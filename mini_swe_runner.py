#!/usr/bin/env python3
"""
SWE Runner with SOCIS Trajectory Format

A runner that uses SOCIS-Agent's built-in execution environments
(local, docker, modal) and outputs trajectories in the SOCIS-Agent format
compatible with batch_runner.py and trajectory_compressor.py.

Features:
- Uses SOCIS-Agent's Docker, Modal, or Local environments for command execution
- Outputs trajectories in SOCIS format (from/value pairs with <tool_call>/<tool_response> XML)
...
# ============================================================================
# Terminal Tool Definition (matches SOCIS-Agent format)
# ============================================================================
...
def create_environment(
    ...
    **kwargs
    ...
    """
    Create an execution environment using SOCIS-Agent's built-in backends.
...
# ============================================================================
# Mini-SWE Runner with SOCIS Trajectory Format
# ============================================================================

class MiniSWERunner:
    """
    Agent runner that uses SOCIS-Agent's built-in execution environments
    and outputs trajectories in SOCIS-Agent format.
    """
    ...
    def _convert_to_socis_format(
        ...
        """
        Convert internal message format to SOCIS trajectory format.
...
Complete the user's task step by step."""
        ...
        # Convert to SOCIS trajectory format
        trajectory = self._convert_to_socis_format(messages, task, completed)
...
def main(
    ...
    """
    Run SWE tasks with SOCIS trajectory format output.
    ...
    """
    print("🚀 Mini-SWE Runner with SOCIS Trajectory Format")
    print("=" * 60)
