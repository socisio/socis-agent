...
def main() -> None:
    ...
    socis_agent_home = Path(tempfile.mkdtemp(prefix="socis-otel-smoke-"))
    ...
    config = {
        "monitoring": {
            ...
            "gateway_health_export": {
                ...
                "resource_attributes": {
                    "service.name": "socis-gateway-smoke",
    ...
    print(json.dumps({"socis_agent_home": str(socis_agent_home), "requests": len(rows), "paths": sorted(paths)}, indent=2))
