#!/usr/bin/env python3
"""Build the SOCIS Skills Index — a centralized JSON catalog of all skills.
...
`socis skills search/install` can use it without hitting the GitHub API.
...
# Ensure SOCIS_AGENT_HOME is set (needed by tools/skills_hub.py imports)
...
def main():
    print("Building SOCIS Skills Index...", flush=True)
