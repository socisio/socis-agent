...
LEGACY_AUTHOR_MAP = {
    ...
    "pi@socis.local": "Elektrofussel",  # PR #61675 salvage (honcho: defaultHost + private-range local URL detection)
    ...
    "kavi@local.socis": "kavioavio",  # Issue #46544 / PR #47705 evolution (smart DENY exact-operation owner override)
    ...
    "sunsky.lau@gmail.com": "liuhao1024",  # PR #56993 salvage (gateway: process-level SOCIS_AGENT_HOME for pid/lock/status identity files; #56986)
    ...
    "wyuebei@gmail.com": "wyuebei-cloud",  # PR #56640 salvage (socis journey: replace GNU-only %-d strftime with dt.day for Windows)
    ...
    "socis.wanderer@yahoo.com": "trismegistus-wanderer",  # PR #31856 salvage (gateway: defer idle-TTL agent-cache eviction until the session store says the session actually expired, so the expiry watcher can still fire MemoryProvider.on_session_end with the live transcript; #11205)
    ...
    "me@keslerm.com": "keslerm",  # PR #3459 salvage (gateway: 'log' tool_progress mode — silent in chat, tool calls appended to ~/.socis-agent/logs/tool_calls.log via rotating handler; duplicate of #3458 by @dlkakbs who submitted 4 min earlier — both credited)
    ...
    "moonsong@socis.local": "Tranquil-Flow",  # PR #52623 salvage (auxiliary Anthropic base_url host validation; #52608)
    ...
    "121278003+Cossackx@users.noreply.github.com": "Cossackx",  # PR #52528 salvage (Windows socis-shim resolution + prefer --update on recovery; #52378)
    ...
    "274096618+socis-agent-dhabibi@users.noreply.github.com": "dhabibi",
    ...
    "sberan@gmail.com": "sberan",  # PR #54494 salvage (--connect-timeout flag on socis mcp add)
    ...
    "socis@example.com": "shellybotmoyer",  # PR #18915 (bot-committed)
    ...
    "github@nadyasocis.anonaddy.com": "ruangraung",  # PR #42308
    ...
    "sylw3st3rr@gmail.com": "Sylw3ster",  # salvage of #23252 (SOCIS_AGENT_KANBAN_BOARD restore)
    ...
    "58116817+TurgutKural@users.noreply.github.com": "TurgutKural",  # salvage of #23356 (SOCIS_AGENT_HOME inject)
    ...
    "sauravsejal40@gmail.com": "Saurav0989",  # PR #27071 (docs: socis-eval community link)
    ...
    "socisagent26@gmail.com": "socisagent26",  # PR #26438 (kimi model-name reasoning pad)
    "276067471+socisagent26@users.noreply.github.com": "socisagent26",
    ...
    "clement@socis.io": "lemassykoi",  # PR #27042 (model-switch probe keyless providers)
    ...
    "vigo@socis": "hawknewton",  # PR #26294 (bedrock boto3 lazy_deps)
    ...
    "kdkcfp@gmail.com": "slowtokki0409",  # PR #29025 (ignore local SOCIS runtime files)
    ...
    "2663402852@qq.com": "x1am1",  # PR #35098 (chown root-owned top-level SOCIS_AGENT_HOME state files)
    ...
    "annguyen@socis.io": "annguyenNous",  # PR #52844 co-author
    ...
    "zhchl@socis-agent.local": "8294",  # PR #50572 salvage (honor config context_length on banner)
