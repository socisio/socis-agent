...
IGNORED_PATTERNS = [
    ...
    re.compile(r"^SOCIS\s+(Agent|Audit)$", re.IGNORECASE),
    ...
    re.compile(r".*\[bot\]$", re.IGNORECASE),             # any GitHub [bot] suffix (socis-seaeye[bot] etc.)
...
IGNORED_EMAILS = {
    ...
    "socis@socis.io",
    "socis-audit@example.com",
    "nousbot@socis.io",
    "socis@habibilabs.dev",
    "omx@oh-my-codex.dev",
    "codex@openai.com",
