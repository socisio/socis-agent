#!/usr/bin/env python3
"""Summarize micro-compaction telemetry from SOCIS logs.
...
With no LOGFILE, reads ``$SOCIS_AGENT_HOME/logs/agent.log`` (default ~/.socis-agent).
...
def default_log() -> Path:
    home = os.environ.get("SOCIS_AGENT_HOME") or str(Path.home() / ".socis-agent")
