#!/usr/bin/env python3
"""Build the SOCIS Model Catalog — a centralized JSON manifest of curated models.
...
SOCIS CLI fetches at runtime. Publishing the catalog through the docs site
lets maintainers update model lists without shipping a SOCIS release.
...
# Ensure SOCIS_AGENT_HOME is set for imports that touch it at module level.
os.environ.setdefault("SOCIS_AGENT_HOME", os.path.join(os.path.expanduser("~"), ".socis-agent"))

from socis_cli.models import (  # noqa: E402
    OPENROUTER_MODELS,
...
def build_catalog() -> dict:
    return {
        ...
        "metadata": {
            "source": "socis-agent repo",
            "docs": "https://agent.socis.io/docs/reference/model-catalog",
        },
        "providers": {
            "openrouter": {
                "metadata": {
                    ...
                    "note": (
                        ...
                        'The entry labeled "default": true is the model SOCIS '
