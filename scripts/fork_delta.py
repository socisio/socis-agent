...
NOISE_PARTS = (
    ...
    # Docusaurus build cache. Absent in CI (nobody runs the site build there)
    # but present locally the moment anyone runs website/scripts/prebuild.mjs,
    # which made a local run report 1259 files against CI's 68 — the same
    # measurement disagreeing with itself depending on where it ran.
    ".docusaurus",
    "rebrand_report.json",
)
...
GENERATED_PREFIXES = (
    ...
    "website/static/api/",
    # Generated by website/scripts/generate-llms-txt.py.
