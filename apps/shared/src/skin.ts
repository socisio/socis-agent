/**
 * Canonical SOCIS skin — the theme SDK's cross-surface contract.
 *
 * A skin is authored once as YAML in `$SOCIS_AGENT_HOME/skins/<name>.yaml` (or a
 * built-in), resolved by the Python skin engine (`socis_cli/skin_engine.py`),
 ...
 *   • CLI     → `socis_cli/skin_engine` → prompt_toolkit / Rich styles (Python)
 *
