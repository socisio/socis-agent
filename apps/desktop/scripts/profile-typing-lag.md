...
cd apps/desktop
XCURSOR_SIZE=24 SOCIS_AGENT_DESKTOP_DEV_SERVER=http://127.0.0.1:5174 \
...
node apps/desktop/scripts/profile-typing.mjs \
  --chars=400 --cps=30 --out=/tmp/socis-typing
# → /tmp/socis-typing.cpuprofile  (open in Chrome DevTools Performance)
# → /tmp/socis-typing.before.heapsnapshot
# → /tmp/socis-typing.after.heapsnapshot
```
