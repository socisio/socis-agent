...
const relaySource = readFileSync(join(process.cwd(), 'src/plugins/socis-bots/relay.ts'), 'utf8')
const repoRoot = join(process.cwd(), '..', '..')
const configDefaults = readFileSync(join(repoRoot, 'socis_cli/config_defaults.py'), 'utf8')
