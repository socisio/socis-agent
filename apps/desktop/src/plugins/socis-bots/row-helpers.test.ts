 ...
 *    the primary profile surfaced as @default instead of @socis;
 ...
 *    kanban/tool workers count too (socis-agent#90268): a profile grinding
...
describe('previewKind classifies a roster preview', () => {
  ...
  it('surfaces the primary profile as @socis, never @default (#89484)', () => {
    expect(fromBot("Message from agent 'default': deploy is green")).toBe('socis')
