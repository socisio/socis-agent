...
import { ackStoredSessionId, atom, haptic, host, markSessionUnreadFinished } from '@socis/plugin-sdk'
 ...
 *  (socis-agent#90102) and are discarded. Without `canonical_session` (older
