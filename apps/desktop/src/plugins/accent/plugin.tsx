...
import type { SOCISPlugin, PaletteContribution } from '@socis/plugin-sdk'
import { $accentOverride, PALETTE_AREA, setAccentOverride, STATUSBAR_AREAS } from '@socis/plugin-sdk'

import { AccentPickerTrigger } from './picker'

const plugin: SOCISPlugin = {
  id: 'accent',
  name: 'Accent Picker',
  description:
