...
const STORAGE_KEY = 'socis.desktop.layoutTree.v2'

writeKey('socis.desktop.layoutTree.v1', null)
 ...
 */
export const $activePresetId = atom<string>(readKey('socis.desktop.layoutPreset.active') ?? 'default')

export function markActivePreset(id: string) {
  $activePresetId.set(id)
  writeKey('socis.desktop.layoutPreset.active', id)
}
 ...
 */
const DISMISSED_KEY = 'socis.desktop.dismissedPanes.v1'
...
const PANE_SHARE_KEY = 'socis.desktop.paneShare.v1'
...
const HIDDEN_STRIP_TAB_KEY = 'socis.desktop.hiddenStripTabs.v1'
...
writeKey('socis.desktop.paneDockHeals.v1', null)
...
if ((import.meta.env.DEV || import.meta.env.VITE_PERF_PROBE === '1') && typeof window !== 'undefined') {
  ;(window as unknown as Record<string, unknown>).__SOCIS_AGENT_LAYOUT_TREE__ = {
    close: closeTreePane,
