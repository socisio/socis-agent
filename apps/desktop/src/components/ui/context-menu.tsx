...
export const SOCIS_AGENT_CONTEXT_MENU_TRIGGER_ATTR = 'data-socis-context-menu-trigger'

function ContextMenuTrigger({ ...props }: React.ComponentProps<typeof ContextMenuPrimitive.Trigger>) {
  return (
    <ContextMenuPrimitive.Trigger data-slot="context-menu-trigger" {...props} data-socis-context-menu-trigger="" />
  )
}
