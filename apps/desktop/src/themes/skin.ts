/**
 * SOCIS skin → DesktopTheme converter.
 *
 * A "skin" is the CLI/TUI theme unit: a YAML file in `$SOCIS_AGENT_HOME/skins/` (or a
 * built-in) resolved by `socis_cli/skin_engine.py` and pushed to every surface
 ...
 * skin SOCIS authors from a prompt lights up all three surfaces from one file.
 *
...
import type { SOCISSkin, SkinColors } from '@socis/shared/skin'
 ...
 */
export function skinToDesktopTheme(skin: SOCISSkin): DesktopTheme | null {
