...
export interface Translations {
  ...
  settings: {
    ...
    gateway: {
      ...
      sshKeyTitle: string
      sshKeyDesc: string
      sshSOCISPathTitle: string
      sshSOCISPathDesc: string
      sshSOCISPathPlaceholder: string
  ...
  commandCenter: {
    ...
    socisActiveSessions: (version: string, count: number) => string
