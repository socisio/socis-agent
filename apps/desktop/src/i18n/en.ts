...
export const en: Translations = {
  ...
  boot: {
    ready: 'SOCIS Agent Desktop is ready',
    desktopBootFailedWithMessage: message => `Desktop boot failed: ${message}`,
    steps: {
      connectingGateway: 'Connecting live desktop gateway',
      loadingSettings: 'Loading SOCIS settings',
      loadingSessions: 'Loading recent sessions',
      retryingRemoteBackend: 'Reconnecting to the remote SOCIS backend…',
      startingDesktopConnection: 'Starting desktop connection',
      startingSOCISDesktop: 'Starting SOCIS Agent Desktop…'
    },
    errors: {
      backgroundExited: 'SOCIS background process exited.',
      backgroundExitedDuringStartup: 'SOCIS background process exited during startup.',
    ...
    failure: {
      ...
      cloudDownHint:
        'The button below opens the Nous Portal for instance status and controls.',
  ...
  notifications: {
    ...
    backendOutOfDateMessage:
      'Your SOCIS backend is older than this desktop build and may not work correctly. Update to align them.',
    installMethodUnsupportedTitle: 'Unsupported install method',
    updateSOCIS: 'Update SOCIS',
    ...
    errors: {
      ...
      methodNotAllowed:
        'The desktop backend rejected that request (405 Method Not Allowed). Try restarting SOCIS Agent Desktop.',
    ...
    native: {
      ...
      inputBody: 'SOCIS is waiting for your response.',
      turnDoneTitle: 'SOCIS finished',
      turnDoneBody: '',
  ...
  sendDiagnostics: {
    ...
    failedHint:
      'You can also run `socis debug share --nous` from a terminal, or `socis debug share --local` to print the report without uploading.',
  ...
  settings: {
    ...
    resetConfirm: 'Reset all settings to SOCIS defaults?',
    ...
    plugins: {
      ...
      agent: {
        title: 'Agent plugins',
        blurb:
          'Plugins you installed into the SOCIS backend — tools, skills, MCP servers, hooks, and slash commands. Portable ones are Agent Plugins packages (skills + MCP bundles that work in other agents too). Toggles apply to new sessions.',
        ...
        updateBackendToManage: 'Update the SOCIS backend to manage this plugin from Desktop.',
      ...
      installModal: {
        ...
        agentTargetLocal: profile => `Installs into the ${profile} backend (~/.socis-agent/plugins/)`,
    ...
    notifications: {
      ...
      focusedHint: 'Completion alerts only fire while SOCIS is in the background.',
      kinds: {
        approval: {
        ...
        input: {
          label: 'Input needed',
          description: 'SOCIS asked a question or needs a password or secret.'
        },
        turnDone: {
          label: 'Response ready',
          description: 'A turn finished while SOCIS was in the background.'
        },
        turnError: {
          label: 'Turn failed',
        ...
        plugin: {
          ...
          description: 'A desktop plugin sent a notification while SOCIS was in the background.'
        }
      },
    ...
    searchPlaceholder: {
      about: 'About SOCIS Agent Desktop',
    ...
    appearance: {
      ...
      colorModeDesc: 'Pick a fixed mode or let SOCIS follow your system setting.',
      ...
      reactionsDesc: 'iMessage-style emoji tapbacks — react to messages, and SOCIS can react to yours.',
      tipsTitle: 'In-App Tips',
      tipsDesc:
        'A small bubble pointing at one part of the app, shown occasionally while idle and by SOCIS when it helps. Closing one retires it for good.',
      tipsReset: (count: number) => `Bring back ${count} closed ${count === 1 ? 'tip' : 'tips'}`,
      toursTitle: 'Guided Tours',
      toursDesc: 'Let SOCIS walk you through the app, dimming the screen and spotlighting each step.',
      ...
      pet: {
        title: 'Pet',
        intro:
          'Adopt an animated petdex mascot that floats over the app and reacts to what SOCIS is doing — running while tools execute, celebrating on success, sulking on errors.',
        restartHint:
          'Pets need a quick restart — the running app started before this feature was added. Quit and reopen SOCIS, then come back here.',
        on: 'On',
        off: 'Off',
        scaleTitle: 'Size',
    ...
    about: {
      heading: 'SOCIS Agent Desktop',
      version: value => `Version ${value}`,
      versionUnavailable: 'Version unavailable',
      bundleOutOfSync: 'App build out of date',
      bundleOutOfSyncDesc:
        'The SOCIS runtime was updated, but the desktop app itself is still an older build — new interface features (like Bot Mode) will be missing until it updates. Run the update below to rebuild the app. If that doesn\u2019t clear this warning, reinstall from the latest desktop installer.',
      bundleOutOfSyncAction: 'Get the installer',
      bundleSwapPending: 'Restart to finish the update',
      bundleSwapPendingDesc:
        'The updated app is already installed — SOCIS only needs to restart to load it. Chats and settings are untouched.',
      bundleSwapPendingAction: 'Restart SOCIS',
      updates: 'Updates',
      checkNow: 'Check now',
      checking: 'Checking…',
      seeWhatsNew: "See what's new",
      ...
      automaticUpdatesDesc:
        'SOCIS checks for updates automatically in the background and lets you know when one is ready.',
    ...
    config: {
      ...
      loading: 'Loading SOCIS configuration...',
    ...
    quickEntry: {
      ...
      enabledDesc:
        'Summon a small composer from anywhere with a global shortcut and fire a prompt without opening SOCIS.',
    ...
    connections: {
      ...
      intro: 'Manage this device and every SOCIS gateway it can reach through remote, SSH, or Cloud connections.',
      stagedNote:
      ...
      updateSkippedCloud: 'Managed by SOCIS Cloud',
      kindLocal: 'Local',
      kindRemote: 'Remote gateway',
      kindCloud: 'SOCIS Cloud',
      kindSsh: 'SSH',
      kindLocalDesc: 'The SOCIS runtime managed by this app.',
      kindRemoteDesc: 'A SOCIS gateway reachable over HTTP(S) — LAN, Tailscale, or the internet.',
      kindCloudDesc: 'A hosted instance discovered through your SOCIS Cloud account.',
      kindSshDesc: 'A SOCIS install reached over SSH.',
      labelTitle: 'Name',
      ...
      headersDesc:
        'Sent with every HTTP and WebSocket request to this gateway — for access proxies such as Cloudflare Access (CF-Access-Client-Id / CF-Access-Client-Secret). Values are stored encrypted. Headers SOCIS manages (Authorization, Cookie, Host…) are ignored.',
      ...
      cloudAddHint:
        'Tip: signing in under SOCIS Cloud above discovers your agents automatically — use this form only to register a known instance URL by hand.',
    ...
    gateway: {
      ...
      intro:
        'Local by default. Use remote when this app should drive a SOCIS backend elsewhere. Gateway connections are machine-level; profiles are discovered from the gateways you connect.',
      envOverrideTitle: 'Environment variables are controlling this desktop session.',
      envOverrideDesc:
        'Unset SOCIS_AGENT_DESKTOP_REMOTE_URL and SOCIS_AGENT_DESKTOP_REMOTE_TOKEN to use the saved setting below.',
      modeTitle: 'Connection mode',
      localTitle: 'Local gateway',
      localDesc: 'Start a private SOCIS backend on localhost. This is the default and works offline.',
      remoteTitle: 'Remote gateway',
      remoteDesc: 'Connect this desktop shell to a remote SOCIS backend.',
      remoteAuthHint: 'Hosted gateways use OAuth or a username and password; self-hosted ones may use a session token.',
      cloudTitle: 'SOCIS Cloud',
      cloudDesc: 'Sign in once to SOCIS Cloud and pick from the agents on your account — no URL to paste.',
      cloudSignInTitle: 'SOCIS Cloud',
      cloudSignIn: 'Sign in to SOCIS Cloud',
      cloudSignedIn: 'Signed in to SOCIS Cloud',
      cloudNeedsSignIn: 'Sign in to SOCIS Cloud to discover the agents on your account.',
      ...
      cloudDiscoverFailed: 'Could not load your SOCIS Cloud agents',
      cloudConnectFailed: 'Could not connect to that agent',
      cloudSignInFailed: 'SOCIS Cloud sign-in failed',
      cloudSignedOutTitle: 'Signed out of SOCIS Cloud',
      cloudSignedOutMessage: 'Cleared the SOCIS Cloud session.',
      ...
      remoteUrlDesc: 'Base URL for the remote dashboard backend. Path prefixes are supported, for example /socis.',
      ...
      restartingMessage: 'SOCIS Agent Desktop will reconnect using the saved settings — the shell stays open.',
      savedMessage: 'Saved for the next restart.',
      connectedTo: (baseUrl, version) => `Connected to ${baseUrl}${version ? ` · SOCIS ${version}` : ''}`,
      ...
      sshDesc:
        'SOCIS is launched on the remote over SSH and tunneled to this app — nothing to start or expose yourself. Requires working key-based SSH access to the host.',
      ...
      sshSOCISPathTitle: 'SOCIS path (optional)',
      sshSOCISPathDesc: 'Full path to the remote socis binary. Blank = auto-detect.',
      sshSOCISPathPlaceholder: 'auto-detect',
      sshTestConnection: 'Test SSH',
      sshConnect: 'Connect',
      sshButtonsHint: 'Save applies on the next launch. Connect reconnects now.',
      sshReachable: (host, platform) => `Reachable: ${host} (${platform}) — SOCIS found`,
      ...
      sshErrAuth:
        'SSH authentication failed. Load your key into the ssh-agent (ssh-add) or set an IdentityFile in ~/.ssh/config — SOCIS runs ssh non-interactively.',
      sshErrHostKey:
        'The host key has CHANGED since you last connected. Verify this is expected, then run ssh-keygen -R <host> and reconnect.',
      sshErrNotInstalled:
        'SOCIS is not installed on the remote host. Install it there (curl -fsSL https://agent.socis.io/install.sh | sh) or set the SOCIS path.',
      sshErrPlatform:
        'Unsupported remote platform. SOCIS Agent Desktop SSH mode supports Linux, macOS, and Windows remote hosts.',
      sshErrTimeout: 'SSH connection timed out. The host may be unreachable or asleep.',
      sshErrUpdateRequired: 'Update SOCIS on the remote host before connecting with Desktop SSH.',
    ...
    mcp: {
      ...
      deepLinkDescription:
        'A link asked to add this MCP server to SOCIS. Review the exact configuration below — it comes from the link, not from SOCIS.',
    ...
    localModels: {
      ...
      runtimeInstalledDetail: (tag, backend) =>
        `Build ${tag}, ${backend} backend. SOCIS starts and manages the server for you.`,
      ...
      upToDateDetail: (tag, backend) => `Running llama.cpp ${tag} (${backend}) — the latest build SOCIS ships.`,
    ...
    providers: {
      ...
      intro:
        'Sign in with a subscription — no API key to copy. SOCIS runs the browser sign-in for you, right here in the app.',
      connected: 'Connected',
      collapse: 'Collapse',
      ...
      localEndpoint: {
        ...
        description: 'Point SOCIS at any OpenAI-compatible endpoint (Zyphra, vLLM, llama.cpp, Ollama, etc).'
      },
    ...
    toolsets: {
      ...
      browserRealProfile: {
        ...
        prompt: {
          ...
          body: 'Let SOCIS browse with a snapshot of your default browser profile, so sites open already signed in.',
  ...
  skills: {
    ...
    skillArchivedMessage: 'Restorable via socis curator restore.',
  ...
  starmap: {
    ...
    emptyDesc: 'As SOCIS builds skills and memories for your work, they appear here.',
    share: 'Share map',
    shareHint:
  ...
  commandCenter: {
    ...
    pets: {
      ...
      staleBackend: 'Restart SOCIS to use pets — the backend predates this feature.',
    ...
    generatePet: {
      ...
      staleBackend: 'Update SOCIS to generate pets.',
      backgroundHint: 'You can close this — SOCIS will notify you when it’s done.',
    ...
    nav: {
      ...
      settings: { title: 'Settings', detail: 'Configure SOCIS desktop' },
    ...
    socisActiveSessions: (version, count) => `SOCIS ${version} · Active sessions ${count}`,
  ...
  messaging: {
    ...
    fieldCopy: {
      ...
      MATRIX_USER_ID: { label: 'Bot user ID', placeholder: '@socis:example.org' },
  ...
  profiles: {
    ...
    remoteOverride: {
      ...
      description: 'Sessions in this profile will run on the remote SOCIS you point it at, instead of this computer.',
    ...
    deleting: 'Deleting...',
    createDesc: 'Profiles are independent SOCIS environments: separate config, skills, and SOUL.md.',
    nameLabel: 'Name',
  ...
  cron: {
    ...
    modelImpact: {
      ...
      saveFailed: 'SOCIS did not save that model change.',
    ...
    newCron: 'New cron',
    emptyDescNew:
      'Schedule a prompt to run on a cron expression. SOCIS will run it and deliver results to the destination you pick.',
  ...
  sidebar: {
    ...
    projects: {
      ...
      staleBackend:
        'Update the SOCIS backend to create projects — your backend is older than this desktop app (Settings → Updates → Backend).',
      deleteConfirm: 'This removes the saved project from SOCIS. Files, git repos, and worktrees stay untouched.',
      ...
      worktreeStaleBackend:
        'Update the SOCIS backend to create worktrees over this remote connection — it predates the git worktree API.',
  ...
  composer: {
    ...
    placeholderStarting: 'Starting SOCIS...',
    placeholderReconnecting: 'Reconnecting to SOCIS…',
    ...
    attachUrlDesc: 'SOCIS will fetch the page and include it as context for this turn.',
  ...
  statusStack: {
    ...
    coding: {
      ...
      agentShip: 'Ask SOCIS to open PR',
  ...
  updates: {
    stages: {
      ...
      pull: 'Almost there…',
      pydeps: 'Finishing up…',
      update: 'Updating SOCIS…',
      rebuild: 'Rebuilding the desktop app…',
      restart: 'Restarting SOCIS…',
    ...
    unsupportedMessage: 'This version of SOCIS can’t update itself from inside the app.',
    ...
    manualBody: 'You installed SOCIS from the command line, so updates run there too. Paste this into your terminal:',
    manualPickedUp: 'SOCIS will pick up the new version next time you launch it.',
    guiSkewTitle: 'Update the desktop app',
    guiSkewBody:
      'The backend was updated, but this desktop app package wasn’t changed. Update or reinstall the SOCIS desktop app (your AppImage / .deb / .rpm) to match.',
    copy: 'Copy',
    copied: 'Copied',
    done: 'Done',
    applyingBody:
      'The SOCIS updater takes over in its own window and reopens SOCIS automatically when it’s done. Please don’t reopen SOCIS yourself while it’s updating.',
    applyingBodyBackend:
      'The remote backend is applying the update and will restart. SOCIS reconnects automatically when it’s back.',
    applyingClose: 'This window will close while the update runs, then SOCIS reopens on its own.',
    errorTitle: 'Update didn’t finish',
    errorBody: 'No worries — nothing was lost. You can try again now.',
    blockerTitle: 'Close local previews to update SOCIS?',
    blockerBody:
      'SOCIS needs to stop these local previews before updating. This will not modify or delete your files.',
    foreignBlockerTitle: 'Close other processes to update SOCIS',
    foreignBlockerBody:
      'SOCIS can’t safely close these processes automatically. Close the app, terminal, or service that owns each one, then try the update again.',
    mixedBlockerBody:
      'SOCIS can close the local previews listed below. Other processes must be closed manually before the update can continue.',
  ...
  install: {
    ...
    oneTimeTitle: 'SOCIS needs a one-time install',
    ...
    setupChoiceTitle: 'Set up SOCIS Agent Desktop',
    setupChoiceDesc:
      'Connect this app to a SOCIS gateway you already run, or install SOCIS locally on this computer.',
    connectExistingTitle: 'Connect to existing SOCIS',
    ...
    installLocalTitle: 'Install SOCIS locally',
    installLocalDesc: 'Download SOCIS, create its Python environment, and run the backend on this computer.',
    localStartUnavailable: 'Local installation could not start. Restart SOCIS Agent Desktop and try again.',
    remoteSetupTitle: 'Connect to existing SOCIS',
    remoteSetupDesc: 'Enter your gateway URL. SOCIS Agent Desktop will detect whether it needs a token or browser sign-in.',
    remoteUrlTitle: 'Gateway URL',
    remoteUrlDesc: 'Use the base URL of the SOCIS gateway, including https:// when remote.',
    remoteUrlPlaceholder: 'https://gateway.example.com/socis',
    probing: 'Detecting gateway authentication...',
    probeError: 'Could not reach that SOCIS gateway.',
    identityProvider: 'your identity provider',
    authTitle: 'Authentication',
    ...
    settingUpTitle: 'Setting up SOCIS Agent',
    finishingTitle: 'Finishing up',
    failedDesc:
      'One of the install steps failed. On Windows, this can happen if another SOCIS CLI or desktop instance is running. Stop any running SOCIS instances, then retry. Check the details below or the desktop log for the full transcript.',
    activeDesc:
  ...
  onboarding: {
    headerTitle: "Let's get you setup with SOCIS Agent",
    headerDesc: 'Connect a model provider to start chatting. Most options take one click.',
    preparingInstall: 'SOCIS is finishing install. This usually takes under a minute on first run.',
    starting: 'Starting SOCIS…',
    ...
    recommended: 'Recommended',
    connected: 'Connected',
    featuredPitch: 'One subscription, 300+ frontier models — the recommended way to run SOCIS',
    ...
    apiKeyOptions: {
      ...
      local: {
        short: 'self-hosted',
        description: 'Point SOCIS at a local or self-hosted OpenAI-compatible endpoint (vLLM, llama.cpp, Ollama, etc).'
      }
    },
    ...
    flowSubtitles: {
      ...
      device_code: 'Opens a verification page in your browser — SOCIS connects automatically',
    ...
    authorizeThere: 'Authorize SOCIS there.',
    ...
    autoBrowser: provider =>
      `We opened ${provider} in your browser. Authorize SOCIS there and you'll be connected automatically — nothing to copy or paste.`,
  ...
  shell: {
    ...
    statusbar: {
      ...
      desktopVersion: version => `SOCIS Agent Desktop v${version}`,
      backendVersion: version => `Backend v${version}`,
      clientLabel: version => `client v${version}`,
      connectionSsh: host => `SSH: ${host}`,
      connectionRemote: host => `Remote: ${host}`,
      connectionCloud: host => `Cloud: ${host}`,
      connectionCloudTooltip: host => `SOCIS Cloud · ${host}`,
  ...
  preview: {
    ...
    largeBody: (label, size) => `${label} is ${size}. SOCIS will only show the first 512 KB.`,
    ...
    web: {
      ...
      tryAgain: 'Try again',
      restarting: 'SOCIS is restarting...',
      askRestart: 'Ask SOCIS to restart the server',
      lookingRestart: taskId => `SOCIS is looking for a preview server to restart (${taskId})`,
      restartingTitle: 'Restarting preview server',
      restartingMessage: 'SOCIS is working in the background. Watch the preview console for progress.',
      ...
      blankPageBody: 'Type an address above to browse, or ask SOCIS to open a page.',
      finishedRestarting: message => `SOCIS finished restarting the preview server${message ? `: ${message}` : ''}`,
      ...
      restartFailedMessage: 'SOCIS could not restart the server.',
      stillWorking:
        'SOCIS is still working, but no restart result has arrived yet. The server command may be running in the foreground.',
  ...
  assistant: {
    thread: {
      ...
      loadingResponse: 'SOCIS is loading a response',
    ...
    approval: {
      gatewayDisconnected: 'SOCIS gateway is not connected',
      ...
      alwaysDescription: pattern =>
        `This adds the “${pattern}” pattern to your permanent allowlist (~/.socis-agent/config.yaml). SOCIS won’t ask again for commands like this — in this session or any future one.`,
  ...
  prompts: {
    ...
    sudoDesc: 'SOCIS needs your sudo password to run a privileged command. It is sent only to your local agent.',
    sudoPlaceholder: 'sudo password',
    secretTitle: 'Secret required',
    secretDesc: 'SOCIS needs a credential to continue.',
  ...
  desktop: {
    ...
    restartToUseSaveImage: 'Restart SOCIS Agent Desktop to use Save Image.',
    restartToSaveImages: 'Restart SOCIS Agent Desktop to save images',
    ...
    handoff: {
      ...
      timedOut: 'Timed out waiting for the gateway. Is `socis gateway` running?'
    }
  },
  ...
  tips: {
    ...
    items: {
      ...
      skills: {
        title: 'Teach it once',
        text: 'Skills are folders of instructions SOCIS loads when the work calls for them.'
      },
      messaging: {
        title: 'SOCIS away from your desk',
        text: 'Connect Telegram, Discord, Slack and more — same agent, same memory.'
      },
      artifacts: {
        title: 'Everything SOCIS made',
      ...
      profiles: {
        ...
        text: 'Each one is its own SOCIS — own keys, own memory, own sessions.'
      },
      'composer-mentions': {
