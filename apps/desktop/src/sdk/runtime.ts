 ...
 * plugins resolve `@socis/plugin-sdk` through the vite alias; RUNTIME-loaded
...
const GLOBALS = {
  __SOCIS_AGENT_PLUGIN_SDK__: sdk,
  __SOCIS_AGENT_REACT__: React,
  __SOCIS_AGENT_REACT_JSX__: jsxRuntime,
  __SOCIS_AGENT_REACT_JSX_DEV__: jsxDevRuntime
} as const
...
export function sdkImportMap(): Record<string, string> {
  cached ??= {
    '@socis/plugin-sdk': shimUrl('__SOCIS_AGENT_PLUGIN_SDK__'),
    'react/jsx-dev-runtime': shimUrl('__SOCIS_AGENT_REACT_JSX_DEV__'),
    'react/jsx-runtime': shimUrl('__SOCIS_AGENT_REACT_JSX__'),
    react: shimUrl('__SOCIS_AGENT_REACT__')
  }
