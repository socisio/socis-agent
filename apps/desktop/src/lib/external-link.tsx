...
const SKIP_PROTO_RE = /^(?:file|data|mailto|javascript|blob|chrome|about|socis):/i
...
export function fetchLinkTitle(url: string): Promise<string> {
  ...
  const bridge = typeof window === 'undefined' ? undefined : window.socisDesktop?.fetchLinkTitle
...
export function openExternalLink(href: string): void {
  if (href) {
    void window.socisDesktop?.openExternal?.(href)
  }
}
 ...
 * doesn't cost a context switch out of SOCIS, and it is the surface the agent
