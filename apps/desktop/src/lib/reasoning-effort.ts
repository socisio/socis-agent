...
/** SOCIS' reasoning levels, in ascending order — mirrors the backend's
 *  VALID_REASONING_EFFORTS (socis_agent_constants.py). `none` is not a level: it's
...
/** SOCIS' built-in level when neither the surface nor the profile config
