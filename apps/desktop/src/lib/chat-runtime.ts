...
import type { ModelOptionsResponse, SessionInfo } from '@/types/socis'
 ...
 *
 * Only the leading status prefix (e.g. "SOCIS is thinking...") and the
 ...
 *  resolved comment as JSON (SOCISPrComment shape); a malformed payload falls
