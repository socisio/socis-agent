...
describe('displayPath', () => {
  it('collapses a macOS home prefix to ~', () => {
    expect(displayPath('/Users/brooklyn/www/socis-agent')).toBe('~/www/socis-agent')
...
describe('pathLeaf', () => {
  it('returns the last segment', () => {
    expect(pathLeaf('/Users/me/www/socis-agent')).toBe('socis-agent')
    expect(pathLeaf('~/www/socis-agent')).toBe('socis-agent')
