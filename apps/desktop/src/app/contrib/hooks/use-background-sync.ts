...
import { getLatestSessionMessages, type ProfileScope } from '@/socis'
...
interface BackgroundSyncParams {
  ...
  refreshSOCISConfig: () => Promise<unknown> | unknown
...
export function useBackgroundSync({
  ...
  }, [activeSessionId, freshDraftReady, gatewayState, refreshCurrentModel, refreshSOCISConfig])
}
