...
import type { SOCISConfigRecord, SessionInfo } from '@/types/socis'
...
// / Program Files), which buried any files SOCIS wrote there.
function DefaultProjectDirSetting() {
  ...
  useEffect(() => {
    ...
    // / Storybook / non-Electron context `window.socisDesktop` is
    ...
    const settings = window.socisDesktop?.settings
