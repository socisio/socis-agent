...
import { getSOCISConfigRecord, listAllProfileSessions } from '@/socis'
...
// SOCIS session ids: <YYYYMMDD>_<HHMMSS>_<6 hex>. Used to offer a direct
        ...
        : []),
      {
        ...
        items: [
          ...
          },
          {
            ...
            icon: Download,
            id: 'cc-update-socis',
            keywords: ['update', 'upgrade', 'socis', 'version', 'system', 'restart'],
            label: cc.updateSOCIS,
