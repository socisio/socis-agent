...
import { getLocalModelsStatus } from '@/socis'
...
import type { LocalModelLoadProgress, ModelOptionProvider, ModelOptionsResponse } from '@/types/socis'
 ...
 * Returning `{}` is fine — the row then shows SOCIS' defaults.
 */
