...
describe('renderRpcResult', () => {
  ...
  describe('session.save', () => {
    it('echoes the saved file path', () => {
      expect(renderRpcResult({ file: '/home/user/.socis-agent/sessions/saved/x.json' }, 'save')).toBe(
        'Saved transcript to /home/user/.socis-agent/sessions/saved/x.json'
      )
    })
  })
