...
const TAKEOVER_KEY = 'socis.desktop.terminalTakeover'
 ...
 *  (CLI-managed) providers, which SOCIS can't clear via the API — the user
 *  sees exactly what runs instead of SOCIS silently deleting their creds. */
