import type { SOCISReviewFile } from '@/global'
...
export function buildReviewFlatList(files: SOCISReviewFile[]): ReviewTreeNode[] {
  return [...files]
...
export function buildReviewTree(files: SOCISReviewFile[], compact = true): ReviewTreeNode[] {
  const root = makeDir('', '')
