...
import type { ProjectInfo, SessionInfo } from '@/socis'
 ...
 * repo shows its branches/worktrees even when they have no SOCIS sessions yet.
...
export function mergeRepoWorktreeGroups(
  ...
  discoveredWorktrees?: SOCISGitWorktree[]
): SidebarSessionGroup[] {
