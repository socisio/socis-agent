...
import type { SOCISGitBranch } from '@/global'
...
const branchActionLabel = (branch: SOCISGitBranch, copy: BranchActionCopy) => {
...
export function WorktreeDialog() {
  ...
  const [branches, setBranches] = useState<SOCISGitBranch[]>([])
  ...
  const convert = async (branch: SOCISGitBranch) => {
    if (pending || !repoPath || !branch) {
      return
    }
