...
import { searchSessions, type SessionInfo, type SessionSearchResult } from '@/socis'
...
// highlight markers (sqlite snippet() delimiters — see socis_agent_state_search.py).
...
export function ChatSidebar({
  ...
  useEffect(() => {
    ...
    window.addEventListener('socis:new-session-shortcut', onShortcut)

    return () => {
      window.removeEventListener('socis:new-session-shortcut', onShortcut)
      clearTimeout(timeout)
    }
  }, [])
  ...
  // A turn can `git worktree add/remove` in the terminal (e.g. you ask SOCIS to
