...
import { type DroppedFile, extractDroppedFiles, SOCIS_AGENT_PATHS_MIME } from './use-composer-actions'
...
const dragKindOf = (event: ReactDragEvent): DragKind =>
  dragHasAttachments(event.dataTransfer, SOCIS_AGENT_PATHS_MIME) ? 'files' : null
