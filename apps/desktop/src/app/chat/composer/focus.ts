...
const FOCUS_EVENT = 'socis:composer-focus'
const INSERT_EVENT = 'socis:composer-insert'
const ATTACH_IMAGES_EVENT = 'socis:composer-attach-images'
const INSERT_REFS_EVENT = 'socis:composer-insert-refs'
const SUBMIT_EVENT = 'socis:composer-submit'
const VOICE_TOGGLE_EVENT = 'socis:composer-voice-toggle'
const MODEL_MENU_EVENT = 'socis:composer-model-menu'
