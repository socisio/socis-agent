 ...
 * `<socis home>/desktop-plugins/*` disk door — incl. agent-written ones),
...
const DECISIONS_KEY = 'socis.desktop.pluginDecisions.v2'
const LEGACY_DISABLED_KEY = 'socis.desktop.disabledPlugins.v1'
