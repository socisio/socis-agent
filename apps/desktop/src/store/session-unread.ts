...
function rehydrateFromDiskOnce(): void {
  ...
  try {
    const rawSeen = readKey('socis.desktop.sessionSeenCounts')
    ...
    const rawMarkers = readKey('socis.desktop.unreadFinishedSessions')
