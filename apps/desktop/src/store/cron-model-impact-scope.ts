...
function identityForConnection(connection: SOCISConnection | null): string {
  if (!connection) {
    return ''
  }
...
export function syncCronModelImpactConnection(connection: SOCISConnection | null): void {
