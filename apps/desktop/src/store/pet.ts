...
export interface PetInfo {
  ...
  // the SOCIS "run" activity state uses the in-place running row).
 ...
 * SOCIS_AGENT_HOME — so every pet RPC carries this. The gateway no-ops it for the
 ...
 */
const ROAM_KEY = 'socis.desktop.pet-roam.v1'
