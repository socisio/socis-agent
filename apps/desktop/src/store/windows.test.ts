...
function installBridge(
  openSessionWindow?: Window['socisDesktop']['openSessionWindow'],
  openWindow?: Window['socisDesktop']['openWindow'],
  openBrowserWindow?: Window['socisDesktop']['openBrowserWindow']
) {
