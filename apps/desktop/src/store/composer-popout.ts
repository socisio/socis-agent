...
const POPOUT_STORAGE_KEY = 'socis.desktop.composerPopout.zones.v1'
const POPOUT_GESTURES_ENABLED_STORAGE_KEY = 'socis.desktop.composerPopout.gesturesEnabled'
...
const LEGACY_ENABLED_KEY = 'socis.desktop.composerPopout.enabled'
const LEGACY_POSITION_KEY = 'socis.desktop.composerPopout.position'
