...
// (#73044). Exercises the REAL socis + store/gateway + store/profile chain:
...
const { pluginSocket, setApiRequestConnection, setApiRequestProfile } = await import('@/socis')
...
const conn = (over: Partial<SOCISConnection> = {}): SOCISConnection =>
  ({
    authMode: 'oauth',
