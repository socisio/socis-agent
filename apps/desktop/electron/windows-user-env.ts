...
// even though a fresh shell — and the SOCIS CLI — sees it immediately. The
// desktop's SOCIS_AGENT_HOME resolution relies on process.env, so that stale-snapshot
// gap silently sends the backend to the default %LOCALAPPDATA%\socis. Reading
...
//       SOCIS_AGENT_HOME    REG_SZ    F:\SOCIS\data
//
