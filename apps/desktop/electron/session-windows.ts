...
// by main.ts (`setBackgroundThrottling` driven by the merged `socis:active-work`
...
// (the "SOCIS idles at 20% CPU while minimized" bug). The preload path is
...
// conversation started by the "Hey SOCIS" wake word has NO preceding click,
