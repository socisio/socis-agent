 ...
 *
 * A public install can end up with `origin=git@github.com:socisio/socis-agent.git`.
...
const OFFICIAL_REPO_HTTPS_URL = 'https://github.com/socisio/socis-agent.git'
const OFFICIAL_REPO_CANONICAL = 'github.com/socisio/socis-agent'
