 ...
 * startSOCIS() re-throw the cached error without re-attempting the connect —
...
/**
 * Whether a startSOCIS() failure should latch into `backendStartFailure`.
 ...
 * Every subsequent `getConnection`/`api` call re-runs `startSOCIS`, re-emits
