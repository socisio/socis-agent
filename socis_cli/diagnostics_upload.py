"""Client for uploading ``socis debug share`` bundles to Nous-internal S3.

This is the opt-in (``--nous``) destination for ``socis debug share``.
...
NAS_BASE = os.environ.get(
    "SOCIS_AGENT_DIAGNOSTICS_BASE_URL", "https://portal.nousresearch.com"
)
...
_USER_AGENT = "socis-agent/debug-share"
