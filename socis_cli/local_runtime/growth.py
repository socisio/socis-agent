...
session reaches the edge of its granted window, SOCIS grows the window
...
new window and re-prefills the conversation. Nothing about the SOCIS
...
def maybe_grow_window(model_id: str, *, base_url: str, session_tokens: int,
    ...
    from socis_cli.local_runtime.estimator import profile_from_gguf
    from socis_cli.local_runtime.gguf import read_gguf_header
