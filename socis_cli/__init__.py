"""
SOCIS CLI - Unified command-line interface for SOCIS Agent.

Provides subcommands for:
- socis chat          - Interactive chat (same as ./socis)
- socis gateway       - Run gateway in foreground
- socis gateway start - Start gateway service
...
def _ensure_utf8():
    ...
    can even start — e.g. `socis setup` on a fresh Pi.
    ...
    socis_cli/stdio.py::configure_windows_stdio() runs later from the entry
