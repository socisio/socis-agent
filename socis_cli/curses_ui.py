"""Shared curses-based UI components for SOCIS CLI.

Used by `socis tools` and `socis skills` for interactive checklists.
...
_MENU_NAVIGATION_HANDLER: ContextVar[MenuNavigationHandler | None] = ContextVar(
    "socis_menu_navigation_handler", default=None
)
_NUMBERED_BACK_ENABLED: ContextVar[bool] = ContextVar(
    "socis_numbered_back_enabled", default=False
)
