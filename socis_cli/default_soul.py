"""Default SOUL.md template seeded into SOCIS_AGENT_HOME on first run."""
...
_LEGACY_TEMPLATE_SOULS = (
    (
        ...
        "Edit this to customize how SOCIS communicates with you.\n"
        "\n"
        "Examples:\n"
