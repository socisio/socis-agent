"""Relay subscriber for the persisted SOCIS shared-metrics slice."""
...
class SharedMetricsSubscriber:
    """Persist validated SOCIS counters from Relay lifecycle events."""
    ...
    def __call__(self, event: Any) -> None:
        ...
        with self._lock:
            ...
            try:
                ...
                logger.warning(
                    "Unable to persist the SOCIS shared metric: %s",
                    metric_name,
                    exc_info=True,
                )
