...
Visual styling mirrors the SOCIS design system (the
...
``tests/socis_cli/test_dashboard_auth_401_reauth.py``.
"""
...
<title>Sign in — SOCIS Agent</title>
<style>
...
<main>
  ...
  <div class="card">
    <h1>Sign in</h1>
    <p class="subtitle">Choose a sign-in method to continue to the SOCIS Agent dashboard.</p>
...
<meta charset="utf-8">
<meta name="viewport" content="width=device-width, initial-scale=1">
<title>Sign-in unavailable — SOCIS Agent</title>
<style>
  @font-face {
    font-family: 'Collapse';
    font-style: normal;
...
See the <a href="https://agent.socis.io/docs/user-guide/features/web-dashboard#authentication-gated-mode">dashboard
