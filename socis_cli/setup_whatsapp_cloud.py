...
Entry point: ``socis whatsapp-cloud`` (dispatched from
``cmd_whatsapp_cloud`` in ``socis_cli/main.py``).
...
SOCIS gateway and the cloudflared tunnel both run in separate
...
def run_whatsapp_cloud_setup() -> int:
    ...
    print("=" * 50)
    print()
    print("This wizard configures SOCIS to talk to WhatsApp via Meta's")
    ...
    print("─" * 50)
    print()
    print("  SOCIS needs a public HTTPS URL to receive WhatsApp messages.")
    ...
    print()
    print("    3. Start the SOCIS gateway in another terminal:")
    print("         socis gateway")
    print()
    ...
    print()
    print("  Docs: https://agent.socis.io/docs/user-guide/")
