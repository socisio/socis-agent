...
Invoked by ``socis kanban decompose [task_id | --all]`` and the
...
_SYSTEM_PROMPT = """You are the Kanban decomposer for the SOCIS Agent board.
...
def _profile_author() -> str:
    """Mirror of ``socis_cli.kanban._profile_author``."""
    return (
