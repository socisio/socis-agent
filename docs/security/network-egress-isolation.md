...
When running SOCIS inside Docker, the default `network_mode: host` gives the
...
The SOCIS [SECURITY.md](../../SECURITY.md) §2 defines the trust model. The
...
#
# Usage:
#   SOCIS_AGENT_UID=$(id -u) SOCIS_AGENT_GID=$(id -g) docker compose up -d
#
...
services:
  gateway:
    ...
    environment:
      ...
      - NO_PROXY=socis,socis-dashboard,localhost
...
- [SECURITY.md](../../SECURITY.md) — SOCIS trust model and vulnerability reporting
