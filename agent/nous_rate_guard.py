...
(3 SDK retries x 3 SOCIS retries), and every one of those calls counts
...
def _state_path() -> str:
    ...
    try:
        ...
        base = get_socis_agent_home()
    except ImportError:
        base = os.path.join(os.path.expanduser("~"), ".socis-agent")
...
def is_genuine_nous_rate_limit(
    *,
    ...
    MiMo, SOCIS, ...) behind one endpoint.  A 429 can mean either:
