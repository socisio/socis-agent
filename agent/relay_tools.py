"""Core NeMo Relay adapter for SOCIS tool execution."""
    ...
    try:
        ...
        if (
            ...
            logger.warning(
                ...
                "returning the SOCIS tool result",
                exc_info=True,
            )
...
def _run_awaitable(value: Any) -> Any:
    ...
    raise RuntimeError(
        "Synchronous SOCIS Relay tool execution cannot run on an active event-loop thread"
    )
