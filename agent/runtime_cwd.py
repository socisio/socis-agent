...
_SESSION_CWD: ContextVar = ContextVar("SOCIS_AGENT_SESSION_CWD", default=_UNSET)
...
def resolve_context_cwd() -> Path | None:
    ...
    # configured path is otherwise honored verbatim — including the SOCIS
    # source tree itself, which is a legitimate workspace when the user is
    # developing SOCIS (per-surface policy for fallback-picked directories
