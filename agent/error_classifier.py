...
# ``data:`` field before SOCIS receives a completion chunk.  Keeping this
...
# See: https://github.com/socisio/socis-agent/issues/69078
...
#
# See: https://github.com/socisio/socis-agent/issues/27344
...
# case: a stream dies mid-response and SOCIS persists a content-less
...
# Request parameters that SOCIS sends on SOME routes only, paired with the
...
def classify_api_error(
    ...
    *,
    ...
    # socis_cli.plugins.VALID_HOOKS for the callback contract). Callback
    ...
    try:
        from socis_cli.plugins import get_plugin_error_classification
