...
The run gets a throwaway SOCIS_AGENT_HOME so no local config leaks in, and the
...
hh = os.path.join(home, ".socis-agent")
...
os.environ["SOCIS_AGENT_HOME"] = hh
...
if _or_key:
    ...
    # Resolved by the orchestrator BEFORE SOCIS_AGENT_HOME is redirected to the
