...
benchmarked ten harnesses on hostile-file handling — and whose SOCIS column
...
Every task runs the full SOCIS agent (file + terminal + search toolsets)
...
Rules of engagement (from socisbench discipline):
