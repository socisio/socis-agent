...
await build({
  ...
  // Skip the prebuilt @socis/ink bundle and inline the source instead:
  ...
  alias: { '@socis/ink': resolve(root, 'packages/socis-ink/src/entry-exports.ts') },
...
// the `node` token, leaving a broken interpreter). The socis_cli launcher
