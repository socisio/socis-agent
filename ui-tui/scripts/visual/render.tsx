 ...
 * across theme x background scenes to <tmpdir>/socis-tui-visual/tui-visual.html,
...
import { Box, renderSync, Text } from '@socis/ink'
...
// The regenerated slate light_colors block from socis_cli/skin_engine.py
// (relight recipe: vivid hue-preserved accents, airy capped-saturation text,
// darker calm dims).

const info: SessionInfo = {
  cwd: '/Users/brooklyn/www/socis-agent',
...
const setup = (bgHex: string) => {
  process.env.SOCIS_AGENT_TUI_BACKGROUND = bgHex
  resetOverlayState()
  resetUiState()
}
