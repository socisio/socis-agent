 ...
 *
 * Symptom: in `socis --tui`, typing into the composer until the input
 ...
 */
import { wrapAnsi } from '@socis/ink'
...
const USER_REPORT_MESSAGE =
  ...
  'im in cursor terminal using socis --tui and as i type multiline my caret at the end will often ' +
