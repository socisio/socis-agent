import { Box, type ScrollBoxHandle, stringWidth, Text } from '@socis/ink'
...
export function StatusRule({
  ...
  // Dev-only readout (SOCIS_AGENT_DEV_CREDITS). The server omits the key entirely unless the
  ...
  // Dev-gated readout (SOCIS_AGENT_DEV_CREDITS), lowest priority,
