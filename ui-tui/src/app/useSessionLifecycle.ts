...
import type { ScrollBoxHandle } from '@socis/ink'
import { evictInkCaches } from '@socis/ink'
...
export const writeActiveSessionFile = (sessionId: null | string, file = process.env.SOCIS_AGENT_TUI_ACTIVE_SESSION_FILE) => {
  if (!file || !sessionId) {
    return
  }
