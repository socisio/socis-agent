import type { BillingBlock, UsageModelData } from '@socis/shared/billing'
import type { SOCISSkin } from '@socis/shared/skin'

import type { SessionInfo, SlashCategory, SubagentStatus, Usage } from './types.js'

/** The cross-surface skin contract (canonical shape in `@socis/shared`).
 *  Includes the paired light_colors/dark_colors overlays from #20379. */
export type GatewaySkin = SOCISSkin
...
// Wire shapes now live in @socis/shared for reuse by TypeScript clients.
export type {
  BillingAutoReload,
  BillingBlock,
  BillingCardInfo,
