...
Data file: $SOCIS_AGENT_HOME/skills/productivity/memento-flashcards/data/cards.json
"""
...
_SOCIS_AGENT_HOME = Path(os.environ.get("SOCIS_AGENT_HOME", Path.home() / ".socis-agent"))
DATA_DIR = _SOCIS_AGENT_HOME / "skills" / "productivity" / "memento-flashcards" / "data"
