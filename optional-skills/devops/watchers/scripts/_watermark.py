...
def _state_dir() -> Path:
    ...
    # Default: $SOCIS_AGENT_HOME/watcher-state/, falling back to ~/.socis-agent/watcher-state/.
    socis_agent_home = os.environ.get("SOCIS_AGENT_HOME") or str(Path.home() / ".socis-agent")
    return Path(socis_agent_home) / "watcher-state"
