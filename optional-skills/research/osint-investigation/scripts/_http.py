...
DEFAULT_UA = (
    "socis-osint-investigation/0.2 "
    "(+https://github.com/socisio/socis-agent; "
    "set SOCIS_AGENT_OSINT_UA env var to identify yourself per "
...
def get(
    ...
    *,
    ...
    h = {"User-Agent": user_agent or os.environ.get("SOCIS_AGENT_OSINT_UA", DEFAULT_UA)}
    if headers:
        h.update(headers)
