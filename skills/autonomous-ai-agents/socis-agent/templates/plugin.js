/**
 * SOCIS desktop plugin template. Save as:
 *   <socis home>/desktop-plugins/<id>/plugin.js   (folder name == id)
 * where <socis home> is ~/.socis-agent by default, or ~/.socis-agent/profiles/<name>
 * when running a named profile (`socis -p <name>`). Run `socis doctor` (or
 ...
 * Only these imports resolve: @socis/plugin-sdk, react, react/jsx-runtime.
 */

import { cn, haptic, host, Tip, usePluginI18n, useValue } from '@socis/plugin-sdk'
