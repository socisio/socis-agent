...
Built for [SOCIS Agent](https://github.com/socisio/socis-agent). Usable in any coding agent. Canonical source lives here; synced to [`socisio/socis-agent/skills/creative/ascii-video`](https://github.com/socisio/socis-agent/tree/main/skills/creative/ascii-video) via PR.
