...
Hooks are discovered from ~/.socis-agent/hooks/ directories, each containing:
...
HOOKS_DIR = get_socis_agent_home() / "hooks"
    ...
    def discover_and_load(self) -> None:
        ...
        for hook_dir in sorted(HOOKS_DIR.iterdir()):
            ...
            try:
                ...
                module_name = f"socis_hook_{hook_name}"
