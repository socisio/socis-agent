...
_APP_VERSION = _SOCIS_AGENT_VERSION
_BOT_VERSION = _SOCIS_AGENT_VERSION
_YUANBAO_INSTANCE_ID = str(SOCIS_AGENT_INSTANCE_ID)  # single source: yuanbao_proto.SOCIS_AGENT_INSTANCE_ID
        ...
        if not adapter._auto_sethome_done and adapter._sender_may_designate_home(ctx):
            ...
            if _should_set:
                try:
                    ...
                    from socis_cli.config import atomic_config_write, read_user_config_raw
