...
from environment variables:
  ...
  - ``SOCIS_AGENT_MEDIA_DELIVERY_STRICT``    <- gateway.strict
  - ``SOCIS_AGENT_MEDIA_ALLOW_DIRS``         <- gateway.media_delivery_allow_dirs
  - ``SOCIS_AGENT_MEDIA_TRUST_RECENT_FILES`` <- gateway.trust_recent_files
...
gateway — a manual ``socis cron run`` in the CLI, ``socis send``, a
...
_STRICT_ENV = "SOCIS_AGENT_MEDIA_DELIVERY_STRICT"
_ALLOW_DIRS_ENV = "SOCIS_AGENT_MEDIA_ALLOW_DIRS"
_TRUST_RECENT_ENV = "SOCIS_AGENT_MEDIA_TRUST_RECENT_FILES"
