...
def build_relay_command_manifest() -> List[Dict[str, Any]]:
    ...
    return [
        ...
        {"name": "reset", "description": "Reset your SOCIS session"},
        {
            "name": "model",
        ...
        {"name": "status", "description": "Show SOCIS session status"},
        {"name": "sethome", "description": "Set this chat as the home channel"},
        {"name": "stop", "description": "Stop the running SOCIS agent"},
        {
            "name": "steer",
        ...
        {"name": "update", "description": "Update SOCIS Agent to the latest version"},
        {"name": "restart", "description": "Gracefully restart the SOCIS gateway"},
        {
            "name": "approve",
        ...
        {
            "name": "thread",
            "description": "Create a new thread and start a SOCIS session in it",
