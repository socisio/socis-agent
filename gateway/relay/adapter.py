...
class RelayAdapter(BasePlatformAdapter):
    ...
    def _relay_slack_extra(self) -> Dict[str, Any]:
        ...
        Enterprise knob shape (SOCIS-config directed, relay-namespaced):
    ...
    def _slack_unfurl_hints(self, platform: Optional[str]) -> Optional[Dict[str, bool]]:
        ...
        for knob in ("unfurl_links", "unfurl_media"):
            ...
            if val is None:
                continue
            # Railway / `socis config set` write YAML strings ("true"/"false").
        ...
        try:
            ...
            if platform == "discord":
                ...
                if event is not None:
                    self._capture_scope(event)
                    # Phase 3: a component press carrying a SOCIS prompt token
    ...
    def _discord_interaction_to_event(self, forward):
        ...
        source = SessionSource(
            ...
            # The SOCIS profile this interaction is routed to (multiplex
        ...
        if itype == 3:
            # Phase 3: a component press whose custom_id is a SOCIS prompt
    ...
    def _decode_prompt_token(token: str):
        ...
        — and is not — a SOCIS prompt answer.
        """
        import re
    ...
    def _resolve_reply_to_for_send(
        ...
        Native Slack SOCIS already suppresses this synthetic DM thread anchor:
    ...
    async def _send_prompt(
        ...
        *,
        ...
        # SOCIS suppresses this synthetic DM thread anchor; drop it here for the
