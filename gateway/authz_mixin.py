...
(``~/.socis-agent/plans/god-file-decomposition.md``, Phase 3 mechanical mixin lifts).
...
class GatewayAuthorizationMixin:
    ...
    def _authorization_adapter(
        ...
        ``_profile_runtime_scope``, which overrides ``SOCIS_AGENT_HOME`` so
        ...
        if profile_name and profile_name != "default":
            ...
            # reads the per-turn SOCIS_AGENT_HOME override, so inside a secondary
    ...
    def _adapter_group_has_sender_allowlist(
        ...
        *,
        ...
        restricting which senders inside that group can invoke SOCIS. If such a
    ...
    def _is_user_authorized(
        ...
        *,
        ...
        # (socis gateway pairing approve / the authenticated dashboard) — an
        ...
        # (``load_socis_dotenv(override=True)`` in
