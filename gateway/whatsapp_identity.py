...
def expand_whatsapp_aliases(identifier: str) -> Set[str]:
    ...
    bridge's ``$SOCIS_AGENT_HOME/whatsapp/session/lid-mapping-*.json`` files,
    ...
    session_dir = get_socis_dir("platforms/whatsapp/session", "whatsapp/session")
