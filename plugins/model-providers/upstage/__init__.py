...
# When the user hasn't picked a reasoning effort, SOCIS passes
...
# ON at this effort — matching the "medium (default)" that SOCIS' /reasoning
...
class UpstageProfile(ProviderProfile):
    ...
    def build_api_kwargs_extras(
        ...
        # Map SOCIS' effort vocabulary onto Solar's accepted set via the
