...
required — uses aiohttp which is already a SOCIS dependency.
...
def interactive_setup() -> None:
    ...
    ``socis_cli/setup.py::_setup_mattermost`` function this migration
    removes.
    """
    ...
    print()
    print_info("📬 Home Channel: where SOCIS delivers cron job results and notifications.")
...
def register(ctx) -> None:
    ...
    ctx.register_platform(
        ...
        # socis_cli/setup.py::_setup_mattermost function.
