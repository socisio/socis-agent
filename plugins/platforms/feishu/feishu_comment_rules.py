...
Config: ~/.socis-agent/feishu_comment_rules.json (mtime-cached, hot-reload).
Pairing store: ~/.socis-agent/feishu_comment_pairing.json.
"""
...
# ---------------------------------------------------------------------------
#
# Uses the canonical ``get_socis_agent_home()`` helper (SOCIS_AGENT_HOME-aware and
...
RULES_FILE = get_socis_agent_home() / "feishu_comment_rules.json"
PAIRING_FILE = get_socis_agent_home() / "feishu_comment_pairing.json"
