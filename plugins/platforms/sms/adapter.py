...
class SmsAdapter(BasePlatformAdapter):
    """
    Twilio SMS <-> SOCIS gateway adapter.

    Each inbound phone number gets its own SOCIS session (multi-tenant).
...
# static dict in socis_cli/gateway.py, and the _send_sms dispatch in
