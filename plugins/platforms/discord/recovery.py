...
class DiscordRecoveryStore:
    ...
    def __init__(self, socis_agent_home: Path | None = None) -> None:
        self._lock = threading.Lock()
        self._initialized = False
        self._socis_agent_home = Path(socis_agent_home or get_socis_agent_home())

    def path(self) -> Path:
        directory = self._socis_agent_home / "gateway"
