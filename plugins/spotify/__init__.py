...
``_check_spotify_available()`` — when the user has not run ``socis auth
spotify``, the tools remain registered (so they appear in ``socis
...
The Spotify auth flow (``socis auth spotify``), CLI plumbing, and docs
