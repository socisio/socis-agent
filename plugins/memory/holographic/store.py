...
Single-user SOCIS memory store plugin.
"""
...
class MemoryStore:
    ...
    def __init__(
        ...
        if db_path is None:
            ...
            db_path = str(get_socis_agent_home() / "memory_store.db")
    ...
    def _init_db(self) -> None:
        ...
        # gracefully on NFS/SMB/FUSE-mounted SOCIS_AGENT_HOME (same issue as
        # state.db / kanban.db — see socis_agent_state._WAL_INCOMPAT_MARKERS).
