      ...
      let
        ...
        excludedDirs =
          ...
          jsWorkspaceTopDirs ++ [
            ...
            "nix"
            # Skills are shipped via SOCIS_AGENT_BUNDLED_SKILLS /
            # SOCIS_AGENT_OPTIONAL_SKILLS (see socis-agent.nix), not via the
            ...
            # __init__.py) shipped via symlinks + SOCIS_AGENT_BUNDLED_LOCALES
            # / SOCIS_AGENT_OPTIONAL_MCPS, not via the wheel. Excluding them
