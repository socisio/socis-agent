# nix/overlays.nix — Expose pkgs.socis-agent for external NixOS configs
#
...
# `pkgs.socis-agent`, `nix build .#default`, and the NixOS module's
...
{ inputs, ... }:
{
  flake.overlays.default = final: _: {
    socis-agent = inputs.self.packages.${final.stdenv.hostPlatform.system}.default;
  };
}
