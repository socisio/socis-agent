...
description: "How the SOCIS Agent Desktop app signs in to a gated gateway using your system browser and PKCE — no embedded webview, no session cookies"
---

# Desktop Native Sign-In (RFC 8252)

When the SOCIS Agent Desktop app connects to a **gated gateway** (a hosted or
...
For SOCIS specifically, native sign-in means:
...
- [Run SOCIS with Nous Portal](./run-socis-with-nous-portal.md)
