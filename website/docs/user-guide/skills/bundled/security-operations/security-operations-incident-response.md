---
title: "Incident Response — Run an incident: contain, eradicate, recover, report"
...
Run an incident: contain, eradicate, recover, report.
...
| Path | `skills/security-operations/incident-response` |
| Version | `1.0.0` |
| Author | SOCIS |
| License | MIT |
| Platforms | linux, macos, windows |
| Tags | `Security`, `IncidentResponse`, `NIST`, `DFIR` |
| Related skills | [`alert-triage`](/docs/user-guide/skills/bundled/security-operations/security-operations-alert-triage), [`evidence-handling`](/docs/user-guide/skills/bundled/security-operations/security-operations-evidence-handling), [`attack-mapping`](/docs/user-guide/skills/bundled/security-operations/security-operations-attack-mapping) |
