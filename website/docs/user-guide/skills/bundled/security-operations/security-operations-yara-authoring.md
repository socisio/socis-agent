---
title: "Yara Authoring — Write YARA rules that survive real data, or answer questions on string selection and goodware testing"
sidebar_label: "Yara Authoring"
...
Write YARA rules that survive real data, or answer questions on string selection and goodware testing.
...
| Path | `skills/security-operations/yara-authoring` |
| Version | `1.0.0` |
| Author | SOCIS |
| License | MIT |
| Platforms | linux, macos, windows |
| Tags | `Security`, `DetectionEngineering`, `YARA`, `MalwareAnalysis` |
| Related skills | [`detection-engineering`](/user-guide/skills/bundled/security-operations/security-operations-detection-engineering), [`ioc-enrichment`](/user-guide/skills/bundled/security-operations/security-operations-ioc-enrichment), [`attack-mapping`](/user-guide/skills/bundled/security-operations/security-operations-attack-mapping) |
