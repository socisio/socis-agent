---
title: "Network Signature Authoring"
sidebar_label: "Network Signature Authoring"
...
Write Suricata and Snort rules that fire, or answer questions on signature testing and PCAP replay.
...
| Path | `skills/security-operations/network-signature-authoring` |
| Version | `1.0.0` |
| Author | SOCIS |
| License | MIT |
| Platforms | linux, macos, windows |
| Tags | `Security`, `DetectionEngineering`, `Suricata`, `Snort`, `NetworkSecurity` |
| Related skills | [`detection-engineering`](/user-guide/skills/bundled/security-operations/security-operations-detection-engineering), [`yara-authoring`](/user-guide/skills/bundled/security-operations/security-operations-yara-authoring), [`attack-mapping`](/user-guide/skills/bundled/security-operations/security-operations-attack-mapping) |
