---
title: "Detection Engineering — Author, convert and tune Sigma rules for any SIEM"
...
Author, convert and tune Sigma rules for any SIEM.
...
| Path | `skills/security-operations/detection-engineering` |
| Version | `1.0.0` |
| Author | SOCIS |
| License | MIT |
| Platforms | linux, macos, windows |
| Tags | `Security`, `DetectionEngineering`, `Sigma`, `SIEM` |
| Related skills | [`attack-mapping`](/docs/user-guide/skills/bundled/security-operations/security-operations-attack-mapping), [`alert-triage`](/docs/user-guide/skills/bundled/security-operations/security-operations-alert-triage) |
