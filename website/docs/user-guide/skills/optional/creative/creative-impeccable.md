...
| | |
|---|---|
| Source | Optional — install with `socis skills install official/creative/impeccable` |
...
> ships and verifies a SOCIS-native skill bundle under `.socis-agent/skills/`.
> `socis skills install impeccable` pulls the current bundle live from that
