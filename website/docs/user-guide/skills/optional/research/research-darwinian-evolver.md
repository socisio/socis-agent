...
| | |
|---|---|
| Source | Optional — install with `socis skills install official/research/darwinian-evolver` |
| Path | `optional-skills/research/darwinian-evolver` |
| Version | `0.1.0` |
| Author | Bihruze (Asahi0x), SOCIS Agent |
| License | MIT |
...
import upstream classes into SOCIS itself.
...
Open `~/.socis-agent/cache/darwinian-evolver/darwinian_evolver/darwinian_evolver/lineage_visualizer.html`
...
7. **AGPL.** Never `from darwinian_evolver import ...` inside SOCIS core.
   Custom driver scripts under `~/.socis-agent/skills/...` are user-side and fine.
