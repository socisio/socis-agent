...
| | |
|---|---|
| Source | Optional — install with `socis skills install official/research/qmd` |
...
| Related skills | [`obsidian`](/docs/user-guide/skills/bundled/note-taking/note-taking-obsidian), [`socis-agent`](/docs/user-guide/skills/bundled/autonomous-ai-agents/autonomous-ai-agents-socis-agent), [`arxiv`](/docs/user-guide/skills/bundled/research/research-arxiv) |
...
SOCIS Agent via the native MCP client. This is the preferred
...
Then configure SOCIS Agent to connect via HTTP:
