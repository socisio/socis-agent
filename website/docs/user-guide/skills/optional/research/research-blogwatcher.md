...
| | |
|---|---|
| Source | Optional — install with `socis skills install official/research/blogwatcher` |
...
## Working with SOCIS tools (read this first)

`blogwatcher-cli` is the feed database; SOCIS tools do the automation around it:
