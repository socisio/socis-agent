...
| | |
|---|---|
| Source | Optional — install with `socis skills install official/health/neuroskill-bci` |
...
Connect SOCIS to a running [NeuroSkill](https://neuroskill.com/) instance to read
