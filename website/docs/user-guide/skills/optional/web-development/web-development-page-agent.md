...
| | |
|---|---|
| Source | Optional — install with `socis skills install official/web-development/page-agent` |
...
- User wants **SOCIS itself to drive a browser** → use SOCIS' built-in browser tool (Browserbase / Camofox). page-agent is the *opposite* direction.
