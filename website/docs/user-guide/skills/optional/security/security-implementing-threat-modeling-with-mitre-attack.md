---
title: "Implementing Threat Modeling With Mitre Attack — Implements threat modeling using the MITRE ATT&CK framework"
sidebar_label: "Implementing Threat Modeling With Mitre Attack"
description: "Implements threat modeling using the MITRE ATT&CK framework"
---
...
Implements threat modeling using the MITRE ATT&CK framework

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/implementing-threat-modeling-with-mitre-attack` |
| Path | `optional-skills/security/implementing-threat-modeling-with-mitre-attack` |
| Version | `1.0` |
