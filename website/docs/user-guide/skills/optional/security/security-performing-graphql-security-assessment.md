---
title: "Performing Graphql Security Assessment — Assessing GraphQL API endpoints for introspection leaks"
sidebar_label: "Performing Graphql Security Assessment"
description: "Assessing GraphQL API endpoints for introspection leaks"
---
...
Assessing GraphQL API endpoints for introspection leaks

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/performing-graphql-security-assessment` |
| Path | `optional-skills/security/performing-graphql-security-assessment` |
| Version | `1.0` |
