---
title: "Integrating Sast Into Github Actions Pipeline — Integrates CodeQL and Semgrep SAST scanning into GitHub"
sidebar_label: "Integrating Sast Into Github Actions Pipeline"
description: "Integrates CodeQL and Semgrep SAST scanning into GitHub"
---
...
Integrates CodeQL and Semgrep SAST scanning into GitHub

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/integrating-sast-into-github-actions-pipeline` |
| Path | `optional-skills/security/integrating-sast-into-github-actions-pipeline` |
| Version | `1.0.0` |
