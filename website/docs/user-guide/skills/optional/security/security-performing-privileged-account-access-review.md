---
title: "Performing Privileged Account Access Review — Conducts systematic reviews of privileged accounts to"
sidebar_label: "Performing Privileged Account Access Review"
description: "Conducts systematic reviews of privileged accounts to"
---
...
Conducts systematic reviews of privileged accounts to

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/performing-privileged-account-access-review` |
| Path | `optional-skills/security/performing-privileged-account-access-review` |
| Version | `1.0` |
