---
title: "Detecting Serverless Function Injection — Detects and prevents code injection attacks targeting"
sidebar_label: "Detecting Serverless Function Injection"
description: "Detects and prevents code injection attacks targeting"
---
...
Detects and prevents code injection attacks targeting

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/detecting-serverless-function-injection` |
| Path | `optional-skills/security/detecting-serverless-function-injection` |
| Version | `1.0.0` |
