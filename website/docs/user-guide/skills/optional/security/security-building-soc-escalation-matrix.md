---
title: "Building Soc Escalation Matrix — Build a structured SOC escalation matrix defining severity"
sidebar_label: "Building Soc Escalation Matrix"
description: "Build a structured SOC escalation matrix defining severity"
---
...
Build a structured SOC escalation matrix defining severity

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/building-soc-escalation-matrix` |
| Path | `optional-skills/security/building-soc-escalation-matrix` |
| Version | `1.0` |
