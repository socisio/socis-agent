---
title: "Scanning Container Images With Grype — Scans container images, filesystems, and SBOMs for known"
sidebar_label: "Scanning Container Images With Grype"
description: "Scans container images, filesystems, and SBOMs for known"
---
...
Scans container images, filesystems, and SBOMs for known

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/scanning-container-images-with-grype` |
| Path | `optional-skills/security/scanning-container-images-with-grype` |
| Version | `1.0` |
