---
title: "Building Detection Rules With Sigma — Builds vendor-agnostic detection rules using the Sigma rule"
sidebar_label: "Building Detection Rules With Sigma"
description: "Builds vendor-agnostic detection rules using the Sigma rule"
---
...
Builds vendor-agnostic detection rules using the Sigma rule

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/building-detection-rules-with-sigma` |
| Path | `optional-skills/security/building-detection-rules-with-sigma` |
| Version | `1.0` |
