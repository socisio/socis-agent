---
title: "Detecting Network Scanning With Ids Signatures — Detect network reconnaissance and port scanning using"
sidebar_label: "Detecting Network Scanning With Ids Signatures"
description: "Detect network reconnaissance and port scanning using"
---
...
Detect network reconnaissance and port scanning using

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/detecting-network-scanning-with-ids-signatures` |
| Path | `optional-skills/security/detecting-network-scanning-with-ids-signatures` |
| Version | `1.0` |
| Author | mahipal (vendored by SOCIS) |
| License | Apache-2.0 |
| Platforms | linux, macos, windows |
| Tags | `ids`, `nmap-detection`, `port-scanning`, `snort`, `suricata`, `reconnaissance`, `network-security`, `signature-detection` |
