---
title: "Testing Api Security With Owasp Top 10 — Systematically assesses REST, GraphQL, and gRPC API"
sidebar_label: "Testing Api Security With Owasp Top 10"
description: "Systematically assesses REST, GraphQL, and gRPC API"
---
...
Systematically assesses REST, GraphQL, and gRPC API

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/testing-api-security-with-owasp-top-10` |
| Path | `optional-skills/security/testing-api-security-with-owasp-top-10` |
| Version | `1.0` |
