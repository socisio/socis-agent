---
title: "Implementing Zero Trust Network Access — Configures Zero Trust Network Access (ZTNA) in AWS, Azure"
sidebar_label: "Implementing Zero Trust Network Access"
description: "Configures Zero Trust Network Access (ZTNA) in AWS, Azure"
---
...
Configures Zero Trust Network Access (ZTNA) in AWS, Azure

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/implementing-zero-trust-network-access` |
| Path | `optional-skills/security/implementing-zero-trust-network-access` |
| Version | `1.0` |
