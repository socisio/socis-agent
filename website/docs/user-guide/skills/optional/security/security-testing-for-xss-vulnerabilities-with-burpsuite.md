---
title: "Testing For Xss Vulnerabilities With Burpsuite — Identifying and validating cross-site scripting"
sidebar_label: "Testing For Xss Vulnerabilities With Burpsuite"
description: "Identifying and validating cross-site scripting"
---
...
Identifying and validating cross-site scripting

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/testing-for-xss-vulnerabilities-with-burpsuite` |
| Path | `optional-skills/security/testing-for-xss-vulnerabilities-with-burpsuite` |
| Version | `1.0` |
