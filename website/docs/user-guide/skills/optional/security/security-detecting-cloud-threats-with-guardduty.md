---
title: "Detecting Cloud Threats With Guardduty — Deploy and operationalize Amazon GuardDuty, covering"
sidebar_label: "Detecting Cloud Threats With Guardduty"
description: "Deploy and operationalize Amazon GuardDuty, covering"
---
...
Deploy and operationalize Amazon GuardDuty, covering

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/detecting-cloud-threats-with-guardduty` |
| Path | `optional-skills/security/detecting-cloud-threats-with-guardduty` |
| Version | `1.0.0` |
