---
title: "Securing Serverless Functions — Hardens serverless compute platforms (AWS Lambda, Azure"
sidebar_label: "Securing Serverless Functions"
description: "Hardens serverless compute platforms (AWS Lambda, Azure"
---
...
Hardens serverless compute platforms (AWS Lambda, Azure

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/securing-serverless-functions` |
| Path | `optional-skills/security/securing-serverless-functions` |
| Version | `1.0.0` |
