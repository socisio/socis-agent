---
title: "Detecting Rootkit Activity — Detects rootkit presence on compromised systems by"
sidebar_label: "Detecting Rootkit Activity"
description: "Detects rootkit presence on compromised systems by"
---
...
Detects rootkit presence on compromised systems by

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/detecting-rootkit-activity` |
| Path | `optional-skills/security/detecting-rootkit-activity` |
| Version | `1.0.0` |
