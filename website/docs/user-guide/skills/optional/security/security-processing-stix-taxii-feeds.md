---
title: "Processing Stix Taxii Feeds — Processes STIX 2.1 threat intelligence bundles delivered"
sidebar_label: "Processing Stix Taxii Feeds"
description: "Processes STIX 2.1 threat intelligence bundles delivered"
---
...
Processes STIX 2.1 threat intelligence bundles delivered

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/processing-stix-taxii-feeds` |
| Path | `optional-skills/security/processing-stix-taxii-feeds` |
| Version | `1.0.0` |
