---
title: "Performing Ssl Stripping Attack — Simulates SSL stripping / HTTPS downgrade attacks using"
sidebar_label: "Performing Ssl Stripping Attack"
description: "Simulates SSL stripping / HTTPS downgrade attacks using"
---
...
Simulates SSL stripping / HTTPS downgrade attacks using

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/performing-ssl-stripping-attack` |
| Path | `optional-skills/security/performing-ssl-stripping-attack` |
| Version | `1.0` |
