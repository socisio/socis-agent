---
title: "Analyzing Memory Forensics With Lime And Volatility — Performs Linux memory acquisition using LiME (Linux Memory"
sidebar_label: "Analyzing Memory Forensics With Lime And Volatility"
description: "Performs Linux memory acquisition using LiME (Linux Memory"
---
...
Performs Linux memory acquisition using LiME (Linux Memory

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/analyzing-memory-forensics-with-lime-and-volatility` |
| Path | `optional-skills/security/analyzing-memory-forensics-with-lime-and-volatility` |
| Version | `1.0` |
