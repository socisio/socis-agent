---
title: "Bypassing Authentication With Forced Browsing — Discovering and accessing unprotected pages, APIs, and"
sidebar_label: "Bypassing Authentication With Forced Browsing"
description: "Discovering and accessing unprotected pages, APIs, and"
---
...
Discovering and accessing unprotected pages, APIs, and

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/bypassing-authentication-with-forced-browsing` |
| Path | `optional-skills/security/bypassing-authentication-with-forced-browsing` |
| Version | `1.0` |
