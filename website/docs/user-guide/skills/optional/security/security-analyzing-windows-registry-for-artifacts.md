---
title: "Analyzing Windows Registry For Artifacts — Extract and analyze Windows Registry hives with tools like"
sidebar_label: "Analyzing Windows Registry For Artifacts"
description: "Extract and analyze Windows Registry hives with tools like"
---
...
Extract and analyze Windows Registry hives with tools like

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/analyzing-windows-registry-for-artifacts` |
| Path | `optional-skills/security/analyzing-windows-registry-for-artifacts` |
| Version | `1.0` |
