---
title: "Implementing Azure Ad Privileged Identity Management — Configure Microsoft Entra Privileged Identity Management"
sidebar_label: "Implementing Azure Ad Privileged Identity Management"
description: "Configure Microsoft Entra Privileged Identity Management"
---
...
| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/implementing-azure-ad-privileged-identity-management` |
| Path | `optional-skills/security/implementing-azure-ad-privileged-identity-management` |
| Version | `1.0` |
