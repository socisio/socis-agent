---
title: "Testing Websocket Api Security — Tests WebSocket API implementations for missing"
sidebar_label: "Testing Websocket Api Security"
description: "Tests WebSocket API implementations for missing"
---
...
Tests WebSocket API implementations for missing

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/testing-websocket-api-security` |
| Path | `optional-skills/security/testing-websocket-api-security` |
| Version | `1.0.0` |
