---
title: "Implementing Passwordless Auth With Microsoft Entra — Implements passwordless authentication using Microsoft"
sidebar_label: "Implementing Passwordless Auth With Microsoft Entra"
description: "Implements passwordless authentication using Microsoft"
---
...
Implements passwordless authentication using Microsoft

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/implementing-passwordless-auth-with-microsoft-entra` |
| Path | `optional-skills/security/implementing-passwordless-auth-with-microsoft-entra` |
| Version | `1.0` |
