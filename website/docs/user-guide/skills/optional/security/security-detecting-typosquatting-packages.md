---
title: "Detecting Typosquatting Packages — Flag misspelled, brandjacked, and typosquatted package"
sidebar_label: "Detecting Typosquatting Packages"
description: "Flag misspelled, brandjacked, and typosquatted package"
---
...
Flag misspelled, brandjacked, and typosquatted package

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/detecting-typosquatting-packages` |
| Path | `optional-skills/security/detecting-typosquatting-packages` |
| Version | `1.0` |
| Author | mahipal (vendored by SOCIS) |
| License | Apache-2.0 |
| Platforms | linux, macos, windows |
| Tags | `supply-chain-security`, `typosquatting`, `package-registry`, `npm`, `pypi`, `typomania`, `ossgadget`, `dependency-screening` |
