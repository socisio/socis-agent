---
title: "Detecting Entra Offensive Tools In Graph Logs — Hunt AADGraphActivityLogs and MicrosoftGraphActivityLogs in"
sidebar_label: "Detecting Entra Offensive Tools In Graph Logs"
description: "Hunt AADGraphActivityLogs and MicrosoftGraphActivityLogs in"
---
...
Hunt AADGraphActivityLogs and MicrosoftGraphActivityLogs in

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/detecting-entra-offensive-tools-in-graph-logs` |
| Path | `optional-skills/security/detecting-entra-offensive-tools-in-graph-logs` |
| Version | `1.0` |
| Author | mahipal (vendored by SOCIS) |
| License | Apache-2.0 |
| Platforms | linux, macos, windows |
| Tags | `threat-hunting`, `entra-id`, `microsoft-graph`, `kql`, `sentinel`, `roadtools`, `aadinternals`, `detection-engineering` |
