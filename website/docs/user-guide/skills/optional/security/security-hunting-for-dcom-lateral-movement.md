---
title: "Hunting For Dcom Lateral Movement — Hunt for DCOM-based lateral movement (MITRE ATT&CK"
sidebar_label: "Hunting For Dcom Lateral Movement"
description: "Hunt for DCOM-based lateral movement (MITRE ATT&CK"
---
...
Hunt for DCOM-based lateral movement (MITRE ATT&CK

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/hunting-for-dcom-lateral-movement` |
| Path | `optional-skills/security/hunting-for-dcom-lateral-movement` |
| Version | `1.0` |
| Author | mukul975 (vendored by SOCIS) |
| License | Apache-2.0 |
| Platforms | linux, macos, windows |
| Tags | `threat-hunting`, `DCOM`, `lateral-movement`, `T1021.003`, `Sysmon`, `MMC20`, `ShellWindows`, `ShellBrowserWindow` |
