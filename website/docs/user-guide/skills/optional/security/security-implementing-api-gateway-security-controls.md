---
title: "Implementing Api Gateway Security Controls — Configures API gateways such as Kong, AWS API Gateway"
sidebar_label: "Implementing Api Gateway Security Controls"
description: "Configures API gateways such as Kong, AWS API Gateway"
---
...
Configures API gateways such as Kong, AWS API Gateway

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/implementing-api-gateway-security-controls` |
| Path | `optional-skills/security/implementing-api-gateway-security-controls` |
| Version | `1.0.0` |
