---
title: "Hardening Windows Endpoint With Cis Benchmark — Hardens Windows endpoints using CIS (Center for Internet"
sidebar_label: "Hardening Windows Endpoint With Cis Benchmark"
description: "Hardens Windows endpoints using CIS (Center for Internet"
---
...
Hardens Windows endpoints using CIS (Center for Internet

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/hardening-windows-endpoint-with-cis-benchmark` |
| Path | `optional-skills/security/hardening-windows-endpoint-with-cis-benchmark` |
| Version | `1.0.0` |
