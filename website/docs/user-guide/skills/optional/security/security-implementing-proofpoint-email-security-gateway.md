---
title: "Implementing Proofpoint Email Security Gateway — Deploy and configure Proofpoint Email Protection as a"
sidebar_label: "Implementing Proofpoint Email Security Gateway"
description: "Deploy and configure Proofpoint Email Protection as a"
---
...
Deploy and configure Proofpoint Email Protection as a

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/implementing-proofpoint-email-security-gateway` |
| Path | `optional-skills/security/implementing-proofpoint-email-security-gateway` |
| Version | `1.0` |
