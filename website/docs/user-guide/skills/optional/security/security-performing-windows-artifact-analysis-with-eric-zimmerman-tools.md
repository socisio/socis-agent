...
description: "Performs comprehensive Windows forensic artifact analysis"
---
...
Performs comprehensive Windows forensic artifact analysis

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/performing-windows-artifact-analysis-with-eric-zimmerman-tools` |
| Path | `optional-skills/security/performing-windows-artifact-analysis-with-eric-zimmerman-tools` |
| Version | `1.0` |
| Author | mahipal (vendored by SOCIS) |
| License | Apache-2.0 |
| Platforms | linux, macos, windows |
| Tags | `eric-zimmerman`, `ez-tools`, `kape`, `mftecmd`, `pecmd`, `lecmd`, `jlecmd`, `registry-forensics` |
