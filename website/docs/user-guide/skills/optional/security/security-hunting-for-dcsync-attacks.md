---
title: "Hunting For Dcsync Attacks — Detect DCSync attacks (MITRE ATT&CK T1003.006) by analyzing"
sidebar_label: "Hunting For Dcsync Attacks"
description: "Detect DCSync attacks (MITRE ATT&CK T1003.006) by analyzing"
---
...
Detect DCSync attacks (MITRE ATT&CK T1003.006) by analyzing

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/hunting-for-dcsync-attacks` |
| Path | `optional-skills/security/hunting-for-dcsync-attacks` |
| Version | `1.0` |
