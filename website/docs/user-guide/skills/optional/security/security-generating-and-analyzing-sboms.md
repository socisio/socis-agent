---
title: "Generating And Analyzing Sboms — Generate CycloneDX and SPDX SBOMs from container images and"
sidebar_label: "Generating And Analyzing Sboms"
description: "Generate CycloneDX and SPDX SBOMs from container images and"
---
...
Generate CycloneDX and SPDX SBOMs from container images and

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/generating-and-analyzing-sboms` |
| Path | `optional-skills/security/generating-and-analyzing-sboms` |
| Version | `1.0` |
