---
title: "Analyzing Malicious Pdf With Peepdf — Perform static analysis of malicious PDF documents using"
sidebar_label: "Analyzing Malicious Pdf With Peepdf"
description: "Perform static analysis of malicious PDF documents using"
---
...
Perform static analysis of malicious PDF documents using

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/analyzing-malicious-pdf-with-peepdf` |
| Path | `optional-skills/security/analyzing-malicious-pdf-with-peepdf` |
| Version | `1.0` |
