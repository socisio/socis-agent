---
title: "Implementing Runtime Security With Tetragon — Implements eBPF-based runtime observability and in-kernel"
sidebar_label: "Implementing Runtime Security With Tetragon"
description: "Implements eBPF-based runtime observability and in-kernel"
---
...
Implements eBPF-based runtime observability and in-kernel

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/implementing-runtime-security-with-tetragon` |
| Path | `optional-skills/security/implementing-runtime-security-with-tetragon` |
| Version | `1.0` |
| Author | mahipal (vendored by SOCIS) |
| License | Apache-2.0 |
| Platforms | linux, macos, windows |
| Tags | `tetragon`, `ebpf`, `runtime-security`, `kubernetes`, `cilium`, `container-security`, `observability`, `kernel-security` |
