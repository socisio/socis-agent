---
title: "Performing Insider Threat Investigation — Investigates insider threat incidents involving employees"
sidebar_label: "Performing Insider Threat Investigation"
description: "Investigates insider threat incidents involving employees"
---
...
Investigates insider threat incidents involving employees

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/performing-insider-threat-investigation` |
| Path | `optional-skills/security/performing-insider-threat-investigation` |
| Version | `1.0.0` |
