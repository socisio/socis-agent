---
title: "Auditing Foundry Smart Contract Security — Pre-deployment security audit of Solidity smart contracts"
sidebar_label: "Auditing Foundry Smart Contract Security"
description: "Pre-deployment security audit of Solidity smart contracts"
---
...
Pre-deployment security audit of Solidity smart contracts

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/auditing-foundry-smart-contract-security` |
| Path | `optional-skills/security/auditing-foundry-smart-contract-security` |
| Version | `1.0` |
| Author | devredious (vendored by SOCIS) |
| License | Apache-2.0 |
| Platforms | linux, macos, windows |
| Tags | `solidity`, `foundry`, `forge`, `smart-contract`, `slither`, `aderyn`, `mythril`, `reentrancy` |
