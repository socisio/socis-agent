---
title: "Detecting Lateral Movement In Network — Identifies lateral movement techniques in enterprise"
sidebar_label: "Detecting Lateral Movement In Network"
description: "Identifies lateral movement techniques in enterprise"
---
...
Identifies lateral movement techniques in enterprise

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/detecting-lateral-movement-in-network` |
| Path | `optional-skills/security/detecting-lateral-movement-in-network` |
| Version | `1.0` |
