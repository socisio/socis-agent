---
title: "Implementing Application Whitelisting With Applocker — Implements application whitelisting using Windows AppLocker"
sidebar_label: "Implementing Application Whitelisting With Applocker"
description: "Implements application whitelisting using Windows AppLocker"
---
...
Implements application whitelisting using Windows AppLocker

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/implementing-application-whitelisting-with-applocker` |
| Path | `optional-skills/security/implementing-application-whitelisting-with-applocker` |
| Version | `1.0.0` |
