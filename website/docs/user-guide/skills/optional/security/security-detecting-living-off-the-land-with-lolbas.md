---
title: "Detecting Living Off The Land With Lolbas — Detect Living Off the Land Binaries (LOLBins/LOLBAS) abuse"
sidebar_label: "Detecting Living Off The Land With Lolbas"
description: "Detect Living Off the Land Binaries (LOLBins/LOLBAS) abuse"
---
...
Detect Living Off the Land Binaries (LOLBins/LOLBAS) abuse

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/detecting-living-off-the-land-with-lolbas` |
| Path | `optional-skills/security/detecting-living-off-the-land-with-lolbas` |
| Version | `1.0` |
