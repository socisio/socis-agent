---
title: "Implementing Network Segmentation For Ot — Implements OT network segmentation using VLANs, OT-aware"
sidebar_label: "Implementing Network Segmentation For Ot"
description: "Implements OT network segmentation using VLANs, OT-aware"
---
...
Implements OT network segmentation using VLANs, OT-aware

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/implementing-network-segmentation-for-ot` |
| Path | `optional-skills/security/implementing-network-segmentation-for-ot` |
| Version | `1.0.0` |
