---
title: "Analyzing Windows Event Logs In Splunk — Analyzes Windows Security, System, and Sysmon event logs in"
sidebar_label: "Analyzing Windows Event Logs In Splunk"
description: "Analyzes Windows Security, System, and Sysmon event logs in"
---
...
Analyzes Windows Security, System, and Sysmon event logs in

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/analyzing-windows-event-logs-in-splunk` |
| Path | `optional-skills/security/analyzing-windows-event-logs-in-splunk` |
| Version | `1.0` |
