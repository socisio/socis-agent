---
title: "Performing Second Order Sql Injection — Detect and exploit second-order SQL injection"
...
Detect and exploit second-order SQL injection

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/performing-second-order-sql-injection` |
| Path | `optional-skills/security/performing-second-order-sql-injection` |
| Version | `1.0` |
