---
title: "Conducting Phishing Incident Response — Respond to phishing incidents by analyzing reported emails"
sidebar_label: "Conducting Phishing Incident Response"
description: "Respond to phishing incidents by analyzing reported emails"
---
...
Respond to phishing incidents by analyzing reported emails

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/conducting-phishing-incident-response` |
| Path | `optional-skills/security/conducting-phishing-incident-response` |
| Version | `1.0.0` |
