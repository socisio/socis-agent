---
title: "Detecting Oauth Token Theft — Detect and respond to OAuth token theft and replay in"
sidebar_label: "Detecting Oauth Token Theft"
description: "Detect and respond to OAuth token theft and replay in"
---
...
Detect and respond to OAuth token theft and replay in

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/detecting-oauth-token-theft` |
| Path | `optional-skills/security/detecting-oauth-token-theft` |
| Version | `1.0.0` |
