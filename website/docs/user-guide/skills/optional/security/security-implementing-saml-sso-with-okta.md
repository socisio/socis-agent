---
title: "Implementing Saml Sso With Okta — Implement SAML 2.0 Single Sign-On using Okta as the"
sidebar_label: "Implementing Saml Sso With Okta"
description: "Implement SAML 2.0 Single Sign-On using Okta as the"
---
...
Implement SAML 2.0 Single Sign-On using Okta as the

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/implementing-saml-sso-with-okta` |
| Path | `optional-skills/security/implementing-saml-sso-with-okta` |
| Version | `1.0` |
