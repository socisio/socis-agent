---
title: "Escaping Containers To Host — Exploits privileged pods, host mounts, runC CVEs, and"
sidebar_label: "Escaping Containers To Host"
description: "Exploits privileged pods, host mounts, runC CVEs, and"
---
...
Exploits privileged pods, host mounts, runC CVEs, and

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/escaping-containers-to-host` |
| Path | `optional-skills/security/escaping-containers-to-host` |
| Version | `1.0` |
| Author | mahipal (vendored by SOCIS) |
| License | Apache-2.0 |
| Platforms | linux, macos, windows |
| Tags | `container-escape`, `privileged-container`, `runc-cve`, `docker-socket`, `host-mount`, `kubernetes`, `privilege-escalation`, `breakout` |
