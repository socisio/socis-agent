---
title: "Analyzing Typosquatting Domains With Dnstwist — Generate domain permutations with dnstwist and check DNS"
sidebar_label: "Analyzing Typosquatting Domains With Dnstwist"
description: "Generate domain permutations with dnstwist and check DNS"
---
...
Generate domain permutations with dnstwist and check DNS

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/analyzing-typosquatting-domains-with-dnstwist` |
| Path | `optional-skills/security/analyzing-typosquatting-domains-with-dnstwist` |
| Version | `1.0` |
