---
title: "Implementing Api Abuse Detection With Rate Limiting — Implements API abuse detection using token bucket, sliding"
sidebar_label: "Implementing Api Abuse Detection With Rate Limiting"
description: "Implements API abuse detection using token bucket, sliding"
---
...
Implements API abuse detection using token bucket, sliding

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/implementing-api-abuse-detection-with-rate-limiting` |
| Path | `optional-skills/security/implementing-api-abuse-detection-with-rate-limiting` |
| Version | `1.0` |
