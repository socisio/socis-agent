---
title: "Analyzing Usb Device Connection History — Correlate Windows registry keys (USBSTOR, MountedDevices)"
sidebar_label: "Analyzing Usb Device Connection History"
description: "Correlate Windows registry keys (USBSTOR, MountedDevices)"
---
...
Correlate Windows registry keys (USBSTOR, MountedDevices)

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/analyzing-usb-device-connection-history` |
| Path | `optional-skills/security/analyzing-usb-device-connection-history` |
| Version | `1.0` |
