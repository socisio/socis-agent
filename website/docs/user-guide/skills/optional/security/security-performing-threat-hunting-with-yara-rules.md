---
title: "Performing Threat Hunting With Yara Rules — Use YARA pattern-matching rules to hunt for malware"
sidebar_label: "Performing Threat Hunting With Yara Rules"
description: "Use YARA pattern-matching rules to hunt for malware"
---
...
Use YARA pattern-matching rules to hunt for malware

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/performing-threat-hunting-with-yara-rules` |
| Path | `optional-skills/security/performing-threat-hunting-with-yara-rules` |
| Version | `1.0` |
