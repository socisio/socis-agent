---
title: "Implementing Cloud Waf Rules — Deploys and tunes Web Application Firewall rules on AWS"
sidebar_label: "Implementing Cloud Waf Rules"
description: "Deploys and tunes Web Application Firewall rules on AWS"
---
...
Deploys and tunes Web Application Firewall rules on AWS

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/implementing-cloud-waf-rules` |
| Path | `optional-skills/security/implementing-cloud-waf-rules` |
| Version | `1.0.0` |
