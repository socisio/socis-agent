---
title: "Testing For Broken Access Control — Systematically tests web applications and APIs for broken"
sidebar_label: "Testing For Broken Access Control"
description: "Systematically tests web applications and APIs for broken"
---
...
Systematically tests web applications and APIs for broken

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/testing-for-broken-access-control` |
| Path | `optional-skills/security/testing-for-broken-access-control` |
| Version | `1.0` |
