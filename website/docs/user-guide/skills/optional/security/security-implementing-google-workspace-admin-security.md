---
title: "Implementing Google Workspace Admin Security — Hardens a Google Workspace tenant via Admin Console"
sidebar_label: "Implementing Google Workspace Admin Security"
description: "Hardens a Google Workspace tenant via Admin Console"
---
...
Hardens a Google Workspace tenant via Admin Console

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/implementing-google-workspace-admin-security` |
| Path | `optional-skills/security/implementing-google-workspace-admin-security` |
| Version | `1.0` |
