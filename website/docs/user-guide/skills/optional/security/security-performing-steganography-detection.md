---
title: "Performing Steganography Detection — Detects and extracts hidden data embedded in images, audio"
sidebar_label: "Performing Steganography Detection"
description: "Detects and extracts hidden data embedded in images, audio"
---
...
Detects and extracts hidden data embedded in images, audio

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/performing-steganography-detection` |
| Path | `optional-skills/security/performing-steganography-detection` |
| Version | `1.0` |
