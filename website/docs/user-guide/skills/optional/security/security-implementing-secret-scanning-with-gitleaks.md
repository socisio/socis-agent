---
title: "Implementing Secret Scanning With Gitleaks — This skill covers implementing Gitleaks for detecting and"
sidebar_label: "Implementing Secret Scanning With Gitleaks"
description: "This skill covers implementing Gitleaks for detecting and"
---
...
This skill covers implementing Gitleaks for detecting and

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/implementing-secret-scanning-with-gitleaks` |
| Path | `optional-skills/security/implementing-secret-scanning-with-gitleaks` |
| Version | `1.0.0` |
