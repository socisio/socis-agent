---
title: "Performing Dns Enumeration And Zone Transfer — Enumerates DNS records, attempts zone transfers"
sidebar_label: "Performing Dns Enumeration And Zone Transfer"
description: "Enumerates DNS records, attempts zone transfers"
---
...
Enumerates DNS records, attempts zone transfers

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/performing-dns-enumeration-and-zone-transfer` |
| Path | `optional-skills/security/performing-dns-enumeration-and-zone-transfer` |
| Version | `1.0` |
