---
title: "Implementing Endpoint Detection With Wazuh — Deploys and configures Wazuh SIEM/XDR for endpoint"
sidebar_label: "Implementing Endpoint Detection With Wazuh"
description: "Deploys and configures Wazuh SIEM/XDR for endpoint"
---
...
Deploys and configures Wazuh SIEM/XDR for endpoint

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/implementing-endpoint-detection-with-wazuh` |
| Path | `optional-skills/security/implementing-endpoint-detection-with-wazuh` |
| Version | `1.0` |
