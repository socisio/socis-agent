---
title: "Building Devsecops Pipeline With Gitlab Ci — Configure a GitLab CI/CD pipeline that embeds SAST"
sidebar_label: "Building Devsecops Pipeline With Gitlab Ci"
description: "Configure a GitLab CI/CD pipeline that embeds SAST"
---
...
Configure a GitLab CI/CD pipeline that embeds SAST

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/building-devsecops-pipeline-with-gitlab-ci` |
| Path | `optional-skills/security/building-devsecops-pipeline-with-gitlab-ci` |
| Version | `1.0` |
