---
title: "Analyzing Active Directory Acl Abuse — Detect dangerous ACL misconfigurations in Active Directory"
...
Detect dangerous ACL misconfigurations in Active Directory

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/analyzing-active-directory-acl-abuse` |
| Path | `optional-skills/security/analyzing-active-directory-acl-abuse` |
| Version | `1.0` |
