---
title: "Hunting Saas Sso Token Abuse — Hunts for stolen-session and OAuth/PRT token replay"
sidebar_label: "Hunting Saas Sso Token Abuse"
description: "Hunts for stolen-session and OAuth/PRT token replay"
---
...
Hunts for stolen-session and OAuth/PRT token replay

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/hunting-saas-sso-token-abuse` |
| Path | `optional-skills/security/hunting-saas-sso-token-abuse` |
| Version | `1.0` |
