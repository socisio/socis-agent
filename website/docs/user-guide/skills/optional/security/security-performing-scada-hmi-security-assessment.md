---
title: "Performing Scada Hmi Security Assessment — Perform security assessments of SCADA Human-Machine"
sidebar_label: "Performing Scada Hmi Security Assessment"
description: "Perform security assessments of SCADA Human-Machine"
---
...
Perform security assessments of SCADA Human-Machine

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/performing-scada-hmi-security-assessment` |
| Path | `optional-skills/security/performing-scada-hmi-security-assessment` |
| Version | `1.0` |
