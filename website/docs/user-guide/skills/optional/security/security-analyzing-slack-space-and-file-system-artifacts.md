---
title: "Analyzing Slack Space And File System Artifacts — Examine NTFS slack space, MFT entries, the USN Change"
sidebar_label: "Analyzing Slack Space And File System Artifacts"
description: "Examine NTFS slack space, MFT entries, the USN Change"
---
...
Examine NTFS slack space, MFT entries, the USN Change

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/analyzing-slack-space-and-file-system-artifacts` |
| Path | `optional-skills/security/analyzing-slack-space-and-file-system-artifacts` |
| Version | `1.0` |
