---
title: "Implementing Device Posture Assessment In Zero Trust — Implements device posture assessment as a zero trust access"
sidebar_label: "Implementing Device Posture Assessment In Zero Trust"
description: "Implements device posture assessment as a zero trust access"
---
...
Implements device posture assessment as a zero trust access

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/implementing-device-posture-assessment-in-zero-trust` |
| Path | `optional-skills/security/implementing-device-posture-assessment-in-zero-trust` |
| Version | `1.0` |
