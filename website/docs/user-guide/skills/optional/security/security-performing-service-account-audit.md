---
title: "Performing Service Account Audit — Audit service accounts across enterprise infrastructure to"
sidebar_label: "Performing Service Account Audit"
description: "Audit service accounts across enterprise infrastructure to"
---
...
Audit service accounts across enterprise infrastructure to

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/performing-service-account-audit` |
| Path | `optional-skills/security/performing-service-account-audit` |
| Version | `1.0` |
