---
title: "Performing Kubernetes Etcd Security Assessment — Assesses the security posture of the etcd cluster backing"
sidebar_label: "Performing Kubernetes Etcd Security Assessment"
description: "Assesses the security posture of the etcd cluster backing"
---
...
Assesses the security posture of the etcd cluster backing

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/performing-kubernetes-etcd-security-assessment` |
| Path | `optional-skills/security/performing-kubernetes-etcd-security-assessment` |
| Version | `1.0` |
