---
title: "Analyzing Cyber Kill Chain — Analyzes intrusion activity against the Lockheed Martin"
sidebar_label: "Analyzing Cyber Kill Chain"
description: "Analyzes intrusion activity against the Lockheed Martin"
---
...
Analyzes intrusion activity against the Lockheed Martin

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/analyzing-cyber-kill-chain` |
| Path | `optional-skills/security/analyzing-cyber-kill-chain` |
| Version | `1.0.0` |
