---
title: "Implementing Zero Trust For Saas Applications — Secures SaaS apps (Microsoft 365, Google Workspace"
sidebar_label: "Implementing Zero Trust For Saas Applications"
description: "Secures SaaS apps (Microsoft 365, Google Workspace"
---
...
Secures SaaS apps (Microsoft 365, Google Workspace

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/implementing-zero-trust-for-saas-applications` |
| Path | `optional-skills/security/implementing-zero-trust-for-saas-applications` |
| Version | `1.0` |
