---
title: "Implementing Endpoint Dlp Controls — Implements endpoint Data Loss Prevention (DLP) controls to"
sidebar_label: "Implementing Endpoint Dlp Controls"
description: "Implements endpoint Data Loss Prevention (DLP) controls to"
---
...
Implements endpoint Data Loss Prevention (DLP) controls to

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/implementing-endpoint-dlp-controls` |
| Path | `optional-skills/security/implementing-endpoint-dlp-controls` |
| Version | `1.0.0` |
