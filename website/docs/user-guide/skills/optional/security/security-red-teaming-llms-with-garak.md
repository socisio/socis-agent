---
title: "Red Teaming Llms With Garak — Runs NVIDIA garak probe suites (jailbreak, prompt"
sidebar_label: "Red Teaming Llms With Garak"
description: "Runs NVIDIA garak probe suites (jailbreak, prompt"
---
...
Runs NVIDIA garak probe suites (jailbreak, prompt

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/red-teaming-llms-with-garak` |
| Path | `optional-skills/security/red-teaming-llms-with-garak` |
| Version | `1.0` |
| Author | mahipal (vendored by SOCIS) |
| License | Apache-2.0 |
| Platforms | linux, macos, windows |
| Tags | `ai-security`, `llm-red-teaming`, `garak`, `prompt-injection`, `jailbreak`, `vulnerability-scanning`, `data-leakage`, `mitre-atlas` |
