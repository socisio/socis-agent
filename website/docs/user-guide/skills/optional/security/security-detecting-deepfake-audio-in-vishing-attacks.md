---
title: "Detecting Deepfake Audio In Vishing Attacks — Detect AI-generated deepfake audio used in voice phishing"
sidebar_label: "Detecting Deepfake Audio In Vishing Attacks"
description: "Detect AI-generated deepfake audio used in voice phishing"
---
...
Detect AI-generated deepfake audio used in voice phishing

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/detecting-deepfake-audio-in-vishing-attacks` |
| Path | `optional-skills/security/detecting-deepfake-audio-in-vishing-attacks` |
| Version | `1.0.0` |
