---
title: "Implementing Pod Security Admission Controller — Configures and operates the Kubernetes Pod Security"
sidebar_label: "Implementing Pod Security Admission Controller"
description: "Configures and operates the Kubernetes Pod Security"
---
...
Configures and operates the Kubernetes Pod Security

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/implementing-pod-security-admission-controller` |
| Path | `optional-skills/security/implementing-pod-security-admission-controller` |
| Version | `1.0` |
