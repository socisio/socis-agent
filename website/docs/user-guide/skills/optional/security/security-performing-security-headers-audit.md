---
title: "Performing Security Headers Audit — Auditing HTTP security headers including CSP, HSTS"
sidebar_label: "Performing Security Headers Audit"
description: "Auditing HTTP security headers including CSP, HSTS"
---
...
Auditing HTTP security headers including CSP, HSTS

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/performing-security-headers-audit` |
| Path | `optional-skills/security/performing-security-headers-audit` |
| Version | `1.0` |
