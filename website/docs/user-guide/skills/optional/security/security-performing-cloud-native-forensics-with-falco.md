---
title: "Performing Cloud Native Forensics With Falco — Uses Falco YAML rules for runtime threat detection in"
sidebar_label: "Performing Cloud Native Forensics With Falco"
description: "Uses Falco YAML rules for runtime threat detection in"
---
...
Uses Falco YAML rules for runtime threat detection in

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/performing-cloud-native-forensics-with-falco` |
| Path | `optional-skills/security/performing-cloud-native-forensics-with-falco` |
| Version | `1.0` |
| Author | mahipal (vendored by SOCIS) |
| License | Apache-2.0 |
| Platforms | linux, macos, windows |
| Tags | `cloud-security`, `falco`, `runtime-threat-detection`, `container-forensics`, `kubernetes-security`, `syscall-monitoring` |
