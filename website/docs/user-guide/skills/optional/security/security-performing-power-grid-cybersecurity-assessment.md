---
title: "Performing Power Grid Cybersecurity Assessment — Conduct cybersecurity assessments of power grid"
sidebar_label: "Performing Power Grid Cybersecurity Assessment"
description: "Conduct cybersecurity assessments of power grid"
---
...
Conduct cybersecurity assessments of power grid

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/performing-power-grid-cybersecurity-assessment` |
| Path | `optional-skills/security/performing-power-grid-cybersecurity-assessment` |
| Version | `1.0.0` |
