---
title: "Performing Aws Privilege Escalation Assessment — Performing authorized privilege escalation assessments in"
sidebar_label: "Performing Aws Privilege Escalation Assessment"
description: "Performing authorized privilege escalation assessments in"
---
...
Performing authorized privilege escalation assessments in

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/performing-aws-privilege-escalation-assessment` |
| Path | `optional-skills/security/performing-aws-privilege-escalation-assessment` |
| Version | `1.0` |
