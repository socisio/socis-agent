---
title: "Implementing Cloud Security Posture Management — Continuously monitor multi-cloud environments (AWS, Azure"
sidebar_label: "Implementing Cloud Security Posture Management"
description: "Continuously monitor multi-cloud environments (AWS, Azure"
---
...
Continuously monitor multi-cloud environments (AWS, Azure

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/implementing-cloud-security-posture-management` |
| Path | `optional-skills/security/implementing-cloud-security-posture-management` |
| Version | `1.0` |
