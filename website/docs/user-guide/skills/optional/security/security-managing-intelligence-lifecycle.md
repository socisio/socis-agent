---
title: "Managing Intelligence Lifecycle — Manages the end-to-end cyber threat intelligence lifecycle"
sidebar_label: "Managing Intelligence Lifecycle"
description: "Manages the end-to-end cyber threat intelligence lifecycle"
---
...
Manages the end-to-end cyber threat intelligence lifecycle

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/managing-intelligence-lifecycle` |
| Path | `optional-skills/security/managing-intelligence-lifecycle` |
| Version | `1.0.0` |
