---
title: "Deploying Osquery For Endpoint Monitoring — Deploys and configures osquery for real-time endpoint"
sidebar_label: "Deploying Osquery For Endpoint Monitoring"
description: "Deploys and configures osquery for real-time endpoint"
---
...
Deploys and configures osquery for real-time endpoint

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/deploying-osquery-for-endpoint-monitoring` |
| Path | `optional-skills/security/deploying-osquery-for-endpoint-monitoring` |
| Version | `1.0.0` |
