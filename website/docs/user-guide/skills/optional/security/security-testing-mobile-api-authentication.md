---
title: "Testing Mobile Api Authentication — Tests authentication and authorization mechanisms in mobile"
sidebar_label: "Testing Mobile Api Authentication"
description: "Tests authentication and authorization mechanisms in mobile"
---
...
Tests authentication and authorization mechanisms in mobile

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/testing-mobile-api-authentication` |
| Path | `optional-skills/security/testing-mobile-api-authentication` |
| Version | `1.0.0` |
