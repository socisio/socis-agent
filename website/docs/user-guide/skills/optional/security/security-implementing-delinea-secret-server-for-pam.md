---
title: "Implementing Delinea Secret Server For Pam — Implements Delinea Secret Server for privileged access"
sidebar_label: "Implementing Delinea Secret Server For Pam"
description: "Implements Delinea Secret Server for privileged access"
---
...
Implements Delinea Secret Server for privileged access

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/implementing-delinea-secret-server-for-pam` |
| Path | `optional-skills/security/implementing-delinea-secret-server-for-pam` |
| Version | `1.0` |
