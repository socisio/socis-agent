---
title: "Detecting T1003 Credential Dumping With Edr — Detect OS credential dumping (MITRE T1003) targeting LSASS"
sidebar_label: "Detecting T1003 Credential Dumping With Edr"
description: "Detect OS credential dumping (MITRE T1003) targeting LSASS"
---
...
Detect OS credential dumping (MITRE T1003) targeting LSASS

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/detecting-t1003-credential-dumping-with-edr` |
| Path | `optional-skills/security/detecting-t1003-credential-dumping-with-edr` |
| Version | `1.0` |
