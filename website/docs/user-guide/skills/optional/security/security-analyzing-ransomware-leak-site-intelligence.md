---
title: "Analyzing Ransomware Leak Site Intelligence — Safely monitor ransomware group Tor-hosted data leak sites"
sidebar_label: "Analyzing Ransomware Leak Site Intelligence"
description: "Safely monitor ransomware group Tor-hosted data leak sites"
---
...
Safely monitor ransomware group Tor-hosted data leak sites

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/analyzing-ransomware-leak-site-intelligence` |
| Path | `optional-skills/security/analyzing-ransomware-leak-site-intelligence` |
| Version | `1.0` |
