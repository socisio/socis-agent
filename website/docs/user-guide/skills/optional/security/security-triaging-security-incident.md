---
title: "Triaging Security Incident — Performs initial triage of security incidents using the"
sidebar_label: "Triaging Security Incident"
description: "Performs initial triage of security incidents using the"
---
...
Performs initial triage of security incidents using the

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/triaging-security-incident` |
| Path | `optional-skills/security/triaging-security-incident` |
| Version | `1.0.0` |
