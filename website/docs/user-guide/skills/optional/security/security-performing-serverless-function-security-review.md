---
title: "Performing Serverless Function Security Review — Performing security reviews of serverless functions across"
sidebar_label: "Performing Serverless Function Security Review"
description: "Performing security reviews of serverless functions across"
---
...
Performing security reviews of serverless functions across

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/performing-serverless-function-security-review` |
| Path | `optional-skills/security/performing-serverless-function-security-review` |
| Version | `1.0` |
