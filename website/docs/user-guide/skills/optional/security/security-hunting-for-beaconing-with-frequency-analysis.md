---
title: "Hunting For Beaconing With Frequency Analysis — Identify command-and-control beaconing patterns in network"
sidebar_label: "Hunting For Beaconing With Frequency Analysis"
description: "Identify command-and-control beaconing patterns in network"
---
...
Identify command-and-control beaconing patterns in network

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/hunting-for-beaconing-with-frequency-analysis` |
| Path | `optional-skills/security/hunting-for-beaconing-with-frequency-analysis` |
| Version | `1.0` |
