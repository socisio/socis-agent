---
title: "Detecting Rdp Brute Force Attacks — Detect RDP brute force attacks by parsing Windows Security"
sidebar_label: "Detecting Rdp Brute Force Attacks"
description: "Detect RDP brute force attacks by parsing Windows Security"
---
...
Detect RDP brute force attacks by parsing Windows Security

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/detecting-rdp-brute-force-attacks` |
| Path | `optional-skills/security/detecting-rdp-brute-force-attacks` |
| Version | `1.0` |
