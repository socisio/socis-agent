---
title: "Performing Aws Account Enumeration With Scout Suite — Run the agentless, open-source ScoutSuite tool (via pip"
sidebar_label: "Performing Aws Account Enumeration With Scout Suite"
description: "Run the agentless, open-source ScoutSuite tool (via pip"
---
...
Run the agentless, open-source ScoutSuite tool (via pip

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/performing-aws-account-enumeration-with-scout-suite` |
| Path | `optional-skills/security/performing-aws-account-enumeration-with-scout-suite` |
| Version | `1.0` |
