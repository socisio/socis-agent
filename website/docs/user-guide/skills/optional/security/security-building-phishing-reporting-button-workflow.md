---
title: "Building Phishing Reporting Button Workflow — Implement a phishing report button (Microsoft 365 built-in"
sidebar_label: "Building Phishing Reporting Button Workflow"
description: "Implement a phishing report button (Microsoft 365 built-in"
---
...
Implement a phishing report button (Microsoft 365 built-in

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/building-phishing-reporting-button-workflow` |
| Path | `optional-skills/security/building-phishing-reporting-button-workflow` |
| Version | `1.0` |
