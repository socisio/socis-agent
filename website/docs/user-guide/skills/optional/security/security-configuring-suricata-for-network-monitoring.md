---
title: "Configuring Suricata For Network Monitoring — Deploys and configures Suricata IDS/IPS with Emerging"
sidebar_label: "Configuring Suricata For Network Monitoring"
description: "Deploys and configures Suricata IDS/IPS with Emerging"
---
...
Deploys and configures Suricata IDS/IPS with Emerging

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/configuring-suricata-for-network-monitoring` |
| Path | `optional-skills/security/configuring-suricata-for-network-monitoring` |
| Version | `1.0` |
