---
title: "Detecting Azure Service Principal Abuse — Detect Azure service principal abuse in Microsoft Entra ID"
sidebar_label: "Detecting Azure Service Principal Abuse"
description: "Detect Azure service principal abuse in Microsoft Entra ID"
---
...
Detect Azure service principal abuse in Microsoft Entra ID

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/detecting-azure-service-principal-abuse` |
| Path | `optional-skills/security/detecting-azure-service-principal-abuse` |
| Version | `1.0` |
