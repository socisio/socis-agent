---
title: "Implementing Aws Security Hub Compliance — Deploy AWS Security Hub, backed by AWS Config, to aggregate"
sidebar_label: "Implementing Aws Security Hub Compliance"
description: "Deploy AWS Security Hub, backed by AWS Config, to aggregate"
---
...
Deploy AWS Security Hub, backed by AWS Config, to aggregate

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/implementing-aws-security-hub-compliance` |
| Path | `optional-skills/security/implementing-aws-security-hub-compliance` |
| Version | `1.0` |
