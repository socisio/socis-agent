---
title: "Performing Sca Dependency Scanning With Snyk — This skill covers implementing Software Composition"
sidebar_label: "Performing Sca Dependency Scanning With Snyk"
description: "This skill covers implementing Software Composition"
---
...
This skill covers implementing Software Composition

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/performing-sca-dependency-scanning-with-snyk` |
| Path | `optional-skills/security/performing-sca-dependency-scanning-with-snyk` |
| Version | `1.0.0` |
