---
title: "Detecting Qr Code Phishing With Email Security — Detect and prevent QR code phishing (quishing) attacks that"
sidebar_label: "Detecting Qr Code Phishing With Email Security"
description: "Detect and prevent QR code phishing (quishing) attacks that"
---
...
Detect and prevent QR code phishing (quishing) attacks that

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/detecting-qr-code-phishing-with-email-security` |
| Path | `optional-skills/security/detecting-qr-code-phishing-with-email-security` |
| Version | `1.0` |
