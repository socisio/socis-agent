---
title: "Detecting Email Forwarding Rules Attack — Detect malicious inbox/mail-flow forwarding rules that"
sidebar_label: "Detecting Email Forwarding Rules Attack"
description: "Detect malicious inbox/mail-flow forwarding rules that"
---
...
Detect malicious inbox/mail-flow forwarding rules that

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/detecting-email-forwarding-rules-attack` |
| Path | `optional-skills/security/detecting-email-forwarding-rules-attack` |
| Version | `1.0` |
