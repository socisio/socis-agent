---
title: "Performing Graphql Introspection Attack — Performs GraphQL introspection attacks that extract the"
sidebar_label: "Performing Graphql Introspection Attack"
description: "Performs GraphQL introspection attacks that extract the"
---
...
Performs GraphQL introspection attacks that extract the

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/performing-graphql-introspection-attack` |
| Path | `optional-skills/security/performing-graphql-introspection-attack` |
| Version | `1.0.0` |
