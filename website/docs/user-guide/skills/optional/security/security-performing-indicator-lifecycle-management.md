---
title: "Performing Indicator Lifecycle Management — Tracks IOCs through discovery, enrichment/validation"
sidebar_label: "Performing Indicator Lifecycle Management"
description: "Tracks IOCs through discovery, enrichment/validation"
---
...
Tracks IOCs through discovery, enrichment/validation

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/performing-indicator-lifecycle-management` |
| Path | `optional-skills/security/performing-indicator-lifecycle-management` |
| Version | `1.0` |
