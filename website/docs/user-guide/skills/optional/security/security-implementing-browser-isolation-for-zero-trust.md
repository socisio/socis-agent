---
title: "Implementing Browser Isolation For Zero Trust — Deploys remote browser isolation (RBI) as a core component"
sidebar_label: "Implementing Browser Isolation For Zero Trust"
description: "Deploys remote browser isolation (RBI) as a core component"
---
...
Deploys remote browser isolation (RBI) as a core component

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/implementing-browser-isolation-for-zero-trust` |
| Path | `optional-skills/security/implementing-browser-isolation-for-zero-trust` |
| Version | `1.0` |
