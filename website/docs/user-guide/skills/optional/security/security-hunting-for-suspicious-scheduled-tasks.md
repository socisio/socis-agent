---
title: "Hunting For Suspicious Scheduled Tasks — Hunts for adversary persistence and execution via Windows"
sidebar_label: "Hunting For Suspicious Scheduled Tasks"
description: "Hunts for adversary persistence and execution via Windows"
---
...
Hunts for adversary persistence and execution via Windows

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/hunting-for-suspicious-scheduled-tasks` |
| Path | `optional-skills/security/hunting-for-suspicious-scheduled-tasks` |
| Version | `1.0` |
