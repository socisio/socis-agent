---
title: "Implementing Kubernetes Pod Security Standards — Chooses and applies the correct Kubernetes Pod Security"
sidebar_label: "Implementing Kubernetes Pod Security Standards"
description: "Chooses and applies the correct Kubernetes Pod Security"
---
...
Chooses and applies the correct Kubernetes Pod Security

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/implementing-kubernetes-pod-security-standards` |
| Path | `optional-skills/security/implementing-kubernetes-pod-security-standards` |
| Version | `1.0` |
