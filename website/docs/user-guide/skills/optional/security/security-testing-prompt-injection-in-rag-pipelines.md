---
title: "Testing Prompt Injection In Rag Pipelines — Probes Retrieval-Augmented Generation pipelines for"
sidebar_label: "Testing Prompt Injection In Rag Pipelines"
description: "Probes Retrieval-Augmented Generation pipelines for"
---
...
Probes Retrieval-Augmented Generation pipelines for

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/testing-prompt-injection-in-rag-pipelines` |
| Path | `optional-skills/security/testing-prompt-injection-in-rag-pipelines` |
| Version | `1.0` |
| Author | mahipal (vendored by SOCIS) |
| License | Apache-2.0 |
| Platforms | linux, macos, windows |
| Tags | `ai-security`, `prompt-injection`, `rag`, `llm-red-teaming`, `garak`, `promptfoo`, `pyrit`, `owasp-llm` |
