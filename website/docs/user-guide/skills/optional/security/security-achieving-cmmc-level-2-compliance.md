---
title: "Achieving Cmmc Level 2 Compliance — Prepare a defense-contractor environment for CMMC Level 2"
sidebar_label: "Achieving Cmmc Level 2 Compliance"
...
| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/achieving-cmmc-level-2-compliance` |
| Path | `optional-skills/security/achieving-cmmc-level-2-compliance` |
| Version | `1.0` |
| Author | andrewibrah (vendored by SOCIS) |
| License | Apache-2.0 |
| Platforms | linux, macos, windows |
| Tags | `cmmc`, `nist-800-171`, `cui`, `sprs`, `dfars`, `c3pao`, `poam`, `compliance` |
