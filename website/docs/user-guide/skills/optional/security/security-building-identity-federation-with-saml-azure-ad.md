---
title: "Building Identity Federation With Saml Azure Ad — Configure SAML 2.0 identity federation between on-premises"
sidebar_label: "Building Identity Federation With Saml Azure Ad"
description: "Configure SAML 2.0 identity federation between on-premises"
---
...
Configure SAML 2.0 identity federation between on-premises

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/building-identity-federation-with-saml-azure-ad` |
| Path | `optional-skills/security/building-identity-federation-with-saml-azure-ad` |
| Version | `1.0` |
