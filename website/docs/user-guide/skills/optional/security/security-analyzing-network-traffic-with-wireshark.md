---
title: "Analyzing Network Traffic With Wireshark — Captures and analyzes network packet data using Wireshark"
sidebar_label: "Analyzing Network Traffic With Wireshark"
description: "Captures and analyzes network packet data using Wireshark"
---
...
Captures and analyzes network packet data using Wireshark

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/analyzing-network-traffic-with-wireshark` |
| Path | `optional-skills/security/analyzing-network-traffic-with-wireshark` |
| Version | `1.0` |
