---
title: "Performing Access Recertification With Saviynt — Configure and execute access recertification campaigns in"
sidebar_label: "Performing Access Recertification With Saviynt"
description: "Configure and execute access recertification campaigns in"
---
...
Configure and execute access recertification campaigns in

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/performing-access-recertification-with-saviynt` |
| Path | `optional-skills/security/performing-access-recertification-with-saviynt` |
| Version | `1.0` |
