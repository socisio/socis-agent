---
title: "Hunting Bootkits In Efi System Partition — Baseline the EFI System Partition and hunt malicious EFI"
sidebar_label: "Hunting Bootkits In Efi System Partition"
description: "Baseline the EFI System Partition and hunt malicious EFI"
---
...
Baseline the EFI System Partition and hunt malicious EFI

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/hunting-bootkits-in-efi-system-partition` |
| Path | `optional-skills/security/hunting-bootkits-in-efi-system-partition` |
| Version | `1.0` |
