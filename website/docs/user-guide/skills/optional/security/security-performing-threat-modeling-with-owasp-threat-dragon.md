---
title: "Performing Threat Modeling With Owasp Threat Dragon — Uses OWASP Threat Dragon (web or desktop) to build data"
sidebar_label: "Performing Threat Modeling With Owasp Threat Dragon"
description: "Uses OWASP Threat Dragon (web or desktop) to build data"
---
...
Uses OWASP Threat Dragon (web or desktop) to build data

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/performing-threat-modeling-with-owasp-threat-dragon` |
| Path | `optional-skills/security/performing-threat-modeling-with-owasp-threat-dragon` |
| Version | `1.0` |
