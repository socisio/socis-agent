---
title: "Performing Gcp Security Assessment With Forseti — Performing comprehensive security assessments of Google"
sidebar_label: "Performing Gcp Security Assessment With Forseti"
description: "Performing comprehensive security assessments of Google"
---
...
Performing comprehensive security assessments of Google

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/performing-gcp-security-assessment-with-forseti` |
| Path | `optional-skills/security/performing-gcp-security-assessment-with-forseti` |
| Version | `1.0` |
