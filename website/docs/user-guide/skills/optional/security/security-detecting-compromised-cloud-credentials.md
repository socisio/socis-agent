---
title: "Detecting Compromised Cloud Credentials — Detect compromised cloud credentials across AWS, Azure, and"
sidebar_label: "Detecting Compromised Cloud Credentials"
description: "Detect compromised cloud credentials across AWS, Azure, and"
---
...
Detect compromised cloud credentials across AWS, Azure, and

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/detecting-compromised-cloud-credentials` |
| Path | `optional-skills/security/detecting-compromised-cloud-credentials` |
| Version | `1.0` |
