---
title: "Performing Privacy Impact Assessment — Automates the Privacy Impact Assessment (PIA) workflow"
sidebar_label: "Performing Privacy Impact Assessment"
description: "Automates the Privacy Impact Assessment (PIA) workflow"
---
...
Automates the Privacy Impact Assessment (PIA) workflow

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/performing-privacy-impact-assessment` |
| Path | `optional-skills/security/performing-privacy-impact-assessment` |
| Version | `1.0` |
