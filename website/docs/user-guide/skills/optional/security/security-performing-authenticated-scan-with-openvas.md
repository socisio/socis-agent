---
title: "Performing Authenticated Scan With Openvas — Configure and execute authenticated (credentialed)"
sidebar_label: "Performing Authenticated Scan With Openvas"
description: "Configure and execute authenticated (credentialed)"
---
...
Configure and execute authenticated (credentialed)

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/performing-authenticated-scan-with-openvas` |
| Path | `optional-skills/security/performing-authenticated-scan-with-openvas` |
| Version | `1.0` |
