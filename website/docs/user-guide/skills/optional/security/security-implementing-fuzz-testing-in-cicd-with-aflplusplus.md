---
title: "Implementing Fuzz Testing In Cicd With Aflplusplus — Integrates AFL++ coverage-guided fuzzing into CI/CD"
sidebar_label: "Implementing Fuzz Testing In Cicd With Aflplusplus"
description: "Integrates AFL++ coverage-guided fuzzing into CI/CD"
---
...
Integrates AFL++ coverage-guided fuzzing into CI/CD

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/implementing-fuzz-testing-in-cicd-with-aflplusplus` |
| Path | `optional-skills/security/implementing-fuzz-testing-in-cicd-with-aflplusplus` |
| Version | `1.0` |
