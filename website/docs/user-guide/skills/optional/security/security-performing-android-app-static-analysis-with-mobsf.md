---
title: "Performing Android App Static Analysis With Mobsf — Performs automated static analysis of Android applications"
sidebar_label: "Performing Android App Static Analysis With Mobsf"
description: "Performs automated static analysis of Android applications"
---
...
Performs automated static analysis of Android applications

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/performing-android-app-static-analysis-with-mobsf` |
| Path | `optional-skills/security/performing-android-app-static-analysis-with-mobsf` |
| Version | `1.0.0` |
