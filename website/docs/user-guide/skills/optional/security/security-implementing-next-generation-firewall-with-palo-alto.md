---
title: "Implementing Next Generation Firewall With Palo Alto — Configures and deploys Palo Alto Networks next-generation"
sidebar_label: "Implementing Next Generation Firewall With Palo Alto"
description: "Configures and deploys Palo Alto Networks next-generation"
---
...
Configures and deploys Palo Alto Networks next-generation

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/implementing-next-generation-firewall-with-palo-alto` |
| Path | `optional-skills/security/implementing-next-generation-firewall-with-palo-alto` |
| Version | `1.0` |
| Author | mahipal (vendored by SOCIS) |
| License | Apache-2.0 |
| Platforms | linux, macos, windows |
| Tags | `palo-alto`, `ngfw`, `firewall`, `app-id`, `user-id`, `threat-prevention`, `network-security`, `ssl-decryption` |
