---
title: "Implementing Ics Firewall With Tofino — Deploys and configures Tofino industrial firewalls"
sidebar_label: "Implementing Ics Firewall With Tofino"
description: "Deploys and configures Tofino industrial firewalls"
---
...
| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/implementing-ics-firewall-with-tofino` |
| Path | `optional-skills/security/implementing-ics-firewall-with-tofino` |
| Version | `1.0` |
