---
title: "Detecting Ai Model Prompt Injection Attacks — Detects prompt injection using regex signature matching"
sidebar_label: "Detecting Ai Model Prompt Injection Attacks"
description: "Detects prompt injection using regex signature matching"
---
...
Detects prompt injection using regex signature matching

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/detecting-ai-model-prompt-injection-attacks` |
| Path | `optional-skills/security/detecting-ai-model-prompt-injection-attacks` |
| Version | `1.0.0` |
