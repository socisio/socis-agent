---
title: "Configuring Hsm For Key Storage — Configures Hardware Security Modules for cryptographic key"
sidebar_label: "Configuring Hsm For Key Storage"
description: "Configures Hardware Security Modules for cryptographic key"
---
...
Configures Hardware Security Modules for cryptographic key

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/configuring-hsm-for-key-storage` |
| Path | `optional-skills/security/configuring-hsm-for-key-storage` |
| Version | `1.0` |
