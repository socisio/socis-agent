---
title: "Performing Endpoint Forensics Investigation — Performs digital forensics investigation on compromised"
sidebar_label: "Performing Endpoint Forensics Investigation"
description: "Performs digital forensics investigation on compromised"
---
...
Performs digital forensics investigation on compromised

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/performing-endpoint-forensics-investigation` |
| Path | `optional-skills/security/performing-endpoint-forensics-investigation` |
| Version | `1.0.0` |
