---
title: "Building Incident Response Dashboard — Builds real-time incident response dashboards in Splunk"
sidebar_label: "Building Incident Response Dashboard"
description: "Builds real-time incident response dashboards in Splunk"
---
...
Builds real-time incident response dashboards in Splunk

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/building-incident-response-dashboard` |
| Path | `optional-skills/security/building-incident-response-dashboard` |
| Version | `1.0` |
