---
title: "Detecting Azure Lateral Movement — Detect lateral movement in Azure AD/Entra ID environments"
sidebar_label: "Detecting Azure Lateral Movement"
description: "Detect lateral movement in Azure AD/Entra ID environments"
---
...
Detect lateral movement in Azure AD/Entra ID environments

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/detecting-azure-lateral-movement` |
| Path | `optional-skills/security/detecting-azure-lateral-movement` |
| Version | `1.0` |
