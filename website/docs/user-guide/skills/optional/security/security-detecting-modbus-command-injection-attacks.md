---
title: "Detecting Modbus Command Injection Attacks — Detect command injection against Modbus TCP/RTU in"
sidebar_label: "Detecting Modbus Command Injection Attacks"
description: "Detect command injection against Modbus TCP/RTU in"
---
...
Detect command injection against Modbus TCP/RTU in

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/detecting-modbus-command-injection-attacks` |
| Path | `optional-skills/security/detecting-modbus-command-injection-attacks` |
| Version | `1.0` |
