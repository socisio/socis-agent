---
title: "Implementing Disk Encryption With Bitlocker — Implements full disk encryption using Microsoft BitLocker"
sidebar_label: "Implementing Disk Encryption With Bitlocker"
description: "Implements full disk encryption using Microsoft BitLocker"
---
...
Implements full disk encryption using Microsoft BitLocker

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/implementing-disk-encryption-with-bitlocker` |
| Path | `optional-skills/security/implementing-disk-encryption-with-bitlocker` |
| Version | `1.0.0` |
