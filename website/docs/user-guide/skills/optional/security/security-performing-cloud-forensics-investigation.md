---
title: "Performing Cloud Forensics Investigation — Collect and analyze cloud forensic evidence using AWS CLI"
sidebar_label: "Performing Cloud Forensics Investigation"
description: "Collect and analyze cloud forensic evidence using AWS CLI"
---
...
Collect and analyze cloud forensic evidence using AWS CLI

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/performing-cloud-forensics-investigation` |
| Path | `optional-skills/security/performing-cloud-forensics-investigation` |
| Version | `1.0` |
