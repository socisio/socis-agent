---
title: "Performing Disk Forensics Investigation — Conduct disk forensics investigations using forensic"
sidebar_label: "Performing Disk Forensics Investigation"
description: "Conduct disk forensics investigations using forensic"
---
...
Conduct disk forensics investigations using forensic

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/performing-disk-forensics-investigation` |
| Path | `optional-skills/security/performing-disk-forensics-investigation` |
| Version | `1.0.0` |
