---
title: "Performing Supply Chain Attack Simulation — Simulates and detects software supply chain attacks"
sidebar_label: "Performing Supply Chain Attack Simulation"
description: "Simulates and detects software supply chain attacks"
---
...
Simulates and detects software supply chain attacks

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/performing-supply-chain-attack-simulation` |
| Path | `optional-skills/security/performing-supply-chain-attack-simulation` |
| Version | `1.0` |
