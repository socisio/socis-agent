---
title: "Detecting Malicious Npm Packages — Triage npm packages and lockfiles for install-script"
sidebar_label: "Detecting Malicious Npm Packages"
description: "Triage npm packages and lockfiles for install-script"
---
...
Triage npm packages and lockfiles for install-script

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/detecting-malicious-npm-packages` |
| Path | `optional-skills/security/detecting-malicious-npm-packages` |
| Version | `1.0` |
| Author | mahipal (vendored by SOCIS) |
| License | Apache-2.0 |
| Platforms | linux, macos, windows |
| Tags | `supply-chain-security`, `npm`, `malware-analysis`, `guarddog`, `install-scripts`, `exfiltration`, `static-analysis`, `threat-detection` |
