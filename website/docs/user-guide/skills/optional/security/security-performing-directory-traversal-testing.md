---
title: "Performing Directory Traversal Testing — Test web applications for path traversal and Local/Remote"
sidebar_label: "Performing Directory Traversal Testing"
description: "Test web applications for path traversal and Local/Remote"
---
...
Test web applications for path traversal and Local/Remote

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/performing-directory-traversal-testing` |
| Path | `optional-skills/security/performing-directory-traversal-testing` |
| Version | `1.0` |
