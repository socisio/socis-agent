---
title: "Performing Threat Hunting With Elastic Siem — Performs proactive threat hunting in Elastic Security SIEM"
sidebar_label: "Performing Threat Hunting With Elastic Siem"
description: "Performs proactive threat hunting in Elastic Security SIEM"
---
...
Performs proactive threat hunting in Elastic Security SIEM

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/performing-threat-hunting-with-elastic-siem` |
| Path | `optional-skills/security/performing-threat-hunting-with-elastic-siem` |
| Version | `1.0` |
