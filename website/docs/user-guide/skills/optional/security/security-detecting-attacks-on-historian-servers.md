---
title: "Detecting Attacks On Historian Servers — Detect cyber attacks on OT historian servers (OSIsoft PI"
sidebar_label: "Detecting Attacks On Historian Servers"
description: "Detect cyber attacks on OT historian servers (OSIsoft PI"
---
...
Detect cyber attacks on OT historian servers (OSIsoft PI

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/detecting-attacks-on-historian-servers` |
| Path | `optional-skills/security/detecting-attacks-on-historian-servers` |
| Version | `1.0` |
