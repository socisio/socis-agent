---
title: "Implementing Azure Defender For Cloud — Enable Microsoft Defender for Cloud (CSPM + CWPP) across"
sidebar_label: "Implementing Azure Defender For Cloud"
description: "Enable Microsoft Defender for Cloud (CSPM + CWPP) across"
---
...
Enable Microsoft Defender for Cloud (CSPM + CWPP) across

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/implementing-azure-defender-for-cloud` |
| Path | `optional-skills/security/implementing-azure-defender-for-cloud` |
| Version | `1.0` |
