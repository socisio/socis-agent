---
title: "Mapping Mitre Attack Techniques — Maps observed adversary behaviors, security alerts, and"
sidebar_label: "Mapping Mitre Attack Techniques"
description: "Maps observed adversary behaviors, security alerts, and"
---
...
Maps observed adversary behaviors, security alerts, and

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/mapping-mitre-attack-techniques` |
| Path | `optional-skills/security/mapping-mitre-attack-techniques` |
| Version | `1.0.0` |
