---
title: "Performing Ios App Security Assessment — Performs comprehensive iOS application security assessments"
sidebar_label: "Performing Ios App Security Assessment"
description: "Performs comprehensive iOS application security assessments"
---
...
Performs comprehensive iOS application security assessments

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/performing-ios-app-security-assessment` |
| Path | `optional-skills/security/performing-ios-app-security-assessment` |
| Version | `1.0.0` |
