---
title: "Implementing Secrets Scanning In Ci Cd — Integrate gitleaks and trufflehog into CI/CD pipelines to"
sidebar_label: "Implementing Secrets Scanning In Ci Cd"
description: "Integrate gitleaks and trufflehog into CI/CD pipelines to"
---
...
Integrate gitleaks and trufflehog into CI/CD pipelines to

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/implementing-secrets-scanning-in-ci-cd` |
| Path | `optional-skills/security/implementing-secrets-scanning-in-ci-cd` |
| Version | `1.0` |
