---
title: "Deploying Palo Alto Prisma Access Zero Trust — Deploys Palo Alto Networks Prisma Access for SASE-based"
sidebar_label: "Deploying Palo Alto Prisma Access Zero Trust"
description: "Deploys Palo Alto Networks Prisma Access for SASE-based"
---
...
Deploys Palo Alto Networks Prisma Access for SASE-based

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/deploying-palo-alto-prisma-access-zero-trust` |
| Path | `optional-skills/security/deploying-palo-alto-prisma-access-zero-trust` |
| Version | `1.0` |
