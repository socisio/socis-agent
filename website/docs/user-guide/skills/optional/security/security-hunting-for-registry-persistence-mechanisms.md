---
title: "Hunting For Registry Persistence Mechanisms — Hunts for registry-based persistence mechanisms (MITRE"
sidebar_label: "Hunting For Registry Persistence Mechanisms"
description: "Hunts for registry-based persistence mechanisms (MITRE"
---
...
Hunts for registry-based persistence mechanisms (MITRE

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/hunting-for-registry-persistence-mechanisms` |
| Path | `optional-skills/security/hunting-for-registry-persistence-mechanisms` |
| Version | `1.0` |
