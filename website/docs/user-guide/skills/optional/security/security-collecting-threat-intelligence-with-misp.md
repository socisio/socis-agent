---
title: "Collecting Threat Intelligence With Misp — Deploy MISP, configure threat feeds (MISP community"
sidebar_label: "Collecting Threat Intelligence With Misp"
description: "Deploy MISP, configure threat feeds (MISP community"
---
...
Deploy MISP, configure threat feeds (MISP community

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/collecting-threat-intelligence-with-misp` |
| Path | `optional-skills/security/collecting-threat-intelligence-with-misp` |
| Version | `1.0` |
