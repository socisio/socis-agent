---
title: "Building Role Mining For Rbac Optimization — Apply bottom-up and top-down role mining techniques"
sidebar_label: "Building Role Mining For Rbac Optimization"
description: "Apply bottom-up and top-down role mining techniques"
---
...
Apply bottom-up and top-down role mining techniques

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/building-role-mining-for-rbac-optimization` |
| Path | `optional-skills/security/building-role-mining-for-rbac-optimization` |
| Version | `1.0` |
