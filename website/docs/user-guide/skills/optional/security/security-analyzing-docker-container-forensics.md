---
title: "Analyzing Docker Container Forensics — Investigate compromised Docker containers by analyzing"
sidebar_label: "Analyzing Docker Container Forensics"
description: "Investigate compromised Docker containers by analyzing"
---
...
Investigate compromised Docker containers by analyzing

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/analyzing-docker-container-forensics` |
| Path | `optional-skills/security/analyzing-docker-container-forensics` |
| Version | `1.0` |
