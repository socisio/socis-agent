---
title: "Defending Llms With Guardrails — Deploys Llama Guard 3 safety classification, NeMo"
sidebar_label: "Defending Llms With Guardrails"
description: "Deploys Llama Guard 3 safety classification, NeMo"
---
...
Deploys Llama Guard 3 safety classification, NeMo

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/defending-llms-with-guardrails` |
| Path | `optional-skills/security/defending-llms-with-guardrails` |
| Version | `1.0` |
| Author | mahipal (vendored by SOCIS) |
| License | Apache-2.0 |
| Platforms | linux, macos, windows |
| Tags | `ai-security`, `llm-guardrails`, `llama-guard`, `nemo-guardrails`, `llm-guard`, `prompt-injection`, `content-moderation`, `runtime-defense` |
