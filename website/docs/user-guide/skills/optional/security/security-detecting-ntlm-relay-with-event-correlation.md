---
title: "Detecting Ntlm Relay With Event Correlation — Detect NTLM relay attacks (T1557.001) by correlating"
sidebar_label: "Detecting Ntlm Relay With Event Correlation"
description: "Detect NTLM relay attacks (T1557.001) by correlating"
---
...
Detect NTLM relay attacks (T1557.001) by correlating

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/detecting-ntlm-relay-with-event-correlation` |
| Path | `optional-skills/security/detecting-ntlm-relay-with-event-correlation` |
| Version | `1.0` |
| Author | mukul975 (vendored by SOCIS) |
| License | Apache-2.0 |
| Platforms | linux, macos, windows |
| Tags | `threat-hunting`, `NTLM-relay`, `event-correlation`, `T1557.001`, `Event-4624`, `Responder`, `SMB-signing`, `LDAP-signing` |
