---
title: "Analyzing Outlook Pst For Email Forensics — Parse Microsoft Outlook PST and OST files using libpff and"
sidebar_label: "Analyzing Outlook Pst For Email Forensics"
description: "Parse Microsoft Outlook PST and OST files using libpff and"
---
...
Parse Microsoft Outlook PST and OST files using libpff and

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/analyzing-outlook-pst-for-email-forensics` |
| Path | `optional-skills/security/analyzing-outlook-pst-for-email-forensics` |
| Version | `1.0` |
| Author | mahipal (vendored by SOCIS) |
| License | Apache-2.0 |
| Platforms | linux, macos, windows |
| Tags | `email-forensics`, `pst`, `ost`, `outlook`, `mapi`, `email-headers`, `attachments`, `deleted-emails` |
