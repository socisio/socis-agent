---
title: "Implementing Canary Tokens For Network Intrusion — Deploys DNS, HTTP, and AWS API key canary tokens across"
sidebar_label: "Implementing Canary Tokens For Network Intrusion"
description: "Deploys DNS, HTTP, and AWS API key canary tokens across"
---
...
Deploys DNS, HTTP, and AWS API key canary tokens across

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/implementing-canary-tokens-for-network-intrusion` |
| Path | `optional-skills/security/implementing-canary-tokens-for-network-intrusion` |
| Version | `1.0` |
