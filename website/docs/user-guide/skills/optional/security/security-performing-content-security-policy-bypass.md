---
title: "Performing Content Security Policy Bypass — Analyze Content-Security-Policy headers and bypass them to"
sidebar_label: "Performing Content Security Policy Bypass"
description: "Analyze Content-Security-Policy headers and bypass them to"
---
...
Analyze Content-Security-Policy headers and bypass them to

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/performing-content-security-policy-bypass` |
| Path | `optional-skills/security/performing-content-security-policy-bypass` |
| Version | `1.0` |
