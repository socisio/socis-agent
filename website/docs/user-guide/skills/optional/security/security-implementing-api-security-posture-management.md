---
title: "Implementing Api Security Posture Management — Implements API Security Posture Management (API-SPM) to"
sidebar_label: "Implementing Api Security Posture Management"
description: "Implements API Security Posture Management (API-SPM) to"
---
...
Implements API Security Posture Management (API-SPM) to

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/implementing-api-security-posture-management` |
| Path | `optional-skills/security/implementing-api-security-posture-management` |
| Version | `1.0` |
