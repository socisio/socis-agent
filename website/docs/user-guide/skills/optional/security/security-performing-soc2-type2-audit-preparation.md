---
title: "Performing Soc2 Type2 Audit Preparation — Automates SOC 2 Type II audit preparation including gap"
sidebar_label: "Performing Soc2 Type2 Audit Preparation"
description: "Automates SOC 2 Type II audit preparation including gap"
---
...
Automates SOC 2 Type II audit preparation including gap

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/performing-soc2-type2-audit-preparation` |
| Path | `optional-skills/security/performing-soc2-type2-audit-preparation` |
| Version | `1.0` |
| Author | mukul975 (vendored by SOCIS) |
| License | Apache-2.0 |
| Platforms | linux, macos, windows |
| Tags | `soc2`, `compliance`, `grc`, `aicpa-tsc`, `audit-preparation`, `governance-risk-compliance` |
