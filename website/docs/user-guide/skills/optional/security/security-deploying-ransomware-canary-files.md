---
title: "Deploying Ransomware Canary Files — Deploys and monitors ransomware canary files using Python's"
sidebar_label: "Deploying Ransomware Canary Files"
description: "Deploys and monitors ransomware canary files using Python's"
---
...
Deploys and monitors ransomware canary files using Python's

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/deploying-ransomware-canary-files` |
| Path | `optional-skills/security/deploying-ransomware-canary-files` |
| Version | `1.0.0` |
