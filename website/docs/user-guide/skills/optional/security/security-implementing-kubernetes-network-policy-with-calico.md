---
title: "Implementing Kubernetes Network Policy With Calico — Installs Calico as the cluster CNI and writes standard"
sidebar_label: "Implementing Kubernetes Network Policy With Calico"
description: "Installs Calico as the cluster CNI and writes standard"
---
...
Installs Calico as the cluster CNI and writes standard

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/implementing-kubernetes-network-policy-with-calico` |
| Path | `optional-skills/security/implementing-kubernetes-network-policy-with-calico` |
| Version | `1.0` |
