---
title: "Performing Clickjacking Attack Test — Testing web applications for clickjacking vulnerabilities"
sidebar_label: "Performing Clickjacking Attack Test"
description: "Testing web applications for clickjacking vulnerabilities"
---
...
Testing web applications for clickjacking vulnerabilities

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/performing-clickjacking-attack-test` |
| Path | `optional-skills/security/performing-clickjacking-attack-test` |
| Version | `1.0` |
