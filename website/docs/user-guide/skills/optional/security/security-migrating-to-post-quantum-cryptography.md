---
title: "Migrating To Post Quantum Cryptography — Build a cryptographic inventory/CBOM with OpenSSL 3.5+"
sidebar_label: "Migrating To Post Quantum Cryptography"
description: "Build a cryptographic inventory/CBOM with OpenSSL 3.5+"
---
...
Build a cryptographic inventory/CBOM with OpenSSL 3.5+

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/migrating-to-post-quantum-cryptography` |
| Path | `optional-skills/security/migrating-to-post-quantum-cryptography` |
| Version | `1.0` |
