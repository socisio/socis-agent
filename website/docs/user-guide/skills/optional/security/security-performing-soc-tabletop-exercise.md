---
title: "Performing Soc Tabletop Exercise — Performs tabletop exercises for SOC teams simulating"
sidebar_label: "Performing Soc Tabletop Exercise"
description: "Performs tabletop exercises for SOC teams simulating"
---
...
Performs tabletop exercises for SOC teams simulating

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/performing-soc-tabletop-exercise` |
| Path | `optional-skills/security/performing-soc-tabletop-exercise` |
| Version | `1.0` |
