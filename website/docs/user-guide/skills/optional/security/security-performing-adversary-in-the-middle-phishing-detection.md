---
title: "Performing Adversary In The Middle Phishing Detection — Detect and respond to Adversary-in-the-Middle (AiTM)"
sidebar_label: "Performing Adversary In The Middle Phishing Detection"
description: "Detect and respond to Adversary-in-the-Middle (AiTM)"
---
...
Detect and respond to Adversary-in-the-Middle (AiTM)

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/performing-adversary-in-the-middle-phishing-detection` |
| Path | `optional-skills/security/performing-adversary-in-the-middle-phishing-detection` |
| Version | `1.0` |
