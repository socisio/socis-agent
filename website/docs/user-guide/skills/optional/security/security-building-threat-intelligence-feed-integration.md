---
title: "Building Threat Intelligence Feed Integration — Builds automated threat intelligence feed integration"
sidebar_label: "Building Threat Intelligence Feed Integration"
description: "Builds automated threat intelligence feed integration"
---
...
Builds automated threat intelligence feed integration

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/building-threat-intelligence-feed-integration` |
| Path | `optional-skills/security/building-threat-intelligence-feed-integration` |
| Version | `1.0` |
