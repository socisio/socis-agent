---
title: "Acquiring Disk Image With Dd And Dcfldd — Create forensically sound bit-for-bit disk images with dd"
sidebar_label: "Acquiring Disk Image With Dd And Dcfldd"
description: "Create forensically sound bit-for-bit disk images with dd"
---
...
Create forensically sound bit-for-bit disk images with dd

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/acquiring-disk-image-with-dd-and-dcfldd` |
| Path | `optional-skills/security/acquiring-disk-image-with-dd-and-dcfldd` |
| Version | `1.0` |
