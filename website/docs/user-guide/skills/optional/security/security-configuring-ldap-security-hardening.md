---
title: "Configuring Ldap Security Hardening — Hardens LDAP directory services against credential"
sidebar_label: "Configuring Ldap Security Hardening"
description: "Hardens LDAP directory services against credential"
---
...
Hardens LDAP directory services against credential

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/configuring-ldap-security-hardening` |
| Path | `optional-skills/security/configuring-ldap-security-hardening` |
| Version | `1.0` |
