---
title: "Configuring Aws Verified Access For Ztna — Configure AWS Verified Access to provide VPN-less zero"
sidebar_label: "Configuring Aws Verified Access For Ztna"
description: "Configure AWS Verified Access to provide VPN-less zero"
---
...
Configure AWS Verified Access to provide VPN-less zero

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/configuring-aws-verified-access-for-ztna` |
| Path | `optional-skills/security/configuring-aws-verified-access-for-ztna` |
| Version | `1.0` |
| Author | mahipal (vendored by SOCIS) |
| License | Apache-2.0 |
| Platforms | linux, macos, windows |
| Tags | `zero-trust`, `aws`, `verified-access`, `ztna`, `cedar-policy`, `vpn-less`, `identity-verification`, `device-posture` |
