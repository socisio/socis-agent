---
title: "Performing Kubernetes Cis Benchmark With Kube Bench — Turns kube-bench output into a finished CIS Kubernetes"
sidebar_label: "Performing Kubernetes Cis Benchmark With Kube Bench"
description: "Turns kube-bench output into a finished CIS Kubernetes"
---
...
Turns kube-bench output into a finished CIS Kubernetes

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/performing-kubernetes-cis-benchmark-with-kube-bench` |
| Path | `optional-skills/security/performing-kubernetes-cis-benchmark-with-kube-bench` |
| Version | `1.0` |
