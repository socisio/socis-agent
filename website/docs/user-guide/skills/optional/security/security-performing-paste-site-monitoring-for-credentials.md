---
title: "Performing Paste Site Monitoring For Credentials — Monitor paste sites like Pastebin and GitHub Gists for"
sidebar_label: "Performing Paste Site Monitoring For Credentials"
description: "Monitor paste sites like Pastebin and GitHub Gists for"
---
...
Monitor paste sites like Pastebin and GitHub Gists for

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/performing-paste-site-monitoring-for-credentials` |
| Path | `optional-skills/security/performing-paste-site-monitoring-for-credentials` |
| Version | `1.0` |
