---
title: "Performing Firmware Extraction With Binwalk — Performs firmware image extraction and analysis using"
sidebar_label: "Performing Firmware Extraction With Binwalk"
description: "Performs firmware image extraction and analysis using"
---
...
Performs firmware image extraction and analysis using

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/performing-firmware-extraction-with-binwalk` |
| Path | `optional-skills/security/performing-firmware-extraction-with-binwalk` |
| Version | `1.0.0` |
