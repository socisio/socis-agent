---
title: "Configuring Identity Aware Proxy With Google Iap — Configures Google Cloud Identity-Aware Proxy (IAP) via"
sidebar_label: "Configuring Identity Aware Proxy With Google Iap"
description: "Configures Google Cloud Identity-Aware Proxy (IAP) via"
---
...
Configures Google Cloud Identity-Aware Proxy (IAP) via

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/configuring-identity-aware-proxy-with-google-iap` |
| Path | `optional-skills/security/configuring-identity-aware-proxy-with-google-iap` |
| Version | `1.0` |
