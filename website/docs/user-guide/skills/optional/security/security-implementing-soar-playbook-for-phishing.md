---
title: "Implementing Soar Playbook For Phishing — Automates phishing incident response by calling the Splunk"
sidebar_label: "Implementing Soar Playbook For Phishing"
description: "Automates phishing incident response by calling the Splunk"
---
...
Automates phishing incident response by calling the Splunk

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/implementing-soar-playbook-for-phishing` |
| Path | `optional-skills/security/implementing-soar-playbook-for-phishing` |
| Version | `1.0` |
