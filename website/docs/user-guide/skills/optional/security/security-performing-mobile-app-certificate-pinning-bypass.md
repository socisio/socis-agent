---
title: "Performing Mobile App Certificate Pinning Bypass — Bypasses SSL/TLS certificate pinning implementations in"
sidebar_label: "Performing Mobile App Certificate Pinning Bypass"
description: "Bypasses SSL/TLS certificate pinning implementations in"
---
...
Bypasses SSL/TLS certificate pinning implementations in

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/performing-mobile-app-certificate-pinning-bypass` |
| Path | `optional-skills/security/performing-mobile-app-certificate-pinning-bypass` |
| Version | `1.0.0` |
