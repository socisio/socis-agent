---
title: "Implementing Mimecast Targeted Attack Protection — Deploys and configures Mimecast Targeted Threat Protection"
sidebar_label: "Implementing Mimecast Targeted Attack Protection"
description: "Deploys and configures Mimecast Targeted Threat Protection"
---
...
Deploys and configures Mimecast Targeted Threat Protection

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/implementing-mimecast-targeted-attack-protection` |
| Path | `optional-skills/security/implementing-mimecast-targeted-attack-protection` |
| Version | `1.0` |
