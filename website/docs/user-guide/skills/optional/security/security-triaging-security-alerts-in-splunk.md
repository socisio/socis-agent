---
title: "Triaging Security Alerts In Splunk — Triages security alerts in Splunk Enterprise Security by"
sidebar_label: "Triaging Security Alerts In Splunk"
description: "Triages security alerts in Splunk Enterprise Security by"
---
...
Triages security alerts in Splunk Enterprise Security by

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/triaging-security-alerts-in-splunk` |
| Path | `optional-skills/security/triaging-security-alerts-in-splunk` |
| Version | `1.0` |
