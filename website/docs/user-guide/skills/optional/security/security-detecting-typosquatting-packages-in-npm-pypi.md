---
title: "Detecting Typosquatting Packages In Npm Pypi — Detects typosquatting attacks in npm and PyPI package"
sidebar_label: "Detecting Typosquatting Packages In Npm Pypi"
description: "Detects typosquatting attacks in npm and PyPI package"
---
...
Detects typosquatting attacks in npm and PyPI package

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/detecting-typosquatting-packages-in-npm-pypi` |
| Path | `optional-skills/security/detecting-typosquatting-packages-in-npm-pypi` |
| Version | `1.0.0` |
