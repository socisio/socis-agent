---
title: "Detecting Lateral Movement With Zeek — Detect lateral movement in network traffic using Zeek"
sidebar_label: "Detecting Lateral Movement With Zeek"
description: "Detect lateral movement in network traffic using Zeek"
---
...
Detect lateral movement in network traffic using Zeek

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/detecting-lateral-movement-with-zeek` |
| Path | `optional-skills/security/detecting-lateral-movement-with-zeek` |
| Version | `1.0` |
