---
title: "Detecting Indirect Prompt Injection — Detect and defend against indirect prompt injection hidden"
sidebar_label: "Detecting Indirect Prompt Injection"
description: "Detect and defend against indirect prompt injection hidden"
---
...
| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/detecting-indirect-prompt-injection` |
| Path | `optional-skills/security/detecting-indirect-prompt-injection` |
| Version | `1.0` |
