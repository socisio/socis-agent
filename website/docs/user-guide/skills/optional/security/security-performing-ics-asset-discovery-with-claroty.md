---
title: "Performing Ics Asset Discovery With Claroty — Performs ICS/OT asset discovery with Claroty xDome"
sidebar_label: "Performing Ics Asset Discovery With Claroty"
description: "Performs ICS/OT asset discovery with Claroty xDome"
---
...
Performs ICS/OT asset discovery with Claroty xDome

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/performing-ics-asset-discovery-with-claroty` |
| Path | `optional-skills/security/performing-ics-asset-discovery-with-claroty` |
| Version | `1.0` |
