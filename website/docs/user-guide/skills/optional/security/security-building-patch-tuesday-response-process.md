---
title: "Building Patch Tuesday Response Process — Establish a repeatable operational process for triaging"
sidebar_label: "Building Patch Tuesday Response Process"
description: "Establish a repeatable operational process for triaging"
---
...
Establish a repeatable operational process for triaging

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/building-patch-tuesday-response-process` |
| Path | `optional-skills/security/building-patch-tuesday-response-process` |
| Version | `1.0` |
