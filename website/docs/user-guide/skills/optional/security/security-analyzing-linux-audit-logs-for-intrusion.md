---
title: "Analyzing Linux Audit Logs For Intrusion — Uses the Linux Audit framework (auditd) with ausearch and"
...
| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/analyzing-linux-audit-logs-for-intrusion` |
| Path | `optional-skills/security/analyzing-linux-audit-logs-for-intrusion` |
| Version | `1.0.0` |
