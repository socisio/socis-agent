---
title: "Extracting Credentials From Memory Dump — Extracts cached credentials, password hashes, Kerberos"
sidebar_label: "Extracting Credentials From Memory Dump"
description: "Extracts cached credentials, password hashes, Kerberos"
---
...
Extracts cached credentials, password hashes, Kerberos

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/extracting-credentials-from-memory-dump` |
| Path | `optional-skills/security/extracting-credentials-from-memory-dump` |
| Version | `1.0` |
