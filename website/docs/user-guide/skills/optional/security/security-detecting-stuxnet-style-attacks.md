---
title: "Detecting Stuxnet Style Attacks — Detects sophisticated cyber-physical attacks that follow"
sidebar_label: "Detecting Stuxnet Style Attacks"
description: "Detects sophisticated cyber-physical attacks that follow"
---
...
Detects sophisticated cyber-physical attacks that follow

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/detecting-stuxnet-style-attacks` |
| Path | `optional-skills/security/detecting-stuxnet-style-attacks` |
| Version | `1.0.0` |
