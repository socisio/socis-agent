---
title: "Scanning Iac And Images With Trivy — Scans container images, Infrastructure-as-Code (Terraform"
sidebar_label: "Scanning Iac And Images With Trivy"
description: "Scans container images, Infrastructure-as-Code (Terraform"
---
...
Scans container images, Infrastructure-as-Code (Terraform

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/scanning-iac-and-images-with-trivy` |
| Path | `optional-skills/security/scanning-iac-and-images-with-trivy` |
| Version | `1.0` |
| Author | mahipal (vendored by SOCIS) |
| License | Apache-2.0 |
| Platforms | linux, macos, windows |
| Tags | `devsecops`, `trivy`, `container-security`, `vulnerability-scanning`, `iac-security`, `sbom`, `ci-cd`, `misconfiguration` |
