---
title: "Performing Container Escape Detection — Audits container and pod configuration for escape-enabling"
sidebar_label: "Performing Container Escape Detection"
description: "Audits container and pod configuration for escape-enabling"
---
...
Audits container and pod configuration for escape-enabling

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/performing-container-escape-detection` |
| Path | `optional-skills/security/performing-container-escape-detection` |
| Version | `1.0` |
| Author | mahipal (vendored by SOCIS) |
| License | Apache-2.0 |
| Platforms | linux, macos, windows |
| Tags | `container-security`, `container-escape`, `privileged-container`, `namespace-analysis`, `linux-capabilities`, `threat-detection` |
