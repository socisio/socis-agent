---
title: "Performing Post Quantum Cryptography Migration — Assesses organizational readiness for post-quantum"
sidebar_label: "Performing Post Quantum Cryptography Migration"
description: "Assesses organizational readiness for post-quantum"
---
...
Assesses organizational readiness for post-quantum

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/performing-post-quantum-cryptography-migration` |
| Path | `optional-skills/security/performing-post-quantum-cryptography-migration` |
| Version | `1.0` |
| Author | mukul975 (vendored by SOCIS) |
| License | Apache-2.0 |
| Platforms | linux, macos, windows |
| Tags | `post-quantum`, `PQC`, `CRYSTALS-Kyber`, `ML-KEM`, `ML-DSA`, `FIPS-203`, `FIPS-204`, `hybrid-TLS` |
