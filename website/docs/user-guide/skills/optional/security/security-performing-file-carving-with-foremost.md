---
title: "Performing File Carving With Foremost — Recovers files from disk images and unallocated space using"
sidebar_label: "Performing File Carving With Foremost"
description: "Recovers files from disk images and unallocated space using"
---
...
Recovers files from disk images and unallocated space using

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/performing-file-carving-with-foremost` |
| Path | `optional-skills/security/performing-file-carving-with-foremost` |
| Version | `1.0` |
