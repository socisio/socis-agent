---
title: "Performing Brand Monitoring For Impersonation — Monitor for brand impersonation attacks across domains"
sidebar_label: "Performing Brand Monitoring For Impersonation"
description: "Monitor for brand impersonation attacks across domains"
---
...
Monitor for brand impersonation attacks across domains

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/performing-brand-monitoring-for-impersonation` |
| Path | `optional-skills/security/performing-brand-monitoring-for-impersonation` |
| Version | `1.0` |
