---
title: "Detecting Aws Credential Exposure With Trufflehog — Scan source code repositories, CI/CD pipelines, and"
sidebar_label: "Detecting Aws Credential Exposure With Trufflehog"
description: "Scan source code repositories, CI/CD pipelines, and"
---
...
Scan source code repositories, CI/CD pipelines, and

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/detecting-aws-credential-exposure-with-trufflehog` |
| Path | `optional-skills/security/detecting-aws-credential-exposure-with-trufflehog` |
| Version | `1.0` |
