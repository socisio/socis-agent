---
title: "Deploying Tailscale For Zero Trust Vpn — Deploys and configures Tailscale (or self-hosted Headscale)"
sidebar_label: "Deploying Tailscale For Zero Trust Vpn"
description: "Deploys and configures Tailscale (or self-hosted Headscale)"
---
...
Deploys and configures Tailscale (or self-hosted Headscale)

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/deploying-tailscale-for-zero-trust-vpn` |
| Path | `optional-skills/security/deploying-tailscale-for-zero-trust-vpn` |
| Version | `1.0` |
| Author | mahipal (vendored by SOCIS) |
| License | Apache-2.0 |
| Platforms | linux, macos, windows |
| Tags | `zero-trust`, `tailscale`, `wireguard`, `mesh-vpn`, `ztna`, `peer-to-peer`, `acl`, `identity-aware` |
