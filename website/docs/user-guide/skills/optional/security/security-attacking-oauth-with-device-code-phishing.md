---
title: "Attacking Oauth With Device Code Phishing — Run OAuth 2.0 device-code and illicit-consent phishing"
sidebar_label: "Attacking Oauth With Device Code Phishing"
description: "Run OAuth 2.0 device-code and illicit-consent phishing"
---
...
Run OAuth 2.0 device-code and illicit-consent phishing

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/attacking-oauth-with-device-code-phishing` |
| Path | `optional-skills/security/attacking-oauth-with-device-code-phishing` |
| Version | `1.0` |
