---
title: "Hunting For Lolbins Execution In Endpoint Logs — Hunts for LOLBins (Living Off the Land Binaries) abuse"
sidebar_label: "Hunting For Lolbins Execution In Endpoint Logs"
description: "Hunts for LOLBins (Living Off the Land Binaries) abuse"
---
...
Hunts for LOLBins (Living Off the Land Binaries) abuse

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/hunting-for-lolbins-execution-in-endpoint-logs` |
| Path | `optional-skills/security/hunting-for-lolbins-execution-in-endpoint-logs` |
| Version | `1.0` |
