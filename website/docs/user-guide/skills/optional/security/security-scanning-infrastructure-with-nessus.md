---
title: "Scanning Infrastructure With Nessus — Tenable Nessus is the industry-leading vulnerability"
sidebar_label: "Scanning Infrastructure With Nessus"
description: "Tenable Nessus is the industry-leading vulnerability"
---
...
Tenable Nessus is the industry-leading vulnerability

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/scanning-infrastructure-with-nessus` |
| Path | `optional-skills/security/scanning-infrastructure-with-nessus` |
| Version | `1.0` |
