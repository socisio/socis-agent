---
title: "Testing For Json Web Token Vulnerabilities — Tests JWT implementations for algorithm confusion, \"none\""
sidebar_label: "Testing For Json Web Token Vulnerabilities"
description: "Tests JWT implementations for algorithm confusion, \"none\""
---
...
Tests JWT implementations for algorithm confusion, "none"

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/testing-for-json-web-token-vulnerabilities` |
| Path | `optional-skills/security/testing-for-json-web-token-vulnerabilities` |
| Version | `1.0` |
