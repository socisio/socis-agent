---
title: "Modeling Threats With Opencti — Deploy OpenCTI (Filigran) via Docker Compose and use the"
sidebar_label: "Modeling Threats With Opencti"
description: "Deploy OpenCTI (Filigran) via Docker Compose and use the"
---
...
Deploy OpenCTI (Filigran) via Docker Compose and use the

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/modeling-threats-with-opencti` |
| Path | `optional-skills/security/modeling-threats-with-opencti` |
| Version | `1.0` |
| Author | mahipal (vendored by SOCIS) |
| License | Apache-2.0 |
| Platforms | linux, macos, windows |
| Tags | `opencti`, `threat-intelligence`, `stix2`, `pycti`, `knowledge-graph`, `threat-modeling`, `mitre-attack`, `cti` |
