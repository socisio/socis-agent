---
title: "Detecting Data And Model Poisoning — Identify poisoned training data and backdoored ML models"
sidebar_label: "Detecting Data And Model Poisoning"
description: "Identify poisoned training data and backdoored ML models"
---
...
Identify poisoned training data and backdoored ML models

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/detecting-data-and-model-poisoning` |
| Path | `optional-skills/security/detecting-data-and-model-poisoning` |
| Version | `1.0` |
