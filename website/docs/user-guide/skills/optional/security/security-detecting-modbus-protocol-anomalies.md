---
title: "Detecting Modbus Protocol Anomalies — Detect anomalies in Modbus/TCP and Modbus RTU industrial"
sidebar_label: "Detecting Modbus Protocol Anomalies"
description: "Detect anomalies in Modbus/TCP and Modbus RTU industrial"
---
...
Detect anomalies in Modbus/TCP and Modbus RTU industrial

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/detecting-modbus-protocol-anomalies` |
| Path | `optional-skills/security/detecting-modbus-protocol-anomalies` |
| Version | `1.0.0` |
