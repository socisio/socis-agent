---
title: "Implementing Anti Phishing Training Program — Guides designing, deploying, and measuring an anti-phishing"
sidebar_label: "Implementing Anti Phishing Training Program"
description: "Guides designing, deploying, and measuring an anti-phishing"
---
...
Guides designing, deploying, and measuring an anti-phishing

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/implementing-anti-phishing-training-program` |
| Path | `optional-skills/security/implementing-anti-phishing-training-program` |
| Version | `1.0` |
