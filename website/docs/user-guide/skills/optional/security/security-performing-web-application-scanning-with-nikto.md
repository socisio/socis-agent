---
title: "Performing Web Application Scanning With Nikto — Runs Nikto, an open-source web server and web application"
sidebar_label: "Performing Web Application Scanning With Nikto"
description: "Runs Nikto, an open-source web server and web application"
---
...
Runs Nikto, an open-source web server and web application

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/performing-web-application-scanning-with-nikto` |
| Path | `optional-skills/security/performing-web-application-scanning-with-nikto` |
| Version | `1.0` |
