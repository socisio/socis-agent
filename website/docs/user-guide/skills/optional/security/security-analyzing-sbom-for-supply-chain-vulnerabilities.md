---
title: "Analyzing Sbom For Supply Chain Vulnerabilities — Parses Software Bill of Materials (SBOM) in CycloneDX and"
sidebar_label: "Analyzing Sbom For Supply Chain Vulnerabilities"
description: "Parses Software Bill of Materials (SBOM) in CycloneDX and"
---
...
Parses Software Bill of Materials (SBOM) in CycloneDX and

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/analyzing-sbom-for-supply-chain-vulnerabilities` |
| Path | `optional-skills/security/analyzing-sbom-for-supply-chain-vulnerabilities` |
| Version | `1.0.0` |
| Author | mukul975 (vendored by SOCIS) |
| License | Apache-2.0 |
| Platforms | linux, macos, windows |
| Tags | `SBOM`, `CycloneDX`, `SPDX`, `NVD`, `CVE`, `supply-chain`, `dependency-analysis`, `syft` |
