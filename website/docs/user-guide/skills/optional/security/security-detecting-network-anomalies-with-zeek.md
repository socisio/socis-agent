---
title: "Detecting Network Anomalies With Zeek — Deploy and configure Zeek (formerly Bro) to passively"
sidebar_label: "Detecting Network Anomalies With Zeek"
description: "Deploy and configure Zeek (formerly Bro) to passively"
---
...
Deploy and configure Zeek (formerly Bro) to passively

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/detecting-network-anomalies-with-zeek` |
| Path | `optional-skills/security/detecting-network-anomalies-with-zeek` |
| Version | `1.0` |
