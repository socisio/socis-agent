---
title: "Implementing Rbac Hardening For Kubernetes — Hardens Kubernetes RBAC by designing least-privilege Roles"
sidebar_label: "Implementing Rbac Hardening For Kubernetes"
description: "Hardens Kubernetes RBAC by designing least-privilege Roles"
---
...
Hardens Kubernetes RBAC by designing least-privilege Roles

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/implementing-rbac-hardening-for-kubernetes` |
| Path | `optional-skills/security/implementing-rbac-hardening-for-kubernetes` |
| Version | `1.0` |
