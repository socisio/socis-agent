---
title: "Configuring Windows Defender Advanced Settings — Configures Microsoft Defender for Endpoint (MDE) advanced"
sidebar_label: "Configuring Windows Defender Advanced Settings"
description: "Configures Microsoft Defender for Endpoint (MDE) advanced"
---
...
Configures Microsoft Defender for Endpoint (MDE) advanced

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/configuring-windows-defender-advanced-settings` |
| Path | `optional-skills/security/configuring-windows-defender-advanced-settings` |
| Version | `1.0.0` |
