---
title: "Hardening Linux Endpoint With Cis Benchmark — Hardens Linux endpoints using CIS Benchmark recommendations"
sidebar_label: "Hardening Linux Endpoint With Cis Benchmark"
description: "Hardens Linux endpoints using CIS Benchmark recommendations"
---
...
Hardens Linux endpoints using CIS Benchmark recommendations

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/hardening-linux-endpoint-with-cis-benchmark` |
| Path | `optional-skills/security/hardening-linux-endpoint-with-cis-benchmark` |
| Version | `1.0.0` |
