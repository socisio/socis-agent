---
title: "Implementing Zero Trust Dns With Nextdns — Configure NextDNS as an encrypted (DoH/DoT) zero trust DNS"
sidebar_label: "Implementing Zero Trust Dns With Nextdns"
description: "Configure NextDNS as an encrypted (DoH/DoT) zero trust DNS"
---
...
Configure NextDNS as an encrypted (DoH/DoT) zero trust DNS

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/implementing-zero-trust-dns-with-nextdns` |
| Path | `optional-skills/security/implementing-zero-trust-dns-with-nextdns` |
| Version | `1.0` |
| Author | mahipal (vendored by SOCIS) |
| License | Apache-2.0 |
| Platforms | linux, macos, windows |
| Tags | `zero-trust`, `dns`, `nextdns`, `dns-over-https`, `dns-over-tls`, `threat-blocking`, `dns-filtering`, `privacy` |
