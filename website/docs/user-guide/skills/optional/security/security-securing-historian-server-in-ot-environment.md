---
title: "Securing Historian Server In Ot Environment — Audits and hardens process historian servers (OSIsoft PI"
sidebar_label: "Securing Historian Server In Ot Environment"
description: "Audits and hardens process historian servers (OSIsoft PI"
---
...
Audits and hardens process historian servers (OSIsoft PI

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/securing-historian-server-in-ot-environment` |
| Path | `optional-skills/security/securing-historian-server-in-ot-environment` |
| Version | `1.0.0` |
