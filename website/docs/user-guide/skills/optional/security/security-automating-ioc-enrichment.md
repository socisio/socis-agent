---
title: "Automating Ioc Enrichment — Automates the enrichment of raw indicators of compromise"
sidebar_label: "Automating Ioc Enrichment"
description: "Automates the enrichment of raw indicators of compromise"
---
...
Automates the enrichment of raw indicators of compromise

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/automating-ioc-enrichment` |
| Path | `optional-skills/security/automating-ioc-enrichment` |
| Version | `1.0.0` |
| Author | team-cybersecurity (vendored by SOCIS) |
| License | Apache-2.0 |
| Platforms | linux, macos, windows |
| Tags | `SOAR`, `enrichment`, `IOC`, `Cortex-XSOAR`, `Splunk-SOAR`, `VirusTotal`, `automation`, `CTI` |
