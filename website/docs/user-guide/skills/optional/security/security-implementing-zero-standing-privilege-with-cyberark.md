---
title: "Implementing Zero Standing Privilege With Cyberark — Deploy CyberArk Secure Cloud Access (SCA) to eliminate"
sidebar_label: "Implementing Zero Standing Privilege With Cyberark"
description: "Deploy CyberArk Secure Cloud Access (SCA) to eliminate"
---
...
Deploy CyberArk Secure Cloud Access (SCA) to eliminate

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/implementing-zero-standing-privilege-with-cyberark` |
| Path | `optional-skills/security/implementing-zero-standing-privilege-with-cyberark` |
| Version | `1.0` |
