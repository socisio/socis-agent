---
title: "Securing Github Actions Workflows — Hardens GitHub Actions workflows against supply chain"
sidebar_label: "Securing Github Actions Workflows"
description: "Hardens GitHub Actions workflows against supply chain"
---
...
Hardens GitHub Actions workflows against supply chain

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/securing-github-actions-workflows` |
| Path | `optional-skills/security/securing-github-actions-workflows` |
| Version | `1.0.0` |
