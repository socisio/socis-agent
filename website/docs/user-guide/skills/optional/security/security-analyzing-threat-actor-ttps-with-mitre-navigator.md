---
title: "Analyzing Threat Actor Ttps With Mitre Navigator — Map advanced persistent threat (APT) group TTPs to the"
sidebar_label: "Analyzing Threat Actor Ttps With Mitre Navigator"
description: "Map advanced persistent threat (APT) group TTPs to the"
---
...
Map advanced persistent threat (APT) group TTPs to the

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/analyzing-threat-actor-ttps-with-mitre-navigator` |
| Path | `optional-skills/security/analyzing-threat-actor-ttps-with-mitre-navigator` |
| Version | `1.0` |
