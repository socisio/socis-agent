---
title: "Securing Remote Access To Ot Environment — Designs and configures secure remote access to OT/ICS"
sidebar_label: "Securing Remote Access To Ot Environment"
description: "Designs and configures secure remote access to OT/ICS"
---
...
Designs and configures secure remote access to OT/ICS

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/securing-remote-access-to-ot-environment` |
| Path | `optional-skills/security/securing-remote-access-to-ot-environment` |
| Version | `1.0.0` |
