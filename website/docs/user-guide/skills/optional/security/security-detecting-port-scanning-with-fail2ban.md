---
title: "Detecting Port Scanning With Fail2Ban — Configures Fail2ban with custom filters and actions to"
sidebar_label: "Detecting Port Scanning With Fail2Ban"
description: "Configures Fail2ban with custom filters and actions to"
---
...
Configures Fail2ban with custom filters and actions to

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/detecting-port-scanning-with-fail2ban` |
| Path | `optional-skills/security/detecting-port-scanning-with-fail2ban` |
| Version | `1.0` |
