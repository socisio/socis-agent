---
title: "Performing Timeline Reconstruction With Plaso — Builds comprehensive forensic super-timelines using Plaso"
sidebar_label: "Performing Timeline Reconstruction With Plaso"
description: "Builds comprehensive forensic super-timelines using Plaso"
---
...
Builds comprehensive forensic super-timelines using Plaso

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/performing-timeline-reconstruction-with-plaso` |
| Path | `optional-skills/security/performing-timeline-reconstruction-with-plaso` |
| Version | `1.0` |
