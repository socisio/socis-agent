---
title: "Detecting Dns Exfiltration With Dns Query Analysis — Detect data exfiltration via DNS tunneling (tools like"
sidebar_label: "Detecting Dns Exfiltration With Dns Query Analysis"
description: "Detect data exfiltration via DNS tunneling (tools like"
---
...
Detect data exfiltration via DNS tunneling (tools like

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/detecting-dns-exfiltration-with-dns-query-analysis` |
| Path | `optional-skills/security/detecting-dns-exfiltration-with-dns-query-analysis` |
| Version | `1.0` |
| Author | mahipal (vendored by SOCIS) |
| License | Apache-2.0 |
| Platforms | linux, macos, windows |
| Tags | `dns-exfiltration`, `dns-tunneling`, `data-exfiltration`, `threat-detection`, `entropy-analysis`, `passive-dns`, `network-monitoring`, `iodine` |
