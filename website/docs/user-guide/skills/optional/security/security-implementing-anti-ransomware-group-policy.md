---
title: "Implementing Anti Ransomware Group Policy — Configures Windows Group Policy Objects to block ransomware"
sidebar_label: "Implementing Anti Ransomware Group Policy"
description: "Configures Windows Group Policy Objects to block ransomware"
---
...
Configures Windows Group Policy Objects to block ransomware

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/implementing-anti-ransomware-group-policy` |
| Path | `optional-skills/security/implementing-anti-ransomware-group-policy` |
| Version | `1.0.0` |
