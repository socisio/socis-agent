---
title: "Performing Phishing Simulation With Gophish — Deploy and run authorized phishing awareness campaigns with"
sidebar_label: "Performing Phishing Simulation With Gophish"
description: "Deploy and run authorized phishing awareness campaigns with"
---
...
Deploy and run authorized phishing awareness campaigns with

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/performing-phishing-simulation-with-gophish` |
| Path | `optional-skills/security/performing-phishing-simulation-with-gophish` |
| Version | `1.0` |
