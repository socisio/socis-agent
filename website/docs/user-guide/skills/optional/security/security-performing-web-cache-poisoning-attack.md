---
title: "Performing Web Cache Poisoning Attack — Exploiting web cache mechanisms to serve malicious content"
sidebar_label: "Performing Web Cache Poisoning Attack"
description: "Exploiting web cache mechanisms to serve malicious content"
---
...
Exploiting web cache mechanisms to serve malicious content

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/performing-web-cache-poisoning-attack` |
| Path | `optional-skills/security/performing-web-cache-poisoning-attack` |
| Version | `1.0` |
