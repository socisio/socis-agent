---
title: "Building Attack Pattern Library From Cti Reports — Parse cyber threat intelligence reports (Mandiant"
sidebar_label: "Building Attack Pattern Library From Cti Reports"
description: "Parse cyber threat intelligence reports (Mandiant"
---
...
Parse cyber threat intelligence reports (Mandiant

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/building-attack-pattern-library-from-cti-reports` |
| Path | `optional-skills/security/building-attack-pattern-library-from-cti-reports` |
| Version | `1.0` |
