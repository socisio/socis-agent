---
title: "Evaluating Threat Intelligence Platforms — Evaluates and selects Threat Intelligence Platform (TIP)"
sidebar_label: "Evaluating Threat Intelligence Platforms"
description: "Evaluates and selects Threat Intelligence Platform (TIP)"
---
...
Evaluates and selects Threat Intelligence Platform (TIP)

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/evaluating-threat-intelligence-platforms` |
| Path | `optional-skills/security/evaluating-threat-intelligence-platforms` |
| Version | `1.0.0` |
| Author | team-cybersecurity (vendored by SOCIS) |
| License | Apache-2.0 |
| Platforms | linux, macos, windows |
| Tags | `TIP`, `ThreatConnect`, `MISP`, `OpenCTI`, `Anomali`, `EclecticIQ`, `STIX-TAXII`, `CTI-program` |
