---
title: "Detecting Privilege Escalation In Kubernetes Pods — Detects and prevents privilege escalation inside Kubernetes"
sidebar_label: "Detecting Privilege Escalation In Kubernetes Pods"
description: "Detects and prevents privilege escalation inside Kubernetes"
---
...
Detects and prevents privilege escalation inside Kubernetes

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/detecting-privilege-escalation-in-kubernetes-pods` |
| Path | `optional-skills/security/detecting-privilege-escalation-in-kubernetes-pods` |
| Version | `1.0` |
