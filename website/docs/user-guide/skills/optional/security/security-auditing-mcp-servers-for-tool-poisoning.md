---
title: "Auditing Mcp Servers For Tool Poisoning — Audit MCP servers for tool poisoning, tool shadowing, rug"
sidebar_label: "Auditing Mcp Servers For Tool Poisoning"
description: "Audit MCP servers for tool poisoning, tool shadowing, rug"
---
...
Audit MCP servers for tool poisoning, tool shadowing, rug

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/auditing-mcp-servers-for-tool-poisoning` |
| Path | `optional-skills/security/auditing-mcp-servers-for-tool-poisoning` |
| Version | `1.0` |
| Author | mahipal (vendored by SOCIS) |
| License | Apache-2.0 |
| Platforms | linux, macos, windows |
| Tags | `ai-security`, `mcp`, `tool-poisoning`, `agent-security`, `mcp-scan`, `ssrf`, `supply-chain`, `rug-pull` |
