---
title: "Implementing Dragos Platform For Ot Monitoring — Deploys and configures Dragos Platform sensors and"
sidebar_label: "Implementing Dragos Platform For Ot Monitoring"
description: "Deploys and configures Dragos Platform sensors and"
---
...
Deploys and configures Dragos Platform sensors and

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/implementing-dragos-platform-for-ot-monitoring` |
| Path | `optional-skills/security/implementing-dragos-platform-for-ot-monitoring` |
| Version | `1.0` |
