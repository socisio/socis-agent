---
title: "Implementing Soar Automation With Phantom — Implements Security Orchestration, Automation, and Response"
sidebar_label: "Implementing Soar Automation With Phantom"
description: "Implements Security Orchestration, Automation, and Response"
---
...
Implements Security Orchestration, Automation, and Response

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/implementing-soar-automation-with-phantom` |
| Path | `optional-skills/security/implementing-soar-automation-with-phantom` |
| Version | `1.0` |
