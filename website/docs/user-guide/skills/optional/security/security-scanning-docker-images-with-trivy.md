---
title: "Scanning Docker Images With Trivy — Scans a Docker image with Trivy for vulnerabilities in OS"
sidebar_label: "Scanning Docker Images With Trivy"
description: "Scans a Docker image with Trivy for vulnerabilities in OS"
---
...
Scans a Docker image with Trivy for vulnerabilities in OS

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/scanning-docker-images-with-trivy` |
| Path | `optional-skills/security/scanning-docker-images-with-trivy` |
| Version | `1.0` |
