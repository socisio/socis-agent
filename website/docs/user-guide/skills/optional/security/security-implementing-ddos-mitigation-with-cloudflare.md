---
title: "Implementing Ddos Mitigation With Cloudflare — Configure Cloudflare DDoS protection with managed rulesets"
sidebar_label: "Implementing Ddos Mitigation With Cloudflare"
description: "Configure Cloudflare DDoS protection with managed rulesets"
---
...
Configure Cloudflare DDoS protection with managed rulesets

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/implementing-ddos-mitigation-with-cloudflare` |
| Path | `optional-skills/security/implementing-ddos-mitigation-with-cloudflare` |
| Version | `1.0` |
| Author | mahipal (vendored by SOCIS) |
| License | Apache-2.0 |
| Platforms | linux, macos, windows |
| Tags | `ddos`, `cloudflare`, `ddos-mitigation`, `rate-limiting`, `waf`, `bot-management`, `layer-7`, `volumetric-attack` |
