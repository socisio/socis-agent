---
title: "Performing Hash Cracking With Hashcat — Cracks password hashes with Hashcat, covering hash-type"
sidebar_label: "Performing Hash Cracking With Hashcat"
description: "Cracks password hashes with Hashcat, covering hash-type"
---
...
Cracks password hashes with Hashcat, covering hash-type

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/performing-hash-cracking-with-hashcat` |
| Path | `optional-skills/security/performing-hash-cracking-with-hashcat` |
| Version | `1.0` |
