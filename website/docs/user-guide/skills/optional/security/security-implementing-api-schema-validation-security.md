---
title: "Implementing Api Schema Validation Security — Implements API schema validation using OpenAPI"
sidebar_label: "Implementing Api Schema Validation Security"
description: "Implements API schema validation using OpenAPI"
---
...
| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/implementing-api-schema-validation-security` |
| Path | `optional-skills/security/implementing-api-schema-validation-security` |
| Version | `1.0` |
