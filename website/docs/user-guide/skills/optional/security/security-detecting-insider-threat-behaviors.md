---
title: "Detecting Insider Threat Behaviors — Detect insider threat behavioral indicators including"
sidebar_label: "Detecting Insider Threat Behaviors"
description: "Detect insider threat behavioral indicators including"
---
...
Detect insider threat behavioral indicators including

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/detecting-insider-threat-behaviors` |
| Path | `optional-skills/security/detecting-insider-threat-behaviors` |
| Version | `1.0` |
