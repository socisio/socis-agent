---
title: "Enumerating Cloud With Cloudfox — Run CloudFox's read-only Describe/List/Get enumeration"
sidebar_label: "Enumerating Cloud With Cloudfox"
description: "Run CloudFox's read-only Describe/List/Get enumeration"
---
...
Run CloudFox's read-only Describe/List/Get enumeration

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/enumerating-cloud-with-cloudfox` |
| Path | `optional-skills/security/enumerating-cloud-with-cloudfox` |
| Version | `1.0` |
| Author | mahipal (vendored by SOCIS) |
| License | Apache-2.0 |
| Platforms | linux, macos, windows |
| Tags | `cloudfox`, `aws`, `azure`, `cloud-pentest`, `attack-paths`, `situational-awareness`, `enumeration`, `offensive-security` |
