---
title: "Hunting For Data Staging Before Exfiltration — Detect data-staging activity (MITRE ATT&CK T1074) by"
sidebar_label: "Hunting For Data Staging Before Exfiltration"
description: "Detect data-staging activity (MITRE ATT&CK T1074) by"
---
...
Detect data-staging activity (MITRE ATT&CK T1074) by

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/hunting-for-data-staging-before-exfiltration` |
| Path | `optional-skills/security/hunting-for-data-staging-before-exfiltration` |
| Version | `1.0` |
