---
title: "Detecting Privilege Escalation Attempts — Detect privilege escalation attempts across Windows and"
sidebar_label: "Detecting Privilege Escalation Attempts"
description: "Detect privilege escalation attempts across Windows and"
---
...
Detect privilege escalation attempts across Windows and

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/detecting-privilege-escalation-attempts` |
| Path | `optional-skills/security/detecting-privilege-escalation-attempts` |
| Version | `1.0` |
