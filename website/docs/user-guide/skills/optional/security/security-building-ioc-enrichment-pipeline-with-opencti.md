---
title: "Building Ioc Enrichment Pipeline With Opencti — Build an automated IOC enrichment pipeline on OpenCTI (STIX"
sidebar_label: "Building Ioc Enrichment Pipeline With Opencti"
description: "Build an automated IOC enrichment pipeline on OpenCTI (STIX"
---
...
Build an automated IOC enrichment pipeline on OpenCTI (STIX

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/building-ioc-enrichment-pipeline-with-opencti` |
| Path | `optional-skills/security/building-ioc-enrichment-pipeline-with-opencti` |
| Version | `1.0` |
