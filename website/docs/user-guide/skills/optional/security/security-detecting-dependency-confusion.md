---
title: "Detecting Dependency Confusion — Detect and prevent dependency confusion"
sidebar_label: "Detecting Dependency Confusion"
description: "Detect and prevent dependency confusion"
---
...
Detect and prevent dependency confusion

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/detecting-dependency-confusion` |
| Path | `optional-skills/security/detecting-dependency-confusion` |
| Version | `1.0` |
| Author | mahipal (vendored by SOCIS) |
| License | Apache-2.0 |
| Platforms | linux, macos, windows |
| Tags | `supply-chain-security`, `dependency-confusion`, `npm`, `pypi`, `maven`, `package-management`, `devsecops`, `namespace-hijacking` |
