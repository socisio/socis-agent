---
title: "Implementing Network Deception With Honeypots — Deploy and manage network honeypots using OpenCanary"
sidebar_label: "Implementing Network Deception With Honeypots"
description: "Deploy and manage network honeypots using OpenCanary"
---
...
Deploy and manage network honeypots using OpenCanary

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/implementing-network-deception-with-honeypots` |
| Path | `optional-skills/security/implementing-network-deception-with-honeypots` |
| Version | `1.0` |
