---
title: "Hunting For Data Exfiltration Indicators — Hunt for data exfiltration by analyzing Zeek and Suricata"
sidebar_label: "Hunting For Data Exfiltration Indicators"
description: "Hunt for data exfiltration by analyzing Zeek and Suricata"
---
...
Hunt for data exfiltration by analyzing Zeek and Suricata

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/hunting-for-data-exfiltration-indicators` |
| Path | `optional-skills/security/hunting-for-data-exfiltration-indicators` |
| Version | `1.0` |
