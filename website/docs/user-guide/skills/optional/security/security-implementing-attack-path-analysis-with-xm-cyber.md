---
title: "Implementing Attack Path Analysis With Xm Cyber — Deploys XM Cyber's continuous exposure management platform"
sidebar_label: "Implementing Attack Path Analysis With Xm Cyber"
description: "Deploys XM Cyber's continuous exposure management platform"
---
...
Deploys XM Cyber's continuous exposure management platform

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/implementing-attack-path-analysis-with-xm-cyber` |
| Path | `optional-skills/security/implementing-attack-path-analysis-with-xm-cyber` |
| Version | `1.0` |
