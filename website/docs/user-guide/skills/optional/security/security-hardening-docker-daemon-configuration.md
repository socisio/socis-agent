---
title: "Hardening Docker Daemon Configuration — Hardens the Docker daemon (dockerd) through"
sidebar_label: "Hardening Docker Daemon Configuration"
description: "Hardens the Docker daemon (dockerd) through"
---
...
Hardens the Docker daemon (dockerd) through

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/hardening-docker-daemon-configuration` |
| Path | `optional-skills/security/hardening-docker-daemon-configuration` |
| Version | `1.0` |
