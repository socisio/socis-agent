---
title: "Hunting For Persistence Mechanisms In Windows — Systematically hunts for adversary persistence mechanisms"
sidebar_label: "Hunting For Persistence Mechanisms In Windows"
description: "Systematically hunts for adversary persistence mechanisms"
---
...
Systematically hunts for adversary persistence mechanisms

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/hunting-for-persistence-mechanisms-in-windows` |
| Path | `optional-skills/security/hunting-for-persistence-mechanisms-in-windows` |
| Version | `1.0` |
