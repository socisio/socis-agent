---
title: "Executing Nist Rmf Authorization To Operate — Drive a federal system through the NIST Risk Management"
sidebar_label: "Executing Nist Rmf Authorization To Operate"
description: "Drive a federal system through the NIST Risk Management"
---
...
Drive a federal system through the NIST Risk Management

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/executing-nist-rmf-authorization-to-operate` |
| Path | `optional-skills/security/executing-nist-rmf-authorization-to-operate` |
| Version | `1.0` |
| Author | andrewibrah (vendored by SOCIS) |
| License | Apache-2.0 |
| Platforms | linux, macos, windows |
| Tags | `nist-rmf`, `nist-800-37`, `ato`, `fisma`, `fedramp`, `nist-800-53`, `fips-199`, `ssp` |
