---
title: "Implementing Semgrep For Custom Sast Rules — Write custom Semgrep SAST rules in YAML to detect"
sidebar_label: "Implementing Semgrep For Custom Sast Rules"
description: "Write custom Semgrep SAST rules in YAML to detect"
---
...
Write custom Semgrep SAST rules in YAML to detect

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/implementing-semgrep-for-custom-sast-rules` |
| Path | `optional-skills/security/implementing-semgrep-for-custom-sast-rules` |
| Version | `1.0` |
