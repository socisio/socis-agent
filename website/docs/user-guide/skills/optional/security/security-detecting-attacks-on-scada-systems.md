---
title: "Detecting Attacks On Scada Systems — This skill covers detecting cyber attacks targeting"
sidebar_label: "Detecting Attacks On Scada Systems"
description: "This skill covers detecting cyber attacks targeting"
---
...
This skill covers detecting cyber attacks targeting

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/detecting-attacks-on-scada-systems` |
| Path | `optional-skills/security/detecting-attacks-on-scada-systems` |
| Version | `1.0.0` |
