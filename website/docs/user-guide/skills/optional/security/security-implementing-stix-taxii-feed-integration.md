---
title: "Implementing Stix Taxii Feed Integration — Implements a STIX 2.1/TAXII 2.1 threat-intelligence feed"
sidebar_label: "Implementing Stix Taxii Feed Integration"
description: "Implements a STIX 2.1/TAXII 2.1 threat-intelligence feed"
---
...
Implements a STIX 2.1/TAXII 2.1 threat-intelligence feed

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/implementing-stix-taxii-feed-integration` |
| Path | `optional-skills/security/implementing-stix-taxii-feed-integration` |
| Version | `1.0` |
