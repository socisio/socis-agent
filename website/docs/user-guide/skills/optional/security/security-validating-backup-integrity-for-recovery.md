---
title: "Validating Backup Integrity For Recovery — Validates backup integrity through cryptographic hash"
sidebar_label: "Validating Backup Integrity For Recovery"
description: "Validates backup integrity through cryptographic hash"
---
...
Validates backup integrity through cryptographic hash

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/validating-backup-integrity-for-recovery` |
| Path | `optional-skills/security/validating-backup-integrity-for-recovery` |
| Version | `1.0` |
