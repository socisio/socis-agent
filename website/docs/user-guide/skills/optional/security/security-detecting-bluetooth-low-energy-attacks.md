---
title: "Detecting Bluetooth Low Energy Attacks — Detects and analyzes Bluetooth Low Energy (BLE) security"
sidebar_label: "Detecting Bluetooth Low Energy Attacks"
description: "Detects and analyzes Bluetooth Low Energy (BLE) security"
---
...
Detects and analyzes Bluetooth Low Energy (BLE) security

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/detecting-bluetooth-low-energy-attacks` |
| Path | `optional-skills/security/detecting-bluetooth-low-energy-attacks` |
| Version | `1.0.0` |
