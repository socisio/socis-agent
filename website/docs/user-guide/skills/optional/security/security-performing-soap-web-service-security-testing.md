---
title: "Performing Soap Web Service Security Testing — Performs security testing of SOAP web services by analyzing"
sidebar_label: "Performing Soap Web Service Security Testing"
description: "Performs security testing of SOAP web services by analyzing"
---
...
Performs security testing of SOAP web services by analyzing

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/performing-soap-web-service-security-testing` |
| Path | `optional-skills/security/performing-soap-web-service-security-testing` |
| Version | `1.0` |
| Author | mahipal (vendored by SOCIS) |
| License | Apache-2.0 |
| Platforms | linux, macos, windows |
| Tags | `soap`, `web-services`, `wsdl`, `xml-injection`, `xxe`, `ws-security`, `penetration-testing`, `soapaction-spoofing` |
