---
title: "Building Detection Rule With Splunk Spl — Build effective detection rules using Splunk Search"
sidebar_label: "Building Detection Rule With Splunk Spl"
description: "Build effective detection rules using Splunk Search"
---
...
Build effective detection rules using Splunk Search

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/building-detection-rule-with-splunk-spl` |
| Path | `optional-skills/security/building-detection-rule-with-splunk-spl` |
| Version | `1.0` |
