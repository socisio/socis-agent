---
title: "Testing For Xml Injection Vulnerabilities — Test web applications for XML injection vulnerabilities"
sidebar_label: "Testing For Xml Injection Vulnerabilities"
description: "Test web applications for XML injection vulnerabilities"
---
...
Test web applications for XML injection vulnerabilities

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/testing-for-xml-injection-vulnerabilities` |
| Path | `optional-skills/security/testing-for-xml-injection-vulnerabilities` |
| Version | `1.0` |
