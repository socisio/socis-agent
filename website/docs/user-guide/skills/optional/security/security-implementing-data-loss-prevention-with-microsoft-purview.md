---
title: "Implementing Data Loss Prevention With Microsoft Purview — Implements DLP policies using Microsoft Purview PowerShell"
sidebar_label: "Implementing Data Loss Prevention With Microsoft Purview"
description: "Implements DLP policies using Microsoft Purview PowerShell"
---
...
Implements DLP policies using Microsoft Purview PowerShell

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/implementing-data-loss-prevention-with-microsoft-purview` |
| Path | `optional-skills/security/implementing-data-loss-prevention-with-microsoft-purview` |
| Version | `1.0.0` |
