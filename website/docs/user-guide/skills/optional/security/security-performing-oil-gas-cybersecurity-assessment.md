---
title: "Performing Oil Gas Cybersecurity Assessment — Conduct cybersecurity assessments of upstream, midstream"
sidebar_label: "Performing Oil Gas Cybersecurity Assessment"
description: "Conduct cybersecurity assessments of upstream, midstream"
---
...
Conduct cybersecurity assessments of upstream, midstream

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/performing-oil-gas-cybersecurity-assessment` |
| Path | `optional-skills/security/performing-oil-gas-cybersecurity-assessment` |
| Version | `1.0.0` |
