---
title: "Performing Csrf Attack Simulation — Testing web applications for Cross-Site Request Forgery"
sidebar_label: "Performing Csrf Attack Simulation"
description: "Testing web applications for Cross-Site Request Forgery"
---
...
Testing web applications for Cross-Site Request Forgery

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/performing-csrf-attack-simulation` |
| Path | `optional-skills/security/performing-csrf-attack-simulation` |
| Version | `1.0` |
