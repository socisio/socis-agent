---
title: "Managing Cloud Identity With Okta — Implement Okta as a centralized cloud identity provider"
sidebar_label: "Managing Cloud Identity With Okta"
description: "Implement Okta as a centralized cloud identity provider"
---
...
Implement Okta as a centralized cloud identity provider

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/managing-cloud-identity-with-okta` |
| Path | `optional-skills/security/managing-cloud-identity-with-okta` |
| Version | `1.0.0` |
