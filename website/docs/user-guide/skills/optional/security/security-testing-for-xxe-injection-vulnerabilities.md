---
title: "Testing For Xxe Injection Vulnerabilities — Discovering and exploiting XML External Entity injection"
sidebar_label: "Testing For Xxe Injection Vulnerabilities"
description: "Discovering and exploiting XML External Entity injection"
---
...
Discovering and exploiting XML External Entity injection

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/testing-for-xxe-injection-vulnerabilities` |
| Path | `optional-skills/security/testing-for-xxe-injection-vulnerabilities` |
| Version | `1.0` |
