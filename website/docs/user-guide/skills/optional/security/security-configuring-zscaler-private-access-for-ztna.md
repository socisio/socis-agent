---
title: "Configuring Zscaler Private Access For Ztna — Configures Zscaler Private Access (ZPA) to replace"
sidebar_label: "Configuring Zscaler Private Access For Ztna"
description: "Configures Zscaler Private Access (ZPA) to replace"
---
...
Configures Zscaler Private Access (ZPA) to replace

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/configuring-zscaler-private-access-for-ztna` |
| Path | `optional-skills/security/configuring-zscaler-private-access-for-ztna` |
| Version | `1.0` |
