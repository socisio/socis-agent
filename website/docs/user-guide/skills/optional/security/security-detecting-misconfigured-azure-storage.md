---
title: "Detecting Misconfigured Azure Storage — Audit Azure Storage accounts for public blob containers"
...
| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/detecting-misconfigured-azure-storage` |
| Path | `optional-skills/security/detecting-misconfigured-azure-storage` |
| Version | `1.0` |
