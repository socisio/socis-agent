---
title: "Benchmarking Kubernetes With Kube Bench — Installs and runs the kube-bench tool against a Kubernetes"
sidebar_label: "Benchmarking Kubernetes With Kube Bench"
description: "Installs and runs the kube-bench tool against a Kubernetes"
---
...
Installs and runs the kube-bench tool against a Kubernetes

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/benchmarking-kubernetes-with-kube-bench` |
| Path | `optional-skills/security/benchmarking-kubernetes-with-kube-bench` |
| Version | `1.0` |
