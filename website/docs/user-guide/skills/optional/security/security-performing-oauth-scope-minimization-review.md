---
title: "Performing Oauth Scope Minimization Review — Performs OAuth 2.0 scope minimization review to identify"
sidebar_label: "Performing Oauth Scope Minimization Review"
description: "Performs OAuth 2.0 scope minimization review to identify"
---
...
Performs OAuth 2.0 scope minimization review to identify

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/performing-oauth-scope-minimization-review` |
| Path | `optional-skills/security/performing-oauth-scope-minimization-review` |
| Version | `1.0` |
