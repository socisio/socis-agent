---
title: "Detecting Api Enumeration Attacks — Detect API enumeration attacks (BOLA/IDOR, OWASP API1:2023)"
sidebar_label: "Detecting Api Enumeration Attacks"
description: "Detect API enumeration attacks (BOLA/IDOR, OWASP API1:2023)"
---
...
Detect API enumeration attacks (BOLA/IDOR, OWASP API1:2023)

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/detecting-api-enumeration-attacks` |
| Path | `optional-skills/security/detecting-api-enumeration-attacks` |
| Version | `1.0` |
