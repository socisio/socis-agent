---
title: "Triaging Vulnerabilities With Ssvc Framework — Triages and prioritizes vulnerabilities with CISA's"
sidebar_label: "Triaging Vulnerabilities With Ssvc Framework"
description: "Triages and prioritizes vulnerabilities with CISA's"
---
...
Triages and prioritizes vulnerabilities with CISA's

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/triaging-vulnerabilities-with-ssvc-framework` |
| Path | `optional-skills/security/triaging-vulnerabilities-with-ssvc-framework` |
| Version | `1.0` |
