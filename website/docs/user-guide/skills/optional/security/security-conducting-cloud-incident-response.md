---
title: "Conducting Cloud Incident Response — Respond to security incidents in AWS, Azure, and GCP via"
sidebar_label: "Conducting Cloud Incident Response"
description: "Respond to security incidents in AWS, Azure, and GCP via"
---
...
Respond to security incidents in AWS, Azure, and GCP via

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/conducting-cloud-incident-response` |
| Path | `optional-skills/security/conducting-cloud-incident-response` |
| Version | `1.0.0` |
