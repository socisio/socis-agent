---
title: "Generating Forensic Timelines With Hayabusa — Run Hayabusa against collected Windows EVTX files to apply"
sidebar_label: "Generating Forensic Timelines With Hayabusa"
description: "Run Hayabusa against collected Windows EVTX files to apply"
---
...
Run Hayabusa against collected Windows EVTX files to apply

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/generating-forensic-timelines-with-hayabusa` |
| Path | `optional-skills/security/generating-forensic-timelines-with-hayabusa` |
| Version | `1.0` |
| Author | mahipal (vendored by SOCIS) |
| License | Apache-2.0 |
| Platforms | linux, macos, windows |
| Tags | `hayabusa`, `dfir`, `evtx`, `sigma`, `timeline`, `threat-hunting`, `windows-event-logs`, `forensics` |
