---
title: "Performing Access Review And Certification — Designs and runs access review and certification"
...
Designs and runs access review and certification

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/performing-access-review-and-certification` |
| Path | `optional-skills/security/performing-access-review-and-certification` |
| Version | `1.0` |
