---
title: "Detecting T1055 Process Injection With Sysmon — Detect process injection techniques (T1055) - including DLL"
sidebar_label: "Detecting T1055 Process Injection With Sysmon"
description: "Detect process injection techniques (T1055) - including DLL"
---
...
Detect process injection techniques (T1055) - including DLL

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/detecting-t1055-process-injection-with-sysmon` |
| Path | `optional-skills/security/detecting-t1055-process-injection-with-sysmon` |
| Version | `1.0` |
