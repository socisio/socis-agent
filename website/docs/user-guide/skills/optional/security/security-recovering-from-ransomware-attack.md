---
title: "Recovering From Ransomware Attack — Executes structured ransomware incident recovery following"
sidebar_label: "Recovering From Ransomware Attack"
description: "Executes structured ransomware incident recovery following"
---
...
Executes structured ransomware incident recovery following

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/recovering-from-ransomware-attack` |
| Path | `optional-skills/security/recovering-from-ransomware-attack` |
| Version | `1.0.0` |
