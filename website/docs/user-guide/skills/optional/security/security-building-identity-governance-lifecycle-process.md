---
title: "Building Identity Governance Lifecycle Process — Design identity governance and lifecycle (IGA) programs on"
sidebar_label: "Building Identity Governance Lifecycle Process"
description: "Design identity governance and lifecycle (IGA) programs on"
---
...
Design identity governance and lifecycle (IGA) programs on

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/building-identity-governance-lifecycle-process` |
| Path | `optional-skills/security/building-identity-governance-lifecycle-process` |
| Version | `1.0` |
