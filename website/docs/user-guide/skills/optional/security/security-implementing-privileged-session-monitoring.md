---
title: "Implementing Privileged Session Monitoring — Implements privileged session monitoring and recording"
sidebar_label: "Implementing Privileged Session Monitoring"
description: "Implements privileged session monitoring and recording"
---
...
Implements privileged session monitoring and recording

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/implementing-privileged-session-monitoring` |
| Path | `optional-skills/security/implementing-privileged-session-monitoring` |
| Version | `1.0.0` |
