---
title: "Extracting Browser History Artifacts — Extracts and analyzes browser history, cookies, cache"
sidebar_label: "Extracting Browser History Artifacts"
description: "Extracts and analyzes browser history, cookies, cache"
---
...
Extracts and analyzes browser history, cookies, cache

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/extracting-browser-history-artifacts` |
| Path | `optional-skills/security/extracting-browser-history-artifacts` |
| Version | `1.0` |
