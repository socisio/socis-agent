---
title: "Performing Ot Network Security Assessment — This skill covers conducting comprehensive security"
sidebar_label: "Performing Ot Network Security Assessment"
description: "This skill covers conducting comprehensive security"
---
...
This skill covers conducting comprehensive security

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/performing-ot-network-security-assessment` |
| Path | `optional-skills/security/performing-ot-network-security-assessment` |
| Version | `1.0.0` |
