---
title: "Analyzing Browser Forensics With Hindsight — Parse Chromium-based browser databases with Hindsight to"
sidebar_label: "Analyzing Browser Forensics With Hindsight"
description: "Parse Chromium-based browser databases with Hindsight to"
---
...
Parse Chromium-based browser databases with Hindsight to

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/analyzing-browser-forensics-with-hindsight` |
| Path | `optional-skills/security/analyzing-browser-forensics-with-hindsight` |
| Version | `1.0` |
| Author | mahipal (vendored by SOCIS) |
| License | Apache-2.0 |
| Platforms | linux, macos, windows |
| Tags | `browser-forensics`, `hindsight`, `chrome-forensics`, `chromium`, `edge`, `browsing-history`, `cookies`, `downloads` |
