---
title: "Implementing Gcp Vpc Firewall Rules — Implements and audits GCP VPC firewall rules using gcloud"
sidebar_label: "Implementing Gcp Vpc Firewall Rules"
description: "Implements and audits GCP VPC firewall rules using gcloud"
---
...
Implements and audits GCP VPC firewall rules using gcloud

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/implementing-gcp-vpc-firewall-rules` |
| Path | `optional-skills/security/implementing-gcp-vpc-firewall-rules` |
| Version | `1.0` |
