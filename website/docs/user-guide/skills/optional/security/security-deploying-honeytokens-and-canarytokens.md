---
title: "Deploying Honeytokens And Canarytokens — Plants Canarytokens-based decoy artifacts (honey"
sidebar_label: "Deploying Honeytokens And Canarytokens"
description: "Plants Canarytokens-based decoy artifacts (honey"
---
...
Plants Canarytokens-based decoy artifacts (honey

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/deploying-honeytokens-and-canarytokens` |
| Path | `optional-skills/security/deploying-honeytokens-and-canarytokens` |
| Version | `1.0` |
| Author | mahipal (vendored by SOCIS) |
| License | Apache-2.0 |
| Platforms | linux, macos, windows |
| Tags | `deception-technology`, `canarytokens`, `honeytokens`, `breach-detection`, `threat-detection`, `d3fend`, `decoy-credentials`, `intrusion-detection` |
