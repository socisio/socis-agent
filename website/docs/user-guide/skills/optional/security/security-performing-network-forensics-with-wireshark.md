---
title: "Performing Network Forensics With Wireshark — Capture and analyze network traffic using Wireshark and"
sidebar_label: "Performing Network Forensics With Wireshark"
description: "Capture and analyze network traffic using Wireshark and"
---
...
Capture and analyze network traffic using Wireshark and

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/performing-network-forensics-with-wireshark` |
| Path | `optional-skills/security/performing-network-forensics-with-wireshark` |
| Version | `1.0` |
