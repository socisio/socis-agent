---
title: "Performing Dmarc Policy Enforcement Rollout — Execute a phased DMARC rollout by inventorying sending"
sidebar_label: "Performing Dmarc Policy Enforcement Rollout"
description: "Execute a phased DMARC rollout by inventorying sending"
---
...
Execute a phased DMARC rollout by inventorying sending

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/performing-dmarc-policy-enforcement-rollout` |
| Path | `optional-skills/security/performing-dmarc-policy-enforcement-rollout` |
| Version | `1.0` |
