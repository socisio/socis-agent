---
title: "Detecting Spearphishing With Email Gateway — Detect and block spearphishing emails that use"
sidebar_label: "Detecting Spearphishing With Email Gateway"
description: "Detect and block spearphishing emails that use"
---
...
Detect and block spearphishing emails that use

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/detecting-spearphishing-with-email-gateway` |
| Path | `optional-skills/security/detecting-spearphishing-with-email-gateway` |
| Version | `1.0` |
