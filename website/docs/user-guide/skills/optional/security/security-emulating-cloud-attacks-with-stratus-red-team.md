---
title: "Emulating Cloud Attacks With Stratus Red Team — Install and run Stratus Red Team to detonate granular"
sidebar_label: "Emulating Cloud Attacks With Stratus Red Team"
description: "Install and run Stratus Red Team to detonate granular"
---
...
Install and run Stratus Red Team to detonate granular

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/emulating-cloud-attacks-with-stratus-red-team` |
| Path | `optional-skills/security/emulating-cloud-attacks-with-stratus-red-team` |
| Version | `1.0` |
