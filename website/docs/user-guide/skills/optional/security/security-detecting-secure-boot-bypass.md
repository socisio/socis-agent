---
title: "Detecting Secure Boot Bypass — Detect UEFI Secure Boot bypasses and bootkits such as"
sidebar_label: "Detecting Secure Boot Bypass"
description: "Detect UEFI Secure Boot bypasses and bootkits such as"
---
...
Detect UEFI Secure Boot bypasses and bootkits such as

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/detecting-secure-boot-bypass` |
| Path | `optional-skills/security/detecting-secure-boot-bypass` |
| Version | `1.0` |
