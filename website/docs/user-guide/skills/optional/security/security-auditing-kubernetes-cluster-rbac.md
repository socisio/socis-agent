---
title: "Auditing Kubernetes Cluster Rbac — Auditing Kubernetes cluster RBAC configurations to identify"
sidebar_label: "Auditing Kubernetes Cluster Rbac"
description: "Auditing Kubernetes cluster RBAC configurations to identify"
---
...
Auditing Kubernetes cluster RBAC configurations to identify

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/auditing-kubernetes-cluster-rbac` |
| Path | `optional-skills/security/auditing-kubernetes-cluster-rbac` |
| Version | `1.0` |
