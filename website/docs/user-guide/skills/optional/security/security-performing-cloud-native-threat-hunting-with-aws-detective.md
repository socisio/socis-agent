---
title: "Performing Cloud Native Threat Hunting With Aws Detective — Investigate AWS security incidents using Amazon Detective's"
sidebar_label: "Performing Cloud Native Threat Hunting With Aws Detective"
description: "Investigate AWS security incidents using Amazon Detective's"
---
...
Investigate AWS security incidents using Amazon Detective's

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/performing-cloud-native-threat-hunting-with-aws-detective` |
| Path | `optional-skills/security/performing-cloud-native-threat-hunting-with-aws-detective` |
| Version | `1.0` |
| Author | juliosuas (vendored by SOCIS) |
| License | Apache-2.0 |
| Platforms | linux, macos, windows |
| Tags | `aws-detective`, `threat-hunting`, `cloud-security`, `guardduty`, `behavior-graph`, `aws`, `iam`, `ec2` |
