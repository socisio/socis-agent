---
title: "Performing Ransomware Tabletop Exercise — Plans and facilitates tabletop exercises simulating"
sidebar_label: "Performing Ransomware Tabletop Exercise"
description: "Plans and facilitates tabletop exercises simulating"
---
...
Plans and facilitates tabletop exercises simulating

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/performing-ransomware-tabletop-exercise` |
| Path | `optional-skills/security/performing-ransomware-tabletop-exercise` |
| Version | `1.0.0` |
