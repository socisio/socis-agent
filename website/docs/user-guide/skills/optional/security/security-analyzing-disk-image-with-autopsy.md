---
title: "Analyzing Disk Image With Autopsy — Perform comprehensive forensic analysis of raw (dd), E01"
sidebar_label: "Analyzing Disk Image With Autopsy"
description: "Perform comprehensive forensic analysis of raw (dd), E01"
---
...
Perform comprehensive forensic analysis of raw (dd), E01

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/analyzing-disk-image-with-autopsy` |
| Path | `optional-skills/security/analyzing-disk-image-with-autopsy` |
| Version | `1.0` |
