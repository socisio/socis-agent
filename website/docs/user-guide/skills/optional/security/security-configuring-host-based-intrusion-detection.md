---
title: "Configuring Host Based Intrusion Detection — Configures host-based intrusion detection systems (HIDS) to"
sidebar_label: "Configuring Host Based Intrusion Detection"
description: "Configures host-based intrusion detection systems (HIDS) to"
---
...
Configures host-based intrusion detection systems (HIDS) to

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/configuring-host-based-intrusion-detection` |
| Path | `optional-skills/security/configuring-host-based-intrusion-detection` |
| Version | `1.0.0` |
