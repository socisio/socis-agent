---
title: "Managing Third Party Vendor Risk — Build and run a third-party/vendor risk management (TPRM)"
sidebar_label: "Managing Third Party Vendor Risk"
description: "Build and run a third-party/vendor risk management (TPRM)"
---
...
Build and run a third-party/vendor risk management (TPRM)

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/managing-third-party-vendor-risk` |
| Path | `optional-skills/security/managing-third-party-vendor-risk` |
| Version | `1.0` |
| Author | andrewibrah (vendored by SOCIS) |
| License | Apache-2.0 |
| Platforms | linux, macos, windows |
| Tags | `third-party-risk`, `vendor-risk-management`, `tprm`, `supply-chain-risk`, `c-scrm`, `nist-800-161`, `soc2`, `caiq` |
