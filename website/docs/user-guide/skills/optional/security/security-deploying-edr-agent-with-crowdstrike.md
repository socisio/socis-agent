---
title: "Deploying Edr Agent With Crowdstrike — Deploys and configures CrowdStrike Falcon EDR agents across"
sidebar_label: "Deploying Edr Agent With Crowdstrike"
description: "Deploys and configures CrowdStrike Falcon EDR agents across"
---
...
| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/deploying-edr-agent-with-crowdstrike` |
| Path | `optional-skills/security/deploying-edr-agent-with-crowdstrike` |
| Version | `1.0.0` |
