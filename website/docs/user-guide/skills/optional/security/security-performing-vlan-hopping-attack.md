---
title: "Performing Vlan Hopping Attack — Simulates VLAN hopping attacks using switch spoofing and"
sidebar_label: "Performing Vlan Hopping Attack"
description: "Simulates VLAN hopping attacks using switch spoofing and"
---
...
Simulates VLAN hopping attacks using switch spoofing and

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/performing-vlan-hopping-attack` |
| Path | `optional-skills/security/performing-vlan-hopping-attack` |
| Version | `1.0` |
