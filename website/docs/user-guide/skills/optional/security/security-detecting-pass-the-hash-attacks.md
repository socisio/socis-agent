---
title: "Detecting Pass The Hash Attacks — Detect Pass-the-Hash (T1550.002) attacks by analyzing NTLM"
sidebar_label: "Detecting Pass The Hash Attacks"
description: "Detect Pass-the-Hash (T1550.002) attacks by analyzing NTLM"
---
...
Detect Pass-the-Hash (T1550.002) attacks by analyzing NTLM

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/detecting-pass-the-hash-attacks` |
| Path | `optional-skills/security/detecting-pass-the-hash-attacks` |
| Version | `1.0` |
