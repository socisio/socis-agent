---
title: "Performing Threat Intelligence Sharing With Misp — Uses PyMISP (the official MISP REST API library) to create"
sidebar_label: "Performing Threat Intelligence Sharing With Misp"
description: "Uses PyMISP (the official MISP REST API library) to create"
---
...
Uses PyMISP (the official MISP REST API library) to create

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/performing-threat-intelligence-sharing-with-misp` |
| Path | `optional-skills/security/performing-threat-intelligence-sharing-with-misp` |
| Version | `1.0` |
