---
title: "Detecting Dll Sideloading Attacks — Detect DLL side-loading and search-order hijacking (MITRE"
sidebar_label: "Detecting Dll Sideloading Attacks"
description: "Detect DLL side-loading and search-order hijacking (MITRE"
---
...
Detect DLL side-loading and search-order hijacking (MITRE

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/detecting-dll-sideloading-attacks` |
| Path | `optional-skills/security/detecting-dll-sideloading-attacks` |
| Version | `1.0` |
