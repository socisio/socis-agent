---
title: "Scanning Kubernetes Manifests With Kubesec — Scores Kubernetes resource manifests with Kubesec to flag"
sidebar_label: "Scanning Kubernetes Manifests With Kubesec"
description: "Scores Kubernetes resource manifests with Kubesec to flag"
---
...
Scores Kubernetes resource manifests with Kubesec to flag

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/scanning-kubernetes-manifests-with-kubesec` |
| Path | `optional-skills/security/scanning-kubernetes-manifests-with-kubesec` |
| Version | `1.0` |
