---
title: "Auditing Uefi Firmware With Chipsec — Use Intel CHIPSEC to assess platform firmware"
sidebar_label: "Auditing Uefi Firmware With Chipsec"
description: "Use Intel CHIPSEC to assess platform firmware"
---
...
Use Intel CHIPSEC to assess platform firmware

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/auditing-uefi-firmware-with-chipsec` |
| Path | `optional-skills/security/auditing-uefi-firmware-with-chipsec` |
| Version | `1.0` |
