---
title: "Conducting Cyber Risk Assessment With Nist 800 30 — Conduct a defensible cybersecurity risk assessment using"
sidebar_label: "Conducting Cyber Risk Assessment With Nist 800 30"
description: "Conduct a defensible cybersecurity risk assessment using"
---
...
Conduct a defensible cybersecurity risk assessment using

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/conducting-cyber-risk-assessment-with-nist-800-30` |
| Path | `optional-skills/security/conducting-cyber-risk-assessment-with-nist-800-30` |
| Version | `1.0` |
| Author | andrewibrah (vendored by SOCIS) |
| License | Apache-2.0 |
| Platforms | linux, macos, windows |
| Tags | `risk-assessment`, `nist-800-30`, `risk-management`, `threat-modeling`, `risk-register`, `governance`, `nist-800-39`, `compliance` |
