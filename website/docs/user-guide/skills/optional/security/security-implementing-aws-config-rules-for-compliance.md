---
title: "Implementing Aws Config Rules For Compliance — Implements AWS Config managed and custom rules for"
sidebar_label: "Implementing Aws Config Rules For Compliance"
description: "Implements AWS Config managed and custom rules for"
---
...
Implements AWS Config managed and custom rules for

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/implementing-aws-config-rules-for-compliance` |
| Path | `optional-skills/security/implementing-aws-config-rules-for-compliance` |
| Version | `1.0` |
