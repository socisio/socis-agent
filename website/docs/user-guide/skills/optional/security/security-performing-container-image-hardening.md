---
title: "Performing Container Image Hardening — Harden container images by minimizing attack surface"
sidebar_label: "Performing Container Image Hardening"
description: "Harden container images by minimizing attack surface"
---
...
Harden container images by minimizing attack surface

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/performing-container-image-hardening` |
| Path | `optional-skills/security/performing-container-image-hardening` |
| Version | `1.0.0` |
