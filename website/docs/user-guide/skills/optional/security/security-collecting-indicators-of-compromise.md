---
title: "Collecting Indicators Of Compromise — Systematically collects, categorizes, and distributes"
sidebar_label: "Collecting Indicators Of Compromise"
description: "Systematically collects, categorizes, and distributes"
---
...
Systematically collects, categorizes, and distributes

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/collecting-indicators-of-compromise` |
| Path | `optional-skills/security/collecting-indicators-of-compromise` |
| Version | `1.0.0` |
