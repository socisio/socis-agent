---
title: "Implementing Velociraptor For Ir Collection — Deploy and configure Velociraptor for scalable endpoint"
sidebar_label: "Implementing Velociraptor For Ir Collection"
description: "Deploy and configure Velociraptor for scalable endpoint"
---
...
Deploy and configure Velociraptor for scalable endpoint

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/implementing-velociraptor-for-ir-collection` |
| Path | `optional-skills/security/implementing-velociraptor-for-ir-collection` |
| Version | `1.0` |
