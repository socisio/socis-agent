---
title: "Implementing Network Intrusion Prevention With Suricata — Deploys and configures Suricata as an inline network"
sidebar_label: "Implementing Network Intrusion Prevention With Suricata"
description: "Deploys and configures Suricata as an inline network"
---
...
Deploys and configures Suricata as an inline network

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/implementing-network-intrusion-prevention-with-suricata` |
| Path | `optional-skills/security/implementing-network-intrusion-prevention-with-suricata` |
| Version | `1.0` |
| Author | mahipal (vendored by SOCIS) |
| License | Apache-2.0 |
| Platforms | linux, macos, windows |
| Tags | `suricata`, `ips`, `ids`, `intrusion-prevention`, `network-security`, `emerging-threats`, `rule-management`, `nfqueue` |
