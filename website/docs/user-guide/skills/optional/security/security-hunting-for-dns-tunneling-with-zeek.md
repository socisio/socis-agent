---
title: "Hunting For Dns Tunneling With Zeek — Detects DNS tunneling and covert-channel data exfiltration"
sidebar_label: "Hunting For Dns Tunneling With Zeek"
description: "Detects DNS tunneling and covert-channel data exfiltration"
---
...
Detects DNS tunneling and covert-channel data exfiltration

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/hunting-for-dns-tunneling-with-zeek` |
| Path | `optional-skills/security/hunting-for-dns-tunneling-with-zeek` |
| Version | `1.0` |
