---
title: "Assessing Vector And Embedding Weaknesses — Test RAG vector stores (Pinecone, Qdrant, Weaviate, Chroma"
sidebar_label: "Assessing Vector And Embedding Weaknesses"
description: "Test RAG vector stores (Pinecone, Qdrant, Weaviate, Chroma"
---
...
Test RAG vector stores (Pinecone, Qdrant, Weaviate, Chroma

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/assessing-vector-and-embedding-weaknesses` |
| Path | `optional-skills/security/assessing-vector-and-embedding-weaknesses` |
| Version | `1.0` |
