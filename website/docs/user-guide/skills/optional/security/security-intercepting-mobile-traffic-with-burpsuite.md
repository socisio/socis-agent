---
title: "Intercepting Mobile Traffic With Burpsuite — Intercepts and analyzes HTTP/HTTPS traffic from mobile"
sidebar_label: "Intercepting Mobile Traffic With Burpsuite"
description: "Intercepts and analyzes HTTP/HTTPS traffic from mobile"
---
...
Intercepts and analyzes HTTP/HTTPS traffic from mobile

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/intercepting-mobile-traffic-with-burpsuite` |
| Path | `optional-skills/security/intercepting-mobile-traffic-with-burpsuite` |
| Version | `1.0.0` |
