---
title: "Configuring Microsegmentation For Zero Trust — Configures microsegmentation policies to enforce"
sidebar_label: "Configuring Microsegmentation For Zero Trust"
description: "Configures microsegmentation policies to enforce"
---
...
Configures microsegmentation policies to enforce

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/configuring-microsegmentation-for-zero-trust` |
| Path | `optional-skills/security/configuring-microsegmentation-for-zero-trust` |
| Version | `1.0` |
