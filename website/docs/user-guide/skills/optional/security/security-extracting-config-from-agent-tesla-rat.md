---
title: "Extracting Config From Agent Tesla Rat — Extracts embedded configuration from Agent Tesla RAT"
sidebar_label: "Extracting Config From Agent Tesla Rat"
description: "Extracts embedded configuration from Agent Tesla RAT"
---
...
Extracts embedded configuration from Agent Tesla RAT

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/extracting-config-from-agent-tesla-rat` |
| Path | `optional-skills/security/extracting-config-from-agent-tesla-rat` |
| Version | `1.0` |
