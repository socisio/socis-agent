---
title: "Investigating Insider Threat Indicators — Investigates insider threat indicators including data"
sidebar_label: "Investigating Insider Threat Indicators"
description: "Investigates insider threat indicators including data"
---
...
Investigates insider threat indicators including data

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/investigating-insider-threat-indicators` |
| Path | `optional-skills/security/investigating-insider-threat-indicators` |
| Version | `1.0` |
