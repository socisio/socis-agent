---
title: "Implementing Cloud Dlp For Data Protection — Implement cloud DLP using Amazon Macie, Google Cloud DLP"
sidebar_label: "Implementing Cloud Dlp For Data Protection"
description: "Implement cloud DLP using Amazon Macie, Google Cloud DLP"
---
...
Implement cloud DLP using Amazon Macie, Google Cloud DLP

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/implementing-cloud-dlp-for-data-protection` |
| Path | `optional-skills/security/implementing-cloud-dlp-for-data-protection` |
| Version | `1.0` |
