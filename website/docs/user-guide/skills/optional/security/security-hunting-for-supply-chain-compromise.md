---
title: "Hunting For Supply Chain Compromise — Runs a hypothesis-driven threat hunt for supply-chain"
sidebar_label: "Hunting For Supply Chain Compromise"
description: "Runs a hypothesis-driven threat hunt for supply-chain"
---
...
Runs a hypothesis-driven threat hunt for supply-chain

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/hunting-for-supply-chain-compromise` |
| Path | `optional-skills/security/hunting-for-supply-chain-compromise` |
| Version | `1.0` |
