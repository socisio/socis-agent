---
title: "Performing Lateral Movement Detection — Detects lateral movement techniques including"
sidebar_label: "Performing Lateral Movement Detection"
description: "Detects lateral movement techniques including"
---
...
| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/performing-lateral-movement-detection` |
| Path | `optional-skills/security/performing-lateral-movement-detection` |
| Version | `1.0` |
| Author | mahipal (vendored by SOCIS) |
| License | Apache-2.0 |
| Platforms | linux, macos, windows |
| Tags | `soc`, `lateral-movement`, `mitre-attack`, `pass-the-hash`, `psexec`, `wmi`, `rdp`, `smb` |
