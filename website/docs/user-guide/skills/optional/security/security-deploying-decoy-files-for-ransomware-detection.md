---
title: "Deploying Decoy Files For Ransomware Detection — Deploys canary files (honeytokens) across file systems to"
sidebar_label: "Deploying Decoy Files For Ransomware Detection"
description: "Deploys canary files (honeytokens) across file systems to"
---
...
Deploys canary files (honeytokens) across file systems to

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/deploying-decoy-files-for-ransomware-detection` |
| Path | `optional-skills/security/deploying-decoy-files-for-ransomware-detection` |
| Version | `1.0.0` |
