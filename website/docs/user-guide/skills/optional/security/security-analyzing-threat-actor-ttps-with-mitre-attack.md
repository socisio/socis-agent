---
title: "Analyzing Threat Actor Ttps With Mitre Attack — Systematically map threat actor behavior and observed IOCs"
sidebar_label: "Analyzing Threat Actor Ttps With Mitre Attack"
description: "Systematically map threat actor behavior and observed IOCs"
---
...
Systematically map threat actor behavior and observed IOCs

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/analyzing-threat-actor-ttps-with-mitre-attack` |
| Path | `optional-skills/security/analyzing-threat-actor-ttps-with-mitre-attack` |
| Version | `1.0` |
