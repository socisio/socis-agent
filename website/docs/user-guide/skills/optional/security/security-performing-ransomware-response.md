---
title: "Performing Ransomware Response — Executes a structured ransomware incident response from"
sidebar_label: "Performing Ransomware Response"
description: "Executes a structured ransomware incident response from"
---
...
Executes a structured ransomware incident response from

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/performing-ransomware-response` |
| Path | `optional-skills/security/performing-ransomware-response` |
| Version | `1.0.0` |
