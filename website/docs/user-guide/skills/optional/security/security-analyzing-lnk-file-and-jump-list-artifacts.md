---
title: "Analyzing Lnk File And Jump List Artifacts — Analyze Windows LNK shortcut files and Jump List artifacts"
sidebar_label: "Analyzing Lnk File And Jump List Artifacts"
description: "Analyze Windows LNK shortcut files and Jump List artifacts"
---
...
Analyze Windows LNK shortcut files and Jump List artifacts

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/analyzing-lnk-file-and-jump-list-artifacts` |
| Path | `optional-skills/security/analyzing-lnk-file-and-jump-list-artifacts` |
| Version | `1.0` |
| Author | mahipal (vendored by SOCIS) |
| License | Apache-2.0 |
| Platforms | linux, macos, windows |
| Tags | `lnk-files`, `jump-lists`, `lecmd`, `jlecmd`, `windows-forensics`, `shell-link`, `user-activity`, `file-access` |
