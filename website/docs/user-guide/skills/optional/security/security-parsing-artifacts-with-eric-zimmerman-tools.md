---
title: "Parsing Artifacts With Eric Zimmerman Tools — Parse Windows forensic artifacts—$MFT/$J (MFTECmd)"
sidebar_label: "Parsing Artifacts With Eric Zimmerman Tools"
description: "Parse Windows forensic artifacts—$MFT/$J (MFTECmd)"
---
...
Parse Windows forensic artifacts—$MFT/$J (MFTECmd)

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/parsing-artifacts-with-eric-zimmerman-tools` |
| Path | `optional-skills/security/parsing-artifacts-with-eric-zimmerman-tools` |
| Version | `1.0` |
| Author | mahipal (vendored by SOCIS) |
| License | Apache-2.0 |
| Platforms | linux, macos, windows |
| Tags | `digital-forensics`, `eric-zimmerman`, `registry-forensics`, `prefetch`, `shellbags`, `mft`, `dfir`, `artifact-parsing` |
