---
title: "Implementing Bgp Security With Rpki — Implement RPKI-based BGP route origin validation by"
sidebar_label: "Implementing Bgp Security With Rpki"
description: "Implement RPKI-based BGP route origin validation by"
---
...
Implement RPKI-based BGP route origin validation by

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/implementing-bgp-security-with-rpki` |
| Path | `optional-skills/security/implementing-bgp-security-with-rpki` |
| Version | `1.0` |
| Author | mahipal (vendored by SOCIS) |
| License | Apache-2.0 |
| Platforms | linux, macos, windows |
| Tags | `bgp`, `rpki`, `route-origin-validation`, `rov`, `roa`, `route-hijacking`, `internet-routing`, `bgp-security` |
