---
title: "Configuring Network Segmentation With Vlans — Designs and implements VLAN-based (802.1Q) network"
sidebar_label: "Configuring Network Segmentation With Vlans"
description: "Designs and implements VLAN-based (802.1Q) network"
---
...
Designs and implements VLAN-based (802.1Q) network

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/configuring-network-segmentation-with-vlans` |
| Path | `optional-skills/security/configuring-network-segmentation-with-vlans` |
| Version | `1.0` |
