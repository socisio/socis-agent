---
title: "Detecting Insider Data Exfiltration Via Dlp — Detects insider data exfiltration by analyzing DLP policy"
sidebar_label: "Detecting Insider Data Exfiltration Via Dlp"
description: "Detects insider data exfiltration by analyzing DLP policy"
---
...
Detects insider data exfiltration by analyzing DLP policy

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/detecting-insider-data-exfiltration-via-dlp` |
| Path | `optional-skills/security/detecting-insider-data-exfiltration-via-dlp` |
| Version | `1.0` |
| Author | mahipal (vendored by SOCIS) |
| License | Apache-2.0 |
| Platforms | linux, macos, windows |
| Tags | `insider-threat`, `data-loss-prevention`, `dlp`, `exfiltration-detection`, `ueba`, `security-operations` |
