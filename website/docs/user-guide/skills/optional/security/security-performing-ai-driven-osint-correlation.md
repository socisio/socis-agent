---
title: "Performing Ai Driven Osint Correlation — Use AI/LLM-based reasoning with Sherlock, theHarvester, and"
sidebar_label: "Performing Ai Driven Osint Correlation"
description: "Use AI/LLM-based reasoning with Sherlock, theHarvester, and"
---
...
Use AI/LLM-based reasoning with Sherlock, theHarvester, and

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/performing-ai-driven-osint-correlation` |
| Path | `optional-skills/security/performing-ai-driven-osint-correlation` |
| Version | `1.0` |
| Author | juliosuas (vendored by SOCIS) |
| License | Apache-2.0 |
| Platforms | linux, macos, windows |
| Tags | `osint`, `ai-correlation`, `threat-intelligence`, `reconnaissance`, `link-analysis`, `target-profiling`, `sherlock`, `theharvester` |
