---
title: "Analyzing Security Logs With Splunk — Leverages Splunk Enterprise Security and SPL (Search"
sidebar_label: "Analyzing Security Logs With Splunk"
description: "Leverages Splunk Enterprise Security and SPL (Search"
---
...
Leverages Splunk Enterprise Security and SPL (Search

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/analyzing-security-logs-with-splunk` |
| Path | `optional-skills/security/analyzing-security-logs-with-splunk` |
| Version | `1.0.0` |
