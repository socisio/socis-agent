---
title: "Tracking Threat Actor Infrastructure — Discovers and maps adversary-controlled infrastructure (C2"
sidebar_label: "Tracking Threat Actor Infrastructure"
description: "Discovers and maps adversary-controlled infrastructure (C2"
---
...
Discovers and maps adversary-controlled infrastructure (C2

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/tracking-threat-actor-infrastructure` |
| Path | `optional-skills/security/tracking-threat-actor-infrastructure` |
| Version | `1.0` |
| Author | mahipal (vendored by SOCIS) |
| License | Apache-2.0 |
| Platforms | linux, macos, windows |
| Tags | `threat-intelligence`, `cti`, `ioc`, `mitre-attack`, `stix`, `infrastructure-tracking`, `shodan`, `censys` |
