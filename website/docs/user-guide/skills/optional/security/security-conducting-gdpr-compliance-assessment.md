---
title: "Conducting Gdpr Compliance Assessment — Conduct comprehensive GDPR compliance assessments by"
sidebar_label: "Conducting Gdpr Compliance Assessment"
description: "Conduct comprehensive GDPR compliance assessments by"
---
...
Conduct comprehensive GDPR compliance assessments by

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/conducting-gdpr-compliance-assessment` |
| Path | `optional-skills/security/conducting-gdpr-compliance-assessment` |
| Version | `1.0` |
| Author | dakshverma23 (vendored by SOCIS) |
| License | Apache-2.0 |
| Platforms | linux, macos, windows |
| Tags | `gdpr`, `data-protection`, `privacy`, `compliance`, `dpia`, `data-subject-rights`, `article-30`, `controller` |
