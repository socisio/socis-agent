---
title: "Containing Active Breach — Executes containment strategies to stop active adversary"
...
| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/containing-active-breach` |
| Path | `optional-skills/security/containing-active-breach` |
| Version | `1.0.0` |
