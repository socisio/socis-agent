---
title: "Performing Cloud Storage Forensic Acquisition — Perform forensic acquisition of cloud storage services"
sidebar_label: "Performing Cloud Storage Forensic Acquisition"
description: "Perform forensic acquisition of cloud storage services"
---
...
Perform forensic acquisition of cloud storage services

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/performing-cloud-storage-forensic-acquisition` |
| Path | `optional-skills/security/performing-cloud-storage-forensic-acquisition` |
| Version | `1.0` |
| Author | mahipal (vendored by SOCIS) |
| License | Apache-2.0 |
| Platforms | linux, macos, windows |
| Tags | `cloud-forensics`, `google-drive`, `onedrive`, `dropbox`, `box`, `cloud-acquisition`, `api-forensics`, `sync-client` |
