---
title: "Detecting Evasion Techniques In Endpoint Logs — Detects defense evasion techniques used by adversaries in"
sidebar_label: "Detecting Evasion Techniques In Endpoint Logs"
description: "Detects defense evasion techniques used by adversaries in"
---
...
Detects defense evasion techniques used by adversaries in

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/detecting-evasion-techniques-in-endpoint-logs` |
| Path | `optional-skills/security/detecting-evasion-techniques-in-endpoint-logs` |
| Version | `1.0.0` |
