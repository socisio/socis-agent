---
title: "Hunting For Scheduled Task Persistence — Runs a hypothesis-driven threat hunt for Windows Scheduled"
sidebar_label: "Hunting For Scheduled Task Persistence"
description: "Runs a hypothesis-driven threat hunt for Windows Scheduled"
---
...
Runs a hypothesis-driven threat hunt for Windows Scheduled

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/hunting-for-scheduled-task-persistence` |
| Path | `optional-skills/security/hunting-for-scheduled-task-persistence` |
| Version | `1.0` |
