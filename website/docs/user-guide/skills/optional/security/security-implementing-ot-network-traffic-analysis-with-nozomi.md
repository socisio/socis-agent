---
title: "Implementing Ot Network Traffic Analysis With Nozomi — Deploy Nozomi Networks Guardian sensors for passive OT"
sidebar_label: "Implementing Ot Network Traffic Analysis With Nozomi"
description: "Deploy Nozomi Networks Guardian sensors for passive OT"
---
...
Deploy Nozomi Networks Guardian sensors for passive OT

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/implementing-ot-network-traffic-analysis-with-nozomi` |
| Path | `optional-skills/security/implementing-ot-network-traffic-analysis-with-nozomi` |
| Version | `1.0` |
