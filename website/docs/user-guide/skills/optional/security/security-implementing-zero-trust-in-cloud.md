---
title: "Implementing Zero Trust In Cloud — Guides zero trust implementation across AWS, Azure, and GCP"
sidebar_label: "Implementing Zero Trust In Cloud"
description: "Guides zero trust implementation across AWS, Azure, and GCP"
---
...
Guides zero trust implementation across AWS, Azure, and GCP

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/implementing-zero-trust-in-cloud` |
| Path | `optional-skills/security/implementing-zero-trust-in-cloud` |
| Version | `1.0.0` |
