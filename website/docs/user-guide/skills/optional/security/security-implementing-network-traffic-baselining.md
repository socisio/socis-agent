---
title: "Implementing Network Traffic Baselining — Builds network traffic baselines from NetFlow/IPFIX CSV or"
sidebar_label: "Implementing Network Traffic Baselining"
description: "Builds network traffic baselines from NetFlow/IPFIX CSV or"
---
...
Builds network traffic baselines from NetFlow/IPFIX CSV or

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/implementing-network-traffic-baselining` |
| Path | `optional-skills/security/implementing-network-traffic-baselining` |
| Version | `1.0` |
