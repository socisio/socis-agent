---
title: "Implementing Image Provenance Verification With Cosign — Signs and verifies container image provenance with Sigstore"
sidebar_label: "Implementing Image Provenance Verification With Cosign"
description: "Signs and verifies container image provenance with Sigstore"
---
...
Signs and verifies container image provenance with Sigstore

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/implementing-image-provenance-verification-with-cosign` |
| Path | `optional-skills/security/implementing-image-provenance-verification-with-cosign` |
| Version | `1.0` |
