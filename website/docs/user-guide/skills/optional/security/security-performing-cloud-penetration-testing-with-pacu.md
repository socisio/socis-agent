---
title: "Performing Cloud Penetration Testing With Pacu — Run authorized AWS penetration tests with Pacu, the"
sidebar_label: "Performing Cloud Penetration Testing With Pacu"
description: "Run authorized AWS penetration tests with Pacu, the"
---
...
Run authorized AWS penetration tests with Pacu, the

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/performing-cloud-penetration-testing-with-pacu` |
| Path | `optional-skills/security/performing-cloud-penetration-testing-with-pacu` |
| Version | `1.0` |
