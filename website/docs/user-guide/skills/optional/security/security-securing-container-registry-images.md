---
title: "Securing Container Registry Images — Secures container registry images (ECR, ACR, GCR, Docker"
sidebar_label: "Securing Container Registry Images"
description: "Secures container registry images (ECR, ACR, GCR, Docker"
---
...
Secures container registry images (ECR, ACR, GCR, Docker

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/securing-container-registry-images` |
| Path | `optional-skills/security/securing-container-registry-images` |
| Version | `1.0` |
