---
title: "Detecting T1548 Abuse Elevation Control Mechanism — Detect abuse of elevation control mechanisms (T1548)"
sidebar_label: "Detecting T1548 Abuse Elevation Control Mechanism"
description: "Detect abuse of elevation control mechanisms (T1548)"
---
...
Detect abuse of elevation control mechanisms (T1548)

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/detecting-t1548-abuse-elevation-control-mechanism` |
| Path | `optional-skills/security/detecting-t1548-abuse-elevation-control-mechanism` |
| Version | `1.0` |
