---
title: "Implementing Gdpr Data Protection Controls — Implements GDPR (EU 2016/679) technical and organizational"
sidebar_label: "Implementing Gdpr Data Protection Controls"
description: "Implements GDPR (EU 2016/679) technical and organizational"
---
...
Implements GDPR (EU 2016/679) technical and organizational

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/implementing-gdpr-data-protection-controls` |
| Path | `optional-skills/security/implementing-gdpr-data-protection-controls` |
| Version | `1.0` |
