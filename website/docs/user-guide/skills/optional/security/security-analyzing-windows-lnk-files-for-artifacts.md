---
title: "Analyzing Windows Lnk Files For Artifacts — Parse Windows LNK shortcut files to extract target paths"
sidebar_label: "Analyzing Windows Lnk Files For Artifacts"
description: "Parse Windows LNK shortcut files to extract target paths"
---
...
Parse Windows LNK shortcut files to extract target paths

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/analyzing-windows-lnk-files-for-artifacts` |
| Path | `optional-skills/security/analyzing-windows-lnk-files-for-artifacts` |
| Version | `1.0` |
