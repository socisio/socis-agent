---
title: "Performing Graphql Depth Limit Attack — Execute and test GraphQL depth limit attacks using deeply"
sidebar_label: "Performing Graphql Depth Limit Attack"
description: "Execute and test GraphQL depth limit attacks using deeply"
---
...
Execute and test GraphQL depth limit attacks using deeply

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/performing-graphql-depth-limit-attack` |
| Path | `optional-skills/security/performing-graphql-depth-limit-attack` |
| Version | `1.0` |
