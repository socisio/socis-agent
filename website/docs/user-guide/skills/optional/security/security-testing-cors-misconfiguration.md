---
title: "Testing Cors Misconfiguration — Identifying and exploiting Cross-Origin Resource Sharing"
sidebar_label: "Testing Cors Misconfiguration"
description: "Identifying and exploiting Cross-Origin Resource Sharing"
---
...
Identifying and exploiting Cross-Origin Resource Sharing

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/testing-cors-misconfiguration` |
| Path | `optional-skills/security/testing-cors-misconfiguration` |
| Version | `1.0` |
