---
title: "Recovering Deleted Files With Photorec — Recovers deleted files from disk images and storage media"
sidebar_label: "Recovering Deleted Files With Photorec"
description: "Recovers deleted files from disk images and storage media"
---
...
Recovers deleted files from disk images and storage media

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/recovering-deleted-files-with-photorec` |
| Path | `optional-skills/security/recovering-deleted-files-with-photorec` |
| Version | `1.0` |
