---
title: "Implementing Email Sandboxing With Proofpoint — Email sandboxing detonates suspicious attachments and URLs"
sidebar_label: "Implementing Email Sandboxing With Proofpoint"
description: "Email sandboxing detonates suspicious attachments and URLs"
---
...
Email sandboxing detonates suspicious attachments and URLs

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/implementing-email-sandboxing-with-proofpoint` |
| Path | `optional-skills/security/implementing-email-sandboxing-with-proofpoint` |
| Version | `1.0` |
