---
title: "Performing Purple Team Exercise — Performs purple team exercises by coordinating red team"
sidebar_label: "Performing Purple Team Exercise"
description: "Performs purple team exercises by coordinating red team"
---
...
Performs purple team exercises by coordinating red team

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/performing-purple-team-exercise` |
| Path | `optional-skills/security/performing-purple-team-exercise` |
| Version | `1.0` |
