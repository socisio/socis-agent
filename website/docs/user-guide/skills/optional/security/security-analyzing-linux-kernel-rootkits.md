---
title: "Analyzing Linux Kernel Rootkits — Detect kernel-level rootkits in Linux memory dumps using"
sidebar_label: "Analyzing Linux Kernel Rootkits"
description: "Detect kernel-level rootkits in Linux memory dumps using"
---
...
Detect kernel-level rootkits in Linux memory dumps using

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/analyzing-linux-kernel-rootkits` |
| Path | `optional-skills/security/analyzing-linux-kernel-rootkits` |
| Version | `1.0` |
