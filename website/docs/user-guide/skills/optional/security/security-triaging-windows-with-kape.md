---
title: "Triaging Windows With Kape — Runs KAPE (Kroll Artifact Parser and Extractor) to collect"
sidebar_label: "Triaging Windows With Kape"
description: "Runs KAPE (Kroll Artifact Parser and Extractor) to collect"
---
...
Runs KAPE (Kroll Artifact Parser and Extractor) to collect

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/triaging-windows-with-kape` |
| Path | `optional-skills/security/triaging-windows-with-kape` |
| Version | `1.0` |
| Author | mahipal (vendored by SOCIS) |
| License | Apache-2.0 |
| Platforms | linux, macos, windows |
| Tags | `digital-forensics`, `kape`, `triage`, `artifact-collection`, `incident-response`, `eric-zimmerman`, `dfir`, `windows-forensics` |
