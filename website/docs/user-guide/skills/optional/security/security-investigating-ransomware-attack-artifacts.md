---
title: "Investigating Ransomware Attack Artifacts — Forensically preserve memory and disk, collect ransom notes"
sidebar_label: "Investigating Ransomware Attack Artifacts"
description: "Forensically preserve memory and disk, collect ransom notes"
---
...
Forensically preserve memory and disk, collect ransom notes

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/investigating-ransomware-attack-artifacts` |
| Path | `optional-skills/security/investigating-ransomware-attack-artifacts` |
| Version | `1.0` |
