---
title: "Analyzing Windows Shellbag Artifacts — Analyze Windows Shellbag (BagMRU) registry artifacts with"
sidebar_label: "Analyzing Windows Shellbag Artifacts"
description: "Analyze Windows Shellbag (BagMRU) registry artifacts with"
---
...
Analyze Windows Shellbag (BagMRU) registry artifacts with

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/analyzing-windows-shellbag-artifacts` |
| Path | `optional-skills/security/analyzing-windows-shellbag-artifacts` |
| Version | `1.0` |
| Author | mahipal (vendored by SOCIS) |
| License | Apache-2.0 |
| Platforms | linux, macos, windows |
| Tags | `shellbags`, `windows-registry`, `sbecmd`, `shellbags-explorer`, `folder-access`, `user-activity`, `removable-media`, `network-shares` |
