---
title: "Implementing Ebpf Security Monitoring — Implements eBPF-based security monitoring using Cilium"
sidebar_label: "Implementing Ebpf Security Monitoring"
description: "Implements eBPF-based security monitoring using Cilium"
---
...
Implements eBPF-based security monitoring using Cilium

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/implementing-ebpf-security-monitoring` |
| Path | `optional-skills/security/implementing-ebpf-security-monitoring` |
| Version | `1.0` |
| Author | mukul975 (vendored by SOCIS) |
| License | Apache-2.0 |
| Platforms | linux, macos, windows |
| Tags | `ebpf`, `tetragon`, `cilium`, `runtime-security`, `observability`, `kernel-security`, `kubernetes-security` |
