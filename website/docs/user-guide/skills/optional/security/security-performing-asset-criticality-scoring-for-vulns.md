---
title: "Performing Asset Criticality Scoring For Vulns — Build a multi-factor asset criticality scoring"
sidebar_label: "Performing Asset Criticality Scoring For Vulns"
description: "Build a multi-factor asset criticality scoring"
---
...
Build a multi-factor asset criticality scoring

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/performing-asset-criticality-scoring-for-vulns` |
| Path | `optional-skills/security/performing-asset-criticality-scoring-for-vulns` |
| Version | `1.0` |
