---
title: "Performing Network Traffic Analysis With Zeek — Deploy Zeek (formerly Bro) as a passive network security"
...
| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/performing-network-traffic-analysis-with-zeek` |
| Path | `optional-skills/security/performing-network-traffic-analysis-with-zeek` |
| Version | `1.0` |
| Author | mahipal (vendored by SOCIS) |
| License | Apache-2.0 |
| Platforms | linux, macos, windows |
| Tags | `zeek`, `network-monitoring`, `traffic-analysis`, `ids`, `nids`, `pcap`, `threat-detection`, `forensics` |
