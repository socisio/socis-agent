---
title: "Analyzing Indicators Of Compromise — Analyzes indicators of compromise (IOCs) including IP"
sidebar_label: "Analyzing Indicators Of Compromise"
description: "Analyzes indicators of compromise (IOCs) including IP"
---
...
Analyzes indicators of compromise (IOCs) including IP

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/analyzing-indicators-of-compromise` |
| Path | `optional-skills/security/analyzing-indicators-of-compromise` |
| Version | `1.0.0` |
