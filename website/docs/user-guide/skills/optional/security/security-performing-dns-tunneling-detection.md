---
title: "Performing Dns Tunneling Detection — Detects DNS tunneling by computing Shannon entropy of DNS"
sidebar_label: "Performing Dns Tunneling Detection"
description: "Detects DNS tunneling by computing Shannon entropy of DNS"
---
...
Detects DNS tunneling by computing Shannon entropy of DNS

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/performing-dns-tunneling-detection` |
| Path | `optional-skills/security/performing-dns-tunneling-detection` |
| Version | `1.0` |
| Author | mahipal (vendored by SOCIS) |
| License | Apache-2.0 |
| Platforms | linux, macos, windows |
| Tags | `dns-tunneling`, `exfiltration-detection`, `shannon-entropy`, `dns-analysis`, `threat-detection`, `security-operations` |
