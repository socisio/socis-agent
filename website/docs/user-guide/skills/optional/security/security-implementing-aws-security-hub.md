---
title: "Implementing Aws Security Hub — Deploy AWS Security Hub as a centralized CSPM platform"
sidebar_label: "Implementing Aws Security Hub"
description: "Deploy AWS Security Hub as a centralized CSPM platform"
---
...
Deploy AWS Security Hub as a centralized CSPM platform

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/implementing-aws-security-hub` |
| Path | `optional-skills/security/implementing-aws-security-hub` |
| Version | `1.0.0` |
