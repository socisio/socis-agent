---
title: "Testing Api For Broken Object Level Authorization — Tests REST and GraphQL APIs for Broken Object Level"
sidebar_label: "Testing Api For Broken Object Level Authorization"
description: "Tests REST and GraphQL APIs for Broken Object Level"
---
...
Tests REST and GraphQL APIs for Broken Object Level

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/testing-api-for-broken-object-level-authorization` |
| Path | `optional-skills/security/testing-api-for-broken-object-level-authorization` |
| Version | `1.0.0` |
