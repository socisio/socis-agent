---
title: "Hunting For Living Off The Land Binaries — Proactively hunts for adversary abuse of legitimate, signed"
sidebar_label: "Hunting For Living Off The Land Binaries"
description: "Proactively hunts for adversary abuse of legitimate, signed"
---
...
Proactively hunts for adversary abuse of legitimate, signed

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/hunting-for-living-off-the-land-binaries` |
| Path | `optional-skills/security/hunting-for-living-off-the-land-binaries` |
| Version | `1.0` |
