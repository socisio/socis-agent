---
title: "Detecting Dcsync Attack In Active Directory — Detect DCSync attacks (MITRE T1003.006) where adversaries"
sidebar_label: "Detecting Dcsync Attack In Active Directory"
description: "Detect DCSync attacks (MITRE T1003.006) where adversaries"
---
...
Detect DCSync attacks (MITRE T1003.006) where adversaries

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/detecting-dcsync-attack-in-active-directory` |
| Path | `optional-skills/security/detecting-dcsync-attack-in-active-directory` |
| Version | `1.0` |
