---
title: "Securing Aws Iam Permissions — Hardens AWS IAM configurations to enforce least-privilege"
sidebar_label: "Securing Aws Iam Permissions"
description: "Hardens AWS IAM configurations to enforce least-privilege"
---
...
Hardens AWS IAM configurations to enforce least-privilege

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/securing-aws-iam-permissions` |
| Path | `optional-skills/security/securing-aws-iam-permissions` |
| Version | `1.0.0` |
