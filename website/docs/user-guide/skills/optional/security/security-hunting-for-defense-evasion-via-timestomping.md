---
title: "Hunting For Defense Evasion Via Timestomping — Detect NTFS timestamp manipulation (MITRE T1070.006) by"
sidebar_label: "Hunting For Defense Evasion Via Timestomping"
description: "Detect NTFS timestamp manipulation (MITRE T1070.006) by"
---
...
Detect NTFS timestamp manipulation (MITRE T1070.006) by

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/hunting-for-defense-evasion-via-timestomping` |
| Path | `optional-skills/security/hunting-for-defense-evasion-via-timestomping` |
| Version | `1.0` |
