---
title: "Hunting Advanced Persistent Threats — Proactively hunts for Advanced Persistent Threat (APT)"
sidebar_label: "Hunting Advanced Persistent Threats"
description: "Proactively hunts for Advanced Persistent Threat (APT)"
---
...
Proactively hunts for Advanced Persistent Threat (APT)

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/hunting-advanced-persistent-threats` |
| Path | `optional-skills/security/hunting-advanced-persistent-threats` |
| Version | `1.0.0` |
| Author | mahipal (vendored by SOCIS) |
| License | Apache-2.0 |
| Platforms | linux, macos, windows |
| Tags | `MITRE-ATT&CK`, `threat-hunting`, `APT`, `Velociraptor`, `osquery`, `Zeek`, `TTP`, `NIST-CSF` |
