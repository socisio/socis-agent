---
title: "Implementing Google Workspace Phishing Protection — Configures Google Workspace advanced phishing and malware"
sidebar_label: "Implementing Google Workspace Phishing Protection"
description: "Configures Google Workspace advanced phishing and malware"
---
...
Configures Google Workspace advanced phishing and malware

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/implementing-google-workspace-phishing-protection` |
| Path | `optional-skills/security/implementing-google-workspace-phishing-protection` |
| Version | `1.0` |
