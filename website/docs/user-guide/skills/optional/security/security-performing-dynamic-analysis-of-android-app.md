---
title: "Performing Dynamic Analysis Of Android App — Performs runtime dynamic analysis of Android applications"
sidebar_label: "Performing Dynamic Analysis Of Android App"
description: "Performs runtime dynamic analysis of Android applications"
---
...
Performs runtime dynamic analysis of Android applications

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/performing-dynamic-analysis-of-android-app` |
| Path | `optional-skills/security/performing-dynamic-analysis-of-android-app` |
| Version | `1.0.0` |
