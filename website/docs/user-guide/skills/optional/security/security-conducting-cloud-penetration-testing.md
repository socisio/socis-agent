---
title: "Conducting Cloud Penetration Testing — This skill outlines methodologies for performing authorized"
sidebar_label: "Conducting Cloud Penetration Testing"
description: "This skill outlines methodologies for performing authorized"
---
...
This skill outlines methodologies for performing authorized

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/conducting-cloud-penetration-testing` |
| Path | `optional-skills/security/conducting-cloud-penetration-testing` |
| Version | `1.0.0` |
