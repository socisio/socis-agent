---
title: "Implementing Network Segmentation With Firewall Zones — Designs and implements network segmentation using firewall"
sidebar_label: "Implementing Network Segmentation With Firewall Zones"
description: "Designs and implements network segmentation using firewall"
---
...
Designs and implements network segmentation using firewall

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/implementing-network-segmentation-with-firewall-zones` |
| Path | `optional-skills/security/implementing-network-segmentation-with-firewall-zones` |
| Version | `1.0` |
| Author | mahipal (vendored by SOCIS) |
| License | Apache-2.0 |
| Platforms | linux, macos, windows |
| Tags | `network-segmentation`, `firewall-zones`, `vlan`, `microsegmentation`, `lateral-movement`, `zero-trust`, `acl`, `east-west-traffic` |
