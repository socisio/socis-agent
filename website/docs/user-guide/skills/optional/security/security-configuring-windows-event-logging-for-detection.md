---
title: "Configuring Windows Event Logging For Detection — Configures Windows Event Logging with advanced audit"
sidebar_label: "Configuring Windows Event Logging For Detection"
description: "Configures Windows Event Logging with advanced audit"
---
...
Configures Windows Event Logging with advanced audit

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/configuring-windows-event-logging-for-detection` |
| Path | `optional-skills/security/configuring-windows-event-logging-for-detection` |
| Version | `1.0.0` |
