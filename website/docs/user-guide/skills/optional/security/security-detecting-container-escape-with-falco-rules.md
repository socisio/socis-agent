---
title: "Detecting Container Escape With Falco Rules — Writes and tunes Falco rule syntax for container escape"
sidebar_label: "Detecting Container Escape With Falco Rules"
description: "Writes and tunes Falco rule syntax for container escape"
---
...
Writes and tunes Falco rule syntax for container escape

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/detecting-container-escape-with-falco-rules` |
| Path | `optional-skills/security/detecting-container-escape-with-falco-rules` |
| Version | `1.0` |
