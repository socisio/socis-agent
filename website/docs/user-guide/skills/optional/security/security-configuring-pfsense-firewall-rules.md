---
title: "Configuring Pfsense Firewall Rules — Configures pfSense firewall rules, NAT policies"
sidebar_label: "Configuring Pfsense Firewall Rules"
description: "Configures pfSense firewall rules, NAT policies"
---
...
Configures pfSense firewall rules, NAT policies

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/configuring-pfsense-firewall-rules` |
| Path | `optional-skills/security/configuring-pfsense-firewall-rules` |
| Version | `1.0` |
