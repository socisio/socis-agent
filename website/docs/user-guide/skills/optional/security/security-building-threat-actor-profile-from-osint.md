---
title: "Building Threat Actor Profile From Osint — Build threat actor profiles by collecting OSINT from vendor"
sidebar_label: "Building Threat Actor Profile From Osint"
description: "Build threat actor profiles by collecting OSINT from vendor"
---
...
Build threat actor profiles by collecting OSINT from vendor

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/building-threat-actor-profile-from-osint` |
| Path | `optional-skills/security/building-threat-actor-profile-from-osint` |
| Version | `1.0` |
| Author | mahipal (vendored by SOCIS) |
| License | Apache-2.0 |
| Platforms | linux, macos, windows |
| Tags | `osint`, `threat-actor`, `threat-actor-profiling`, `maltego`, `spiderfoot`, `attribution`, `threat-intelligence`, `reconnaissance` |
