---
title: "Attacking Entra Id With Roadtools — Enumerate Microsoft Entra ID (Azure AD) tenants with"
sidebar_label: "Attacking Entra Id With Roadtools"
description: "Enumerate Microsoft Entra ID (Azure AD) tenants with"
---
...
Enumerate Microsoft Entra ID (Azure AD) tenants with

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/attacking-entra-id-with-roadtools` |
| Path | `optional-skills/security/attacking-entra-id-with-roadtools` |
| Version | `1.0` |
