---
title: "Testing For Host Header Injection — Test web applications for HTTP Host header injection"
sidebar_label: "Testing For Host Header Injection"
description: "Test web applications for HTTP Host header injection"
---
...
Test web applications for HTTP Host header injection

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/testing-for-host-header-injection` |
| Path | `optional-skills/security/testing-for-host-header-injection` |
| Version | `1.0` |
