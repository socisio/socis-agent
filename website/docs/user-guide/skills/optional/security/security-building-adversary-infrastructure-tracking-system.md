---
title: "Building Adversary Infrastructure Tracking System — Build an automated adversary infrastructure tracking system"
sidebar_label: "Building Adversary Infrastructure Tracking System"
description: "Build an automated adversary infrastructure tracking system"
---
...
Build an automated adversary infrastructure tracking system

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/building-adversary-infrastructure-tracking-system` |
| Path | `optional-skills/security/building-adversary-infrastructure-tracking-system` |
| Version | `1.0` |
