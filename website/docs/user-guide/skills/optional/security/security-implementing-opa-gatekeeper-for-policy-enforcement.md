---
title: "Implementing Opa Gatekeeper For Policy Enforcement — Deploys OPA Gatekeeper via Helm as a Kubernetes admission"
sidebar_label: "Implementing Opa Gatekeeper For Policy Enforcement"
description: "Deploys OPA Gatekeeper via Helm as a Kubernetes admission"
---
...
| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/implementing-opa-gatekeeper-for-policy-enforcement` |
| Path | `optional-skills/security/implementing-opa-gatekeeper-for-policy-enforcement` |
| Version | `1.0` |
