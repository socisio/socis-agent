---
title: "Detecting Anomalies In Industrial Control Systems — Deploys anomaly detection for OT/ICS environments using"
sidebar_label: "Detecting Anomalies In Industrial Control Systems"
description: "Deploys anomaly detection for OT/ICS environments using"
---
...
Deploys anomaly detection for OT/ICS environments using

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/detecting-anomalies-in-industrial-control-systems` |
| Path | `optional-skills/security/detecting-anomalies-in-industrial-control-systems` |
| Version | `1.0.0` |
