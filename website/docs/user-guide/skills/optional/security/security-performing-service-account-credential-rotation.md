---
title: "Performing Service Account Credential Rotation — Automates credential rotation for service accounts across"
sidebar_label: "Performing Service Account Credential Rotation"
description: "Automates credential rotation for service accounts across"
---
...
Automates credential rotation for service accounts across

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/performing-service-account-credential-rotation` |
| Path | `optional-skills/security/performing-service-account-credential-rotation` |
| Version | `1.0` |
