---
title: "Testing Api Authentication Weaknesses — Tests API authentication mechanisms for weaknesses"
sidebar_label: "Testing Api Authentication Weaknesses"
description: "Tests API authentication mechanisms for weaknesses"
---
...
| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/testing-api-authentication-weaknesses` |
| Path | `optional-skills/security/testing-api-authentication-weaknesses` |
| Version | `1.0.0` |
