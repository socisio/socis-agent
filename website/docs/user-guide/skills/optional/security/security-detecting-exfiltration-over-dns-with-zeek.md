---
title: "Detecting Exfiltration Over Dns With Zeek — Detect DNS-based data exfiltration by analyzing Zeek"
sidebar_label: "Detecting Exfiltration Over Dns With Zeek"
description: "Detect DNS-based data exfiltration by analyzing Zeek"
---
...
Detect DNS-based data exfiltration by analyzing Zeek

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/detecting-exfiltration-over-dns-with-zeek` |
| Path | `optional-skills/security/detecting-exfiltration-over-dns-with-zeek` |
| Version | `1.0` |
