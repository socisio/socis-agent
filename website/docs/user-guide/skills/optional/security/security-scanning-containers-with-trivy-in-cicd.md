---
title: "Scanning Containers With Trivy In Cicd — Integrates Aqua Security's Trivy scanner into CI/CD"
sidebar_label: "Scanning Containers With Trivy In Cicd"
description: "Integrates Aqua Security's Trivy scanner into CI/CD"
---
...
Integrates Aqua Security's Trivy scanner into CI/CD

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/scanning-containers-with-trivy-in-cicd` |
| Path | `optional-skills/security/scanning-containers-with-trivy-in-cicd` |
| Version | `1.0.0` |
