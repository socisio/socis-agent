---
title: "Implementing Infrastructure As Code Security Scanning — Implements automated security scanning for Infrastructure"
sidebar_label: "Implementing Infrastructure As Code Security Scanning"
description: "Implements automated security scanning for Infrastructure"
---
...
Implements automated security scanning for Infrastructure

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/implementing-infrastructure-as-code-security-scanning` |
| Path | `optional-skills/security/implementing-infrastructure-as-code-security-scanning` |
| Version | `1.0.0` |
