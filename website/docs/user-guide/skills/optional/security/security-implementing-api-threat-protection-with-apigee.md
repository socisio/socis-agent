---
title: "Implementing Api Threat Protection With Apigee — Implements API threat protection using Google Apigee"
sidebar_label: "Implementing Api Threat Protection With Apigee"
description: "Implements API threat protection using Google Apigee"
---
...
Implements API threat protection using Google Apigee

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/implementing-api-threat-protection-with-apigee` |
| Path | `optional-skills/security/implementing-api-threat-protection-with-apigee` |
| Version | `1.0` |
| Author | mahipal (vendored by SOCIS) |
| License | Apache-2.0 |
| Platforms | linux, macos, windows |
| Tags | `apigee`, `api-gateway`, `threat-protection`, `json-threat-protection`, `xml-threat-protection`, `spike-arrest`, `oauth2`, `google-cloud` |
