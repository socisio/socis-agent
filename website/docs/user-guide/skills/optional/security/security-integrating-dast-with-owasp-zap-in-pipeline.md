---
title: "Integrating Dast With Owasp Zap In Pipeline — Integrates OWASP ZAP (Zed Attack Proxy) into GitHub Actions"
sidebar_label: "Integrating Dast With Owasp Zap In Pipeline"
description: "Integrates OWASP ZAP (Zed Attack Proxy) into GitHub Actions"
---
...
Integrates OWASP ZAP (Zed Attack Proxy) into GitHub Actions

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/integrating-dast-with-owasp-zap-in-pipeline` |
| Path | `optional-skills/security/integrating-dast-with-owasp-zap-in-pipeline` |
| Version | `1.0.0` |
