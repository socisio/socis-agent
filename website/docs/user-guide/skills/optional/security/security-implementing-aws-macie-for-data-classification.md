---
title: "Implementing Aws Macie For Data Classification — Enable and configure Amazon Macie via AWS CLI/Terraform to"
sidebar_label: "Implementing Aws Macie For Data Classification"
description: "Enable and configure Amazon Macie via AWS CLI/Terraform to"
---
...
Enable and configure Amazon Macie via AWS CLI/Terraform to

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/implementing-aws-macie-for-data-classification` |
| Path | `optional-skills/security/implementing-aws-macie-for-data-classification` |
| Version | `1.0` |
