---
title: "Auditing Terraform Infrastructure For Security — Auditing Terraform infrastructure-as-code for security"
sidebar_label: "Auditing Terraform Infrastructure For Security"
description: "Auditing Terraform infrastructure-as-code for security"
---
...
Auditing Terraform infrastructure-as-code for security

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/auditing-terraform-infrastructure-for-security` |
| Path | `optional-skills/security/auditing-terraform-infrastructure-for-security` |
| Version | `1.0` |
