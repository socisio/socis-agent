---
title: "Testing Android Intents For Vulnerabilities — Tests Android inter-process communication (IPC) through"
sidebar_label: "Testing Android Intents For Vulnerabilities"
description: "Tests Android inter-process communication (IPC) through"
---
...
Tests Android inter-process communication (IPC) through

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/testing-android-intents-for-vulnerabilities` |
| Path | `optional-skills/security/testing-android-intents-for-vulnerabilities` |
| Version | `1.0.0` |
