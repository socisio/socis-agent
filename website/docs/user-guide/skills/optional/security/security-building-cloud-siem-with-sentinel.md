---
title: "Building Cloud Siem With Sentinel — Deploy Microsoft Sentinel as a cloud-native SIEM/SOAR by"
sidebar_label: "Building Cloud Siem With Sentinel"
description: "Deploy Microsoft Sentinel as a cloud-native SIEM/SOAR by"
---
...
Deploy Microsoft Sentinel as a cloud-native SIEM/SOAR by

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/building-cloud-siem-with-sentinel` |
| Path | `optional-skills/security/building-cloud-siem-with-sentinel` |
| Version | `1.0.0` |
