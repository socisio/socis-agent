---
title: "Detecting Command And Control Over Dns — Detect command-and-control (C2) traffic tunneled over DNS"
sidebar_label: "Detecting Command And Control Over Dns"
description: "Detect command-and-control (C2) traffic tunneled over DNS"
---
...
Detect command-and-control (C2) traffic tunneled over DNS

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/detecting-command-and-control-over-dns` |
| Path | `optional-skills/security/detecting-command-and-control-over-dns` |
| Version | `1.0.0` |
