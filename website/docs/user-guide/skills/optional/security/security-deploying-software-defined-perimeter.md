---
title: "Deploying Software Defined Perimeter — Deploys a Software-Defined Perimeter per the CSA v2.0"
sidebar_label: "Deploying Software Defined Perimeter"
description: "Deploys a Software-Defined Perimeter per the CSA v2.0"
---
...
Deploys a Software-Defined Perimeter per the CSA v2.0

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/deploying-software-defined-perimeter` |
| Path | `optional-skills/security/deploying-software-defined-perimeter` |
| Version | `1.0` |
