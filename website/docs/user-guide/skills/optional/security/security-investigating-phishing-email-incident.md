---
title: "Investigating Phishing Email Incident — Investigates phishing email incidents from initial user"
sidebar_label: "Investigating Phishing Email Incident"
description: "Investigates phishing email incidents from initial user"
---
...
Investigates phishing email incidents from initial user

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/investigating-phishing-email-incident` |
| Path | `optional-skills/security/investigating-phishing-email-incident` |
| Version | `1.0` |
