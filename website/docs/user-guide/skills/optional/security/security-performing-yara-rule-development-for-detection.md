---
title: "Performing Yara Rule Development For Detection — Develops precise YARA and YARA-X rules for malware"
sidebar_label: "Performing Yara Rule Development For Detection"
description: "Develops precise YARA and YARA-X rules for malware"
---
...
Develops precise YARA and YARA-X rules for malware

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/performing-yara-rule-development-for-detection` |
| Path | `optional-skills/security/performing-yara-rule-development-for-detection` |
| Version | `1.0` |
