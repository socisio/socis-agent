---
title: "Implementing Container Image Minimal Base With Distroless — Reduces container attack surface by building application"
sidebar_label: "Implementing Container Image Minimal Base With Distroless"
description: "Reduces container attack surface by building application"
---
...
Reduces container attack surface by building application

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/implementing-container-image-minimal-base-with-distroless` |
| Path | `optional-skills/security/implementing-container-image-minimal-base-with-distroless` |
| Version | `1.0` |
