---
title: "Implementing Taxii Server With Opentaxii — Deploy and configure a TAXII 2.1 server (Medallion) with"
sidebar_label: "Implementing Taxii Server With Opentaxii"
description: "Deploy and configure a TAXII 2.1 server (Medallion) with"
---
...
Deploy and configure a TAXII 2.1 server (Medallion) with

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/implementing-taxii-server-with-opentaxii` |
| Path | `optional-skills/security/implementing-taxii-server-with-opentaxii` |
| Version | `1.0` |
