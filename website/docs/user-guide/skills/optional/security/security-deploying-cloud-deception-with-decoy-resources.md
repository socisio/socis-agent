---
title: "Deploying Cloud Deception With Decoy Resources — Deploy cloud-native deception across AWS, Azure, and GCP"
sidebar_label: "Deploying Cloud Deception With Decoy Resources"
description: "Deploy cloud-native deception across AWS, Azure, and GCP"
---
...
Deploy cloud-native deception across AWS, Azure, and GCP

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/deploying-cloud-deception-with-decoy-resources` |
| Path | `optional-skills/security/deploying-cloud-deception-with-decoy-resources` |
| Version | `1.0` |
| Author | andrewibrah (vendored by SOCIS) |
| License | Apache-2.0 |
| Platforms | linux, macos, windows |
| Tags | `cloud-deception`, `aws`, `azure`, `gcp`, `canary-token`, `honeytoken`, `cloudtrail`, `breach-detection` |
