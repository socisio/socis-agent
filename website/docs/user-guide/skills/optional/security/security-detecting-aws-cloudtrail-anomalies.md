---
title: "Detecting Aws Cloudtrail Anomalies — Detect unusual API call patterns in AWS CloudTrail logs"
sidebar_label: "Detecting Aws Cloudtrail Anomalies"
description: "Detect unusual API call patterns in AWS CloudTrail logs"
---
...
Detect unusual API call patterns in AWS CloudTrail logs

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/detecting-aws-cloudtrail-anomalies` |
| Path | `optional-skills/security/detecting-aws-cloudtrail-anomalies` |
| Version | `1.0` |
