---
title: "Performing Entitlement Review With Sailpoint Iiq — Runs entitlement review and access certification campaigns"
sidebar_label: "Performing Entitlement Review With Sailpoint Iiq"
description: "Runs entitlement review and access certification campaigns"
---
...
Runs entitlement review and access certification campaigns

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/performing-entitlement-review-with-sailpoint-iiq` |
| Path | `optional-skills/security/performing-entitlement-review-with-sailpoint-iiq` |
| Version | `1.0` |
