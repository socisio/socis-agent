---
title: "Implementing Zero Trust Network Access With Zscaler — Configures Zero Trust Network Access using Zscaler Private"
sidebar_label: "Implementing Zero Trust Network Access With Zscaler"
description: "Configures Zero Trust Network Access using Zscaler Private"
---
...
Configures Zero Trust Network Access using Zscaler Private

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/implementing-zero-trust-network-access-with-zscaler` |
| Path | `optional-skills/security/implementing-zero-trust-network-access-with-zscaler` |
| Version | `1.0` |
