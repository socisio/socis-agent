---
title: "Detecting Cryptomining In Cloud — This skill teaches security teams how to detect and respond"
...
| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/detecting-cryptomining-in-cloud` |
| Path | `optional-skills/security/detecting-cryptomining-in-cloud` |
| Version | `1.0.0` |
