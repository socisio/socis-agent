---
title: "Performing Wifi Password Cracking With Aircrack — Captures WPA/WPA2 handshakes and performs offline password"
sidebar_label: "Performing Wifi Password Cracking With Aircrack"
description: "Captures WPA/WPA2 handshakes and performs offline password"
---
...
Captures WPA/WPA2 handshakes and performs offline password

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/performing-wifi-password-cracking-with-aircrack` |
| Path | `optional-skills/security/performing-wifi-password-cracking-with-aircrack` |
| Version | `1.0` |
