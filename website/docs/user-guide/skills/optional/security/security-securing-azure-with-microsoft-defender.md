---
title: "Securing Azure With Microsoft Defender — Deploys and configures Microsoft Defender for Cloud as a"
sidebar_label: "Securing Azure With Microsoft Defender"
description: "Deploys and configures Microsoft Defender for Cloud as a"
---
...
Deploys and configures Microsoft Defender for Cloud as a

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/securing-azure-with-microsoft-defender` |
| Path | `optional-skills/security/securing-azure-with-microsoft-defender` |
| Version | `1.0.0` |
