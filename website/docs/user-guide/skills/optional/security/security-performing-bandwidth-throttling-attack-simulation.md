---
title: "Performing Bandwidth Throttling Attack Simulation — Simulate bandwidth throttling and network degradation"
sidebar_label: "Performing Bandwidth Throttling Attack Simulation"
description: "Simulate bandwidth throttling and network degradation"
---
...
Simulate bandwidth throttling and network degradation

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/performing-bandwidth-throttling-attack-simulation` |
| Path | `optional-skills/security/performing-bandwidth-throttling-attack-simulation` |
| Version | `1.0` |
