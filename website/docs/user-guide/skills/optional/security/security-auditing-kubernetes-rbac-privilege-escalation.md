---
title: "Auditing Kubernetes Rbac Privilege Escalation — Finds over-permissive RBAC roles and service-account token"
sidebar_label: "Auditing Kubernetes Rbac Privilege Escalation"
description: "Finds over-permissive RBAC roles and service-account token"
---
...
Finds over-permissive RBAC roles and service-account token

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/auditing-kubernetes-rbac-privilege-escalation` |
| Path | `optional-skills/security/auditing-kubernetes-rbac-privilege-escalation` |
| Version | `1.0` |
