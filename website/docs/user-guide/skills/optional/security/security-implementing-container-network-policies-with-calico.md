---
title: "Implementing Container Network Policies With Calico — Uses Calico's own policy CRDs beyond the upstream"
sidebar_label: "Implementing Container Network Policies With Calico"
description: "Uses Calico's own policy CRDs beyond the upstream"
---
...
Uses Calico's own policy CRDs beyond the upstream

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/implementing-container-network-policies-with-calico` |
| Path | `optional-skills/security/implementing-container-network-policies-with-calico` |
| Version | `1.0` |
