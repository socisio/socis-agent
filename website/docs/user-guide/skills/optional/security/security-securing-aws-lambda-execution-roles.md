---
title: "Securing Aws Lambda Execution Roles — Hardens AWS Lambda execution roles by writing"
sidebar_label: "Securing Aws Lambda Execution Roles"
description: "Hardens AWS Lambda execution roles by writing"
---
...
Hardens AWS Lambda execution roles by writing

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/securing-aws-lambda-execution-roles` |
| Path | `optional-skills/security/securing-aws-lambda-execution-roles` |
| Version | `1.0` |
