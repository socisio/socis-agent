---
title: "Performing Log Source Onboarding In Siem — Perform structured log source onboarding into SIEM"
sidebar_label: "Performing Log Source Onboarding In Siem"
description: "Perform structured log source onboarding into SIEM"
---
...
Perform structured log source onboarding into SIEM

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/performing-log-source-onboarding-in-siem` |
| Path | `optional-skills/security/performing-log-source-onboarding-in-siem` |
| Version | `1.0` |
