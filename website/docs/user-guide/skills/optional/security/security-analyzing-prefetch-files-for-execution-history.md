---
title: "Analyzing Prefetch Files For Execution History — Parse Windows Prefetch files (versions 17, 23, 26, 30) with"
sidebar_label: "Analyzing Prefetch Files For Execution History"
description: "Parse Windows Prefetch files (versions 17, 23, 26, 30) with"
---
...
Parse Windows Prefetch files (versions 17, 23, 26, 30) with

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/analyzing-prefetch-files-for-execution-history` |
| Path | `optional-skills/security/analyzing-prefetch-files-for-execution-history` |
| Version | `1.0` |
