---
title: "Performing Network Packet Capture Analysis — Perform forensic analysis of network packet captures"
sidebar_label: "Performing Network Packet Capture Analysis"
description: "Perform forensic analysis of network packet captures"
---
...
Perform forensic analysis of network packet captures

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/performing-network-packet-capture-analysis` |
| Path | `optional-skills/security/performing-network-packet-capture-analysis` |
| Version | `1.0` |
| Author | mahipal (vendored by SOCIS) |
| License | Apache-2.0 |
| Platforms | linux, macos, windows |
| Tags | `pcap`, `wireshark`, `tshark`, `tcpdump`, `network-forensics`, `packet-capture`, `protocol-analysis`, `traffic-analysis` |
