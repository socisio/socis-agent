---
title: "Performing Api Security Testing With Postman — Uses Postman to build structured API security test"
sidebar_label: "Performing Api Security Testing With Postman"
description: "Uses Postman to build structured API security test"
---
...
Uses Postman to build structured API security test

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/performing-api-security-testing-with-postman` |
| Path | `optional-skills/security/performing-api-security-testing-with-postman` |
| Version | `1.0.0` |
