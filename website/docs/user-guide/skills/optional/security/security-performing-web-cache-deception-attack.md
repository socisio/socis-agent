---
title: "Performing Web Cache Deception Attack — Executes web cache deception attacks by exploiting path"
sidebar_label: "Performing Web Cache Deception Attack"
description: "Executes web cache deception attacks by exploiting path"
---
...
Executes web cache deception attacks by exploiting path

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/performing-web-cache-deception-attack` |
| Path | `optional-skills/security/performing-web-cache-deception-attack` |
| Version | `1.0` |
