---
title: "Securing Api Gateway With Aws Waf — Secures AWS API Gateway endpoints with AWS WAF by"
sidebar_label: "Securing Api Gateway With Aws Waf"
description: "Secures AWS API Gateway endpoints with AWS WAF by"
---
...
Secures AWS API Gateway endpoints with AWS WAF by

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/securing-api-gateway-with-aws-waf` |
| Path | `optional-skills/security/securing-api-gateway-with-aws-waf` |
| Version | `1.0` |
