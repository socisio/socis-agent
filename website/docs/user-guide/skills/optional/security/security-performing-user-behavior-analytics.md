---
title: "Performing User Behavior Analytics — Performs User and Entity Behavior Analytics (UEBA) to"
sidebar_label: "Performing User Behavior Analytics"
description: "Performs User and Entity Behavior Analytics (UEBA) to"
---
...
Performs User and Entity Behavior Analytics (UEBA) to

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/performing-user-behavior-analytics` |
| Path | `optional-skills/security/performing-user-behavior-analytics` |
| Version | `1.0` |
