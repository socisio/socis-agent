---
title: "Fleet Hunting With Velociraptor — Deploy a Velociraptor server and agents, then author VQL"
sidebar_label: "Fleet Hunting With Velociraptor"
description: "Deploy a Velociraptor server and agents, then author VQL"
---
...
Deploy a Velociraptor server and agents, then author VQL

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/fleet-hunting-with-velociraptor` |
| Path | `optional-skills/security/fleet-hunting-with-velociraptor` |
| Version | `1.0` |
| Author | mahipal (vendored by SOCIS) |
| License | Apache-2.0 |
| Platforms | linux, macos, windows |
| Tags | `threat-hunting`, `velociraptor`, `vql`, `dfir`, `endpoint-visibility`, `incident-response`, `fleet-collection`, `digital-forensics` |
