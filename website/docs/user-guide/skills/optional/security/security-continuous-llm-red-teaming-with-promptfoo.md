---
title: "Continuous Llm Red Teaming With Promptfoo — Wires Promptfoo and DeepTeam into CI/CD for automated"
sidebar_label: "Continuous Llm Red Teaming With Promptfoo"
description: "Wires Promptfoo and DeepTeam into CI/CD for automated"
---
...
Wires Promptfoo and DeepTeam into CI/CD for automated

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/continuous-llm-red-teaming-with-promptfoo` |
| Path | `optional-skills/security/continuous-llm-red-teaming-with-promptfoo` |
| Version | `1.0` |
| Author | mahipal (vendored by SOCIS) |
| License | Apache-2.0 |
| Platforms | linux, macos, windows |
| Tags | `ai-security`, `llm-red-teaming`, `promptfoo`, `deepteam`, `ci-cd`, `owasp-llm-top10`, `jailbreak`, `regression-testing` |
