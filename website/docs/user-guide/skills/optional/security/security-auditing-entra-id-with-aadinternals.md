---
title: "Auditing Entra Id With Aadinternals — Drive the AADInternals PowerShell toolkit to perform"
sidebar_label: "Auditing Entra Id With Aadinternals"
description: "Drive the AADInternals PowerShell toolkit to perform"
---
...
Drive the AADInternals PowerShell toolkit to perform

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/auditing-entra-id-with-aadinternals` |
| Path | `optional-skills/security/auditing-entra-id-with-aadinternals` |
| Version | `1.0` |
| Author | mahipal (vendored by SOCIS) |
| License | Apache-2.0 |
| Platforms | linux, macos, windows |
| Tags | `aadinternals`, `entra-id`, `azure-ad`, `saml-token-forgery`, `federation-backdoor`, `token-manipulation`, `adfs`, `red-team` |
