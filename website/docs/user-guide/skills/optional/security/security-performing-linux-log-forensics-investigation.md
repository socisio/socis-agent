---
title: "Performing Linux Log Forensics Investigation — Perform forensic investigation of Linux system logs"
sidebar_label: "Performing Linux Log Forensics Investigation"
description: "Perform forensic investigation of Linux system logs"
---
...
Perform forensic investigation of Linux system logs

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/performing-linux-log-forensics-investigation` |
| Path | `optional-skills/security/performing-linux-log-forensics-investigation` |
| Version | `1.0` |
| Author | mahipal (vendored by SOCIS) |
| License | Apache-2.0 |
| Platforms | linux, macos, windows |
| Tags | `linux-forensics`, `syslog`, `auth-log`, `systemd-journal`, `journalctl`, `linux-logs`, `ssh-forensics`, `cron` |
