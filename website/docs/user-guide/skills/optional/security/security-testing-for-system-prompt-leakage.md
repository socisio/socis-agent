---
title: "Testing For System Prompt Leakage — Extracts LLM system prompts using direct requests"
sidebar_label: "Testing For System Prompt Leakage"
description: "Extracts LLM system prompts using direct requests"
---
...
Extracts LLM system prompts using direct requests

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/testing-for-system-prompt-leakage` |
| Path | `optional-skills/security/testing-for-system-prompt-leakage` |
| Version | `1.0` |
| Author | mahipal (vendored by SOCIS) |
| License | Apache-2.0 |
| Platforms | linux, macos, windows |
| Tags | `ai-security`, `system-prompt-leakage`, `prompt-extraction`, `llm-red-team`, `owasp-llm07`, `garak`, `promptfoo`, `data-leakage` |
