---
title: "Performing Cloud Asset Inventory With Cartography — Run Cartography to sync AWS, GCP, or Azure resources into a"
sidebar_label: "Performing Cloud Asset Inventory With Cartography"
description: "Run Cartography to sync AWS, GCP, or Azure resources into a"
---
...
Run Cartography to sync AWS, GCP, or Azure resources into a

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/performing-cloud-asset-inventory-with-cartography` |
| Path | `optional-skills/security/performing-cloud-asset-inventory-with-cartography` |
| Version | `1.0` |
