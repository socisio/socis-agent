---
title: "Correlating Threat Campaigns — Correlates disparate security incidents, IOCs, and"
sidebar_label: "Correlating Threat Campaigns"
description: "Correlates disparate security incidents, IOCs, and"
---
...
Correlates disparate security incidents, IOCs, and

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/correlating-threat-campaigns` |
| Path | `optional-skills/security/correlating-threat-campaigns` |
| Version | `1.0.0` |
