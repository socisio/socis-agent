---
title: "Testing For Business Logic Vulnerabilities — Manually identifies flaws in application business logic -"
sidebar_label: "Testing For Business Logic Vulnerabilities"
description: "Manually identifies flaws in application business logic -"
---
...
Manually identifies flaws in application business logic -

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/testing-for-business-logic-vulnerabilities` |
| Path | `optional-skills/security/testing-for-business-logic-vulnerabilities` |
| Version | `1.0` |
