---
title: "Performing Cloud Incident Containment Procedures — Execute cloud-native incident containment across AWS"
sidebar_label: "Performing Cloud Incident Containment Procedures"
description: "Execute cloud-native incident containment across AWS"
---
...
Execute cloud-native incident containment across AWS

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/performing-cloud-incident-containment-procedures` |
| Path | `optional-skills/security/performing-cloud-incident-containment-procedures` |
| Version | `1.0` |
