---
title: "Detecting Insider Threat With Ueba — Implement User and Entity Behavior Analytics (UEBA) using"
sidebar_label: "Detecting Insider Threat With Ueba"
description: "Implement User and Entity Behavior Analytics (UEBA) using"
---
...
Implement User and Entity Behavior Analytics (UEBA) using

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/detecting-insider-threat-with-ueba` |
| Path | `optional-skills/security/detecting-insider-threat-with-ueba` |
| Version | `1.0` |
