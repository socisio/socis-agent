---
title: "Testing For Sensitive Data Exposure — Identifying sensitive data exposure vulnerabilities"
...
Identifying sensitive data exposure vulnerabilities

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/testing-for-sensitive-data-exposure` |
| Path | `optional-skills/security/testing-for-sensitive-data-exposure` |
| Version | `1.0` |
