---
title: "Auditing Gcp Iam Permissions — Auditing Google Cloud Platform IAM permissions to identify"
sidebar_label: "Auditing Gcp Iam Permissions"
description: "Auditing Google Cloud Platform IAM permissions to identify"
---
...
Auditing Google Cloud Platform IAM permissions to identify

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/auditing-gcp-iam-permissions` |
| Path | `optional-skills/security/auditing-gcp-iam-permissions` |
| Version | `1.0` |
