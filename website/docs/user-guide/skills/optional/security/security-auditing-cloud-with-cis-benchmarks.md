---
title: "Auditing Cloud With Cis Benchmarks — Audit AWS, Azure, and GCP environments against the CIS"
sidebar_label: "Auditing Cloud With Cis Benchmarks"
description: "Audit AWS, Azure, and GCP environments against the CIS"
---
...
Audit AWS, Azure, and GCP environments against the CIS

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/auditing-cloud-with-cis-benchmarks` |
| Path | `optional-skills/security/auditing-cloud-with-cis-benchmarks` |
| Version | `1.0.0` |
