---
title: "Implementing Network Policies For Kubernetes — Writes portable upstream Kubernetes NetworkPolicy YAML -"
sidebar_label: "Implementing Network Policies For Kubernetes"
description: "Writes portable upstream Kubernetes NetworkPolicy YAML -"
---
...
Writes portable upstream Kubernetes NetworkPolicy YAML -

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/implementing-network-policies-for-kubernetes` |
| Path | `optional-skills/security/implementing-network-policies-for-kubernetes` |
| Version | `1.0` |
