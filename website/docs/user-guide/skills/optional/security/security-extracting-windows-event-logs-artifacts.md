---
title: "Extracting Windows Event Logs Artifacts — Extract, parse, and analyze Windows Event Logs (EVTX) using"
sidebar_label: "Extracting Windows Event Logs Artifacts"
description: "Extract, parse, and analyze Windows Event Logs (EVTX) using"
---
...
Extract, parse, and analyze Windows Event Logs (EVTX) using

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/extracting-windows-event-logs-artifacts` |
| Path | `optional-skills/security/extracting-windows-event-logs-artifacts` |
| Version | `1.0` |
