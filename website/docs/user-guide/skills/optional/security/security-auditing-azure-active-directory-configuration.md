---
title: "Auditing Azure Active Directory Configuration — Auditing Microsoft Entra ID (Azure Active Directory)"
sidebar_label: "Auditing Azure Active Directory Configuration"
description: "Auditing Microsoft Entra ID (Azure Active Directory)"
---
...
Auditing Microsoft Entra ID (Azure Active Directory)

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/auditing-azure-active-directory-configuration` |
| Path | `optional-skills/security/auditing-azure-active-directory-configuration` |
| Version | `1.0` |
