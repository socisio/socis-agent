---
title: "Validating Tpm Measured Boot Attestation — Verifies TPM 2.0 measured-boot integrity and remote"
sidebar_label: "Validating Tpm Measured Boot Attestation"
description: "Verifies TPM 2.0 measured-boot integrity and remote"
---
...
Verifies TPM 2.0 measured-boot integrity and remote

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/validating-tpm-measured-boot-attestation` |
| Path | `optional-skills/security/validating-tpm-measured-boot-attestation` |
| Version | `1.0` |
| Author | mahipal (vendored by SOCIS) |
| License | Apache-2.0 |
| Platforms | linux, macos, windows |
| Tags | `hardware-firmware-security`, `tpm`, `measured-boot`, `remote-attestation`, `pcr`, `tpm2-tools`, `integrity-verification`, `trusted-computing` |
