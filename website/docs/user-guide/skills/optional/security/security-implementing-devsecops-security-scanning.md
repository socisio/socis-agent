---
title: "Implementing Devsecops Security Scanning — Integrates SAST, DAST, and SCA into CI/CD pipelines using"
sidebar_label: "Implementing Devsecops Security Scanning"
description: "Integrates SAST, DAST, and SCA into CI/CD pipelines using"
---
...
Integrates SAST, DAST, and SCA into CI/CD pipelines using

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/implementing-devsecops-security-scanning` |
| Path | `optional-skills/security/implementing-devsecops-security-scanning` |
| Version | `1.0.0` |
| Author | mahipal (vendored by SOCIS) |
| License | Apache-2.0 |
| Platforms | linux, macos, windows |
| Tags | `devsecops`, `SAST`, `DAST`, `SCA`, `semgrep`, `trivy`, `owasp-zap`, `gitleaks` |
