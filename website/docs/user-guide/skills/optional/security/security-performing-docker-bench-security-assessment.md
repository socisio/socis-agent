---
title: "Performing Docker Bench Security Assessment — Runs Docker Bench for Security, the open-source CIS Docker"
sidebar_label: "Performing Docker Bench Security Assessment"
description: "Runs Docker Bench for Security, the open-source CIS Docker"
---
...
Runs Docker Bench for Security, the open-source CIS Docker

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/performing-docker-bench-security-assessment` |
| Path | `optional-skills/security/performing-docker-bench-security-assessment` |
| Version | `1.0` |
