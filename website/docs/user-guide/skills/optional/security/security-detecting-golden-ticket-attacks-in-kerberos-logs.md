---
title: "Detecting Golden Ticket Attacks In Kerberos Logs — Detect Golden Ticket attacks in Active Directory using"
sidebar_label: "Detecting Golden Ticket Attacks In Kerberos Logs"
description: "Detect Golden Ticket attacks in Active Directory using"
---
...
Detect Golden Ticket attacks in Active Directory using

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/detecting-golden-ticket-attacks-in-kerberos-logs` |
| Path | `optional-skills/security/detecting-golden-ticket-attacks-in-kerberos-logs` |
| Version | `1.0` |
