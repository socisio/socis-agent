---
title: "Detecting S3 Data Exfiltration Attempts — Detecting data exfiltration attempts from AWS S3 buckets by"
sidebar_label: "Detecting S3 Data Exfiltration Attempts"
description: "Detecting data exfiltration attempts from AWS S3 buckets by"
---
...
Detecting data exfiltration attempts from AWS S3 buckets by

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/detecting-s3-data-exfiltration-attempts` |
| Path | `optional-skills/security/detecting-s3-data-exfiltration-attempts` |
| Version | `1.0` |
