---
title: "Building Ioc Defanging And Sharing Pipeline — Build an automated pipeline that ingests raw IOCs (URLs"
sidebar_label: "Building Ioc Defanging And Sharing Pipeline"
description: "Build an automated pipeline that ingests raw IOCs (URLs"
---
...
Build an automated pipeline that ingests raw IOCs (URLs

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/building-ioc-defanging-and-sharing-pipeline` |
| Path | `optional-skills/security/building-ioc-defanging-and-sharing-pipeline` |
| Version | `1.0` |
...
class IOCExtractor:
    ...
    PATTERNS = {
        ...
        "domain": r'\b(?:[a-zA-Z0-9](https://github.com/socisio/socis-agent/blob/main/optional-skills/security/building-ioc-defanging-and-sharing-pipeline/?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?\.)+[a-zA-Z]{2,}\b',
        "url": r'https?://[^\s<>"{}|\\^`\[\]]+',
