---
title: "Securing Container Registry With Harbor — Configures the security features of the Harbor open-source"
sidebar_label: "Securing Container Registry With Harbor"
description: "Configures the security features of the Harbor open-source"
---
...
Configures the security features of the Harbor open-source

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/securing-container-registry-with-harbor` |
| Path | `optional-skills/security/securing-container-registry-with-harbor` |
| Version | `1.0` |
