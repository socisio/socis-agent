---
title: "Building Soc Metrics And Kpi Tracking — Builds SOC performance metrics and KPI tracking dashboards"
sidebar_label: "Building Soc Metrics And Kpi Tracking"
description: "Builds SOC performance metrics and KPI tracking dashboards"
---
...
Builds SOC performance metrics and KPI tracking dashboards

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/building-soc-metrics-and-kpi-tracking` |
| Path | `optional-skills/security/building-soc-metrics-and-kpi-tracking` |
| Version | `1.0` |
