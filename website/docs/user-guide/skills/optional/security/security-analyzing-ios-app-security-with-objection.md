---
title: "Analyzing Ios App Security With Objection — Runtime iOS app security testing with Objection (Frida)"
sidebar_label: "Analyzing Ios App Security With Objection"
description: "Runtime iOS app security testing with Objection (Frida)"
---
...
Runtime iOS app security testing with Objection (Frida)

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/analyzing-ios-app-security-with-objection` |
| Path | `optional-skills/security/analyzing-ios-app-security-with-objection` |
| Version | `1.0.0` |
