---
title: "Detecting Container Runtime Threats With Falco — Deploys and operates Falco with the modern eBPF driver in"
sidebar_label: "Detecting Container Runtime Threats With Falco"
description: "Deploys and operates Falco with the modern eBPF driver in"
---
...
Deploys and operates Falco with the modern eBPF driver in

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/detecting-container-runtime-threats-with-falco` |
| Path | `optional-skills/security/detecting-container-runtime-threats-with-falco` |
| Version | `1.0` |
| Author | mahipal (vendored by SOCIS) |
| License | Apache-2.0 |
| Platforms | linux, macos, windows |
| Tags | `falco`, `runtime-security`, `ebpf`, `container-escape`, `syscall-monitoring`, `detection-engineering`, `kubernetes`, `threat-detection` |
