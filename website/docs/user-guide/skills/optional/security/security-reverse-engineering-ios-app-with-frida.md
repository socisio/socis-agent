---
title: "Reverse Engineering Ios App With Frida — Reverse engineers iOS applications using Frida dynamic"
sidebar_label: "Reverse Engineering Ios App With Frida"
description: "Reverse engineers iOS applications using Frida dynamic"
---
...
Reverse engineers iOS applications using Frida dynamic

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/reverse-engineering-ios-app-with-frida` |
| Path | `optional-skills/security/reverse-engineering-ios-app-with-frida` |
| Version | `1.0.0` |
