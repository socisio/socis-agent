---
title: "Auditing Aws S3 Bucket Permissions — Systematically audit AWS S3 bucket permissions to identify"
sidebar_label: "Auditing Aws S3 Bucket Permissions"
description: "Systematically audit AWS S3 bucket permissions to identify"
---
...
Systematically audit AWS S3 bucket permissions to identify

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/auditing-aws-s3-bucket-permissions` |
| Path | `optional-skills/security/auditing-aws-s3-bucket-permissions` |
| Version | `1.0` |
