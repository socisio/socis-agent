---
title: "Building Threat Intelligence Platform — Design and deploy a Threat Intelligence Platform (TIP) by"
sidebar_label: "Building Threat Intelligence Platform"
description: "Design and deploy a Threat Intelligence Platform (TIP) by"
---
...
Design and deploy a Threat Intelligence Platform (TIP) by

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/building-threat-intelligence-platform` |
| Path | `optional-skills/security/building-threat-intelligence-platform` |
| Version | `1.0` |
