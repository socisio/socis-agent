---
title: "Performing Mobile Device Forensics With Cellebrite — Acquire and analyze mobile device data using Cellebrite"
sidebar_label: "Performing Mobile Device Forensics With Cellebrite"
description: "Acquire and analyze mobile device data using Cellebrite"
---
...
Acquire and analyze mobile device data using Cellebrite

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/performing-mobile-device-forensics-with-cellebrite` |
| Path | `optional-skills/security/performing-mobile-device-forensics-with-cellebrite` |
| Version | `1.0` |
