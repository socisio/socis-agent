---
title: "Performing False Positive Reduction In Siem — Reduces SIEM false positives through systematic rule"
...
| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/performing-false-positive-reduction-in-siem` |
| Path | `optional-skills/security/performing-false-positive-reduction-in-siem` |
| Version | `1.0` |
