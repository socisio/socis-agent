---
title: "Performing Kubernetes Penetration Testing — Evaluates Kubernetes cluster security by actively"
sidebar_label: "Performing Kubernetes Penetration Testing"
description: "Evaluates Kubernetes cluster security by actively"
---
...
Evaluates Kubernetes cluster security by actively

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/performing-kubernetes-penetration-testing` |
| Path | `optional-skills/security/performing-kubernetes-penetration-testing` |
| Version | `1.0` |
