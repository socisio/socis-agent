---
title: "Performing Wireless Security Assessment With Kismet — Conduct wireless network security assessments using Kismet"
sidebar_label: "Performing Wireless Security Assessment With Kismet"
description: "Conduct wireless network security assessments using Kismet"
---
...
Conduct wireless network security assessments using Kismet

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/performing-wireless-security-assessment-with-kismet` |
| Path | `optional-skills/security/performing-wireless-security-assessment-with-kismet` |
| Version | `1.0` |
| Author | mahipal (vendored by SOCIS) |
| License | Apache-2.0 |
| Platforms | linux, macos, windows |
| Tags | `kismet`, `wireless-security`, `wifi-assessment`, `rogue-ap`, `802.11`, `wardriving`, `wids`, `wireless-ids` |
