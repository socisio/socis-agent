---
title: "Securing Helm Chart Deployments — Secures Helm chart deployments by verifying chart"
sidebar_label: "Securing Helm Chart Deployments"
description: "Secures Helm chart deployments by verifying chart"
---
...
Secures Helm chart deployments by verifying chart

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/securing-helm-chart-deployments` |
| Path | `optional-skills/security/securing-helm-chart-deployments` |
| Version | `1.0` |
