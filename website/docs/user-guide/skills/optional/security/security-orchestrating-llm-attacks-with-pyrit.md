---
title: "Orchestrating Llm Attacks With Pyrit — Build automated multi-turn adversarial attacks against"
sidebar_label: "Orchestrating Llm Attacks With Pyrit"
description: "Build automated multi-turn adversarial attacks against"
---
...
Build automated multi-turn adversarial attacks against

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/orchestrating-llm-attacks-with-pyrit` |
| Path | `optional-skills/security/orchestrating-llm-attacks-with-pyrit` |
| Version | `1.0` |
| Author | mahipal (vendored by SOCIS) |
| License | Apache-2.0 |
| Platforms | linux, macos, windows |
| Tags | `ai-security`, `llm-red-teaming`, `pyrit`, `multi-turn-attacks`, `crescendo`, `jailbreak`, `prompt-injection`, `mitre-atlas` |
