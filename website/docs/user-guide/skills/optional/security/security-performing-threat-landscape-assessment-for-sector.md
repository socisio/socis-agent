---
title: "Performing Threat Landscape Assessment For Sector — Conducts a sector-specific threat landscape assessment"
sidebar_label: "Performing Threat Landscape Assessment For Sector"
description: "Conducts a sector-specific threat landscape assessment"
---
...
Conducts a sector-specific threat landscape assessment

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/performing-threat-landscape-assessment-for-sector` |
| Path | `optional-skills/security/performing-threat-landscape-assessment-for-sector` |
| Version | `1.0` |
