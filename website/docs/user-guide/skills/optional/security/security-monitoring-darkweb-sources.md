---
title: "Monitoring Darkweb Sources — Monitors dark web forums, marketplaces, paste sites, and"
sidebar_label: "Monitoring Darkweb Sources"
description: "Monitors dark web forums, marketplaces, paste sites, and"
---
...
Monitors dark web forums, marketplaces, paste sites, and

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/monitoring-darkweb-sources` |
| Path | `optional-skills/security/monitoring-darkweb-sources` |
| Version | `1.0.0` |
