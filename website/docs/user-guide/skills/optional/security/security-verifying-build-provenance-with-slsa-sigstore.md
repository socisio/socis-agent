---
title: "Verifying Build Provenance With Slsa Sigstore — Verifies artifact signatures and SLSA provenance using"
sidebar_label: "Verifying Build Provenance With Slsa Sigstore"
description: "Verifies artifact signatures and SLSA provenance using"
---
...
Verifies artifact signatures and SLSA provenance using

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/verifying-build-provenance-with-slsa-sigstore` |
| Path | `optional-skills/security/verifying-build-provenance-with-slsa-sigstore` |
| Version | `1.0` |
| Author | mahipal (vendored by SOCIS) |
| License | Apache-2.0 |
| Platforms | linux, macos, windows |
| Tags | `supply-chain`, `slsa`, `sigstore`, `cosign`, `provenance`, `attestation`, `keyless-signing`, `code-signing` |
