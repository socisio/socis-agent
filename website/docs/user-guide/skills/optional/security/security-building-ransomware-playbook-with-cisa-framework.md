---
title: "Building Ransomware Playbook With Cisa Framework — Builds a structured ransomware incident response playbook"
sidebar_label: "Building Ransomware Playbook With Cisa Framework"
description: "Builds a structured ransomware incident response playbook"
---
...
Builds a structured ransomware incident response playbook

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/building-ransomware-playbook-with-cisa-framework` |
| Path | `optional-skills/security/building-ransomware-playbook-with-cisa-framework` |
| Version | `1.0.0` |
