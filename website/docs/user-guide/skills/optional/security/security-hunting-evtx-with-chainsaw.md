---
title: "Hunting Evtx With Chainsaw — Run Chainsaw against collected Windows EVTX files to hunt"
sidebar_label: "Hunting Evtx With Chainsaw"
description: "Run Chainsaw against collected Windows EVTX files to hunt"
---
...
Run Chainsaw against collected Windows EVTX files to hunt

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/hunting-evtx-with-chainsaw` |
| Path | `optional-skills/security/hunting-evtx-with-chainsaw` |
| Version | `1.0` |
| Author | mahipal (vendored by SOCIS) |
| License | Apache-2.0 |
| Platforms | linux, macos, windows |
| Tags | `chainsaw`, `threat-hunting`, `evtx`, `sigma`, `windows-event-logs`, `dfir`, `detection`, `shimcache` |
