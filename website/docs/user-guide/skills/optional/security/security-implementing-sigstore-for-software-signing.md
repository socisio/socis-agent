---
title: "Implementing Sigstore For Software Signing — Implements Sigstore-based software signing and verification"
sidebar_label: "Implementing Sigstore For Software Signing"
description: "Implements Sigstore-based software signing and verification"
---
...
Implements Sigstore-based software signing and verification

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/implementing-sigstore-for-software-signing` |
| Path | `optional-skills/security/implementing-sigstore-for-software-signing` |
| Version | `1.0.0` |
| Author | mukul975 (vendored by SOCIS) |
| License | Apache-2.0 |
| Platforms | linux, macos, windows |
| Tags | `sigstore`, `cosign`, `rekor`, `fulcio`, `software-signing`, `supply-chain`, `keyless-signing`, `OIDC` |
