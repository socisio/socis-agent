---
title: "Analyzing Mft For Deleted File Recovery — Analyze the NTFS Master File Table ($MFT) with MFTECmd"
sidebar_label: "Analyzing Mft For Deleted File Recovery"
description: "Analyze the NTFS Master File Table ($MFT) with MFTECmd"
---
...
| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/analyzing-mft-for-deleted-file-recovery` |
| Path | `optional-skills/security/analyzing-mft-for-deleted-file-recovery` |
| Version | `1.0` |
| Author | mahipal (vendored by SOCIS) |
| License | Apache-2.0 |
| Platforms | linux, macos, windows |
| Tags | `mft`, `ntfs`, `deleted-files`, `file-recovery`, `mftecmd`, `usn-journal`, `logfile`, `mft-slack-space` |
