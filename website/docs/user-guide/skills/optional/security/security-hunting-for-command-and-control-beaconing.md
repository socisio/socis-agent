---
title: "Hunting For Command And Control Beaconing — Detect C2 beaconing patterns in network traffic using"
sidebar_label: "Hunting For Command And Control Beaconing"
description: "Detect C2 beaconing patterns in network traffic using"
---
...
Detect C2 beaconing patterns in network traffic using

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/hunting-for-command-and-control-beaconing` |
| Path | `optional-skills/security/hunting-for-command-and-control-beaconing` |
| Version | `1.0` |
