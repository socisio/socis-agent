---
title: "Triaging Security Incident With Ir Playbook — Classifies and prioritizes security incidents using"
sidebar_label: "Triaging Security Incident With Ir Playbook"
description: "Classifies and prioritizes security incidents using"
---
...
Classifies and prioritizes security incidents using

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/triaging-security-incident-with-ir-playbook` |
| Path | `optional-skills/security/triaging-security-incident-with-ir-playbook` |
| Version | `1.0` |
