---
title: "Profiling Threat Actor Groups — Develops comprehensive threat actor profiles for APT"
sidebar_label: "Profiling Threat Actor Groups"
description: "Develops comprehensive threat actor profiles for APT"
---
...
Develops comprehensive threat actor profiles for APT

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/profiling-threat-actor-groups` |
| Path | `optional-skills/security/profiling-threat-actor-groups` |
| Version | `1.0.0` |
