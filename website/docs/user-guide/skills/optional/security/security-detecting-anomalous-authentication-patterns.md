---
title: "Detecting Anomalous Authentication Patterns — Detects anomalous authentication patterns using UEBA"
sidebar_label: "Detecting Anomalous Authentication Patterns"
description: "Detects anomalous authentication patterns using UEBA"
---
...
Detects anomalous authentication patterns using UEBA

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/detecting-anomalous-authentication-patterns` |
| Path | `optional-skills/security/detecting-anomalous-authentication-patterns` |
| Version | `1.0` |
