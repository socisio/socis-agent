---
title: "Analyzing Dns Logs For Exfiltration — Analyzes DNS query logs to detect data exfiltration via DNS"
sidebar_label: "Analyzing Dns Logs For Exfiltration"
description: "Analyzes DNS query logs to detect data exfiltration via DNS"
---
...
Analyzes DNS query logs to detect data exfiltration via DNS

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/analyzing-dns-logs-for-exfiltration` |
| Path | `optional-skills/security/analyzing-dns-logs-for-exfiltration` |
| Version | `1.0` |
