---
title: "Performing Cloud Log Forensics With Athena — Uses AWS Athena to query CloudTrail, VPC Flow Logs, S3"
sidebar_label: "Performing Cloud Log Forensics With Athena"
description: "Uses AWS Athena to query CloudTrail, VPC Flow Logs, S3"
---
...
Uses AWS Athena to query CloudTrail, VPC Flow Logs, S3

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/performing-cloud-log-forensics-with-athena` |
| Path | `optional-skills/security/performing-cloud-log-forensics-with-athena` |
| Version | `1.0` |
| Author | mukul975 (vendored by SOCIS) |
| License | Apache-2.0 |
...
WITH SERDEPROPERTIES (
    'serialization.format' = '1',
    'input.regex' = '([^ ]*) ([^ ]*) ([^ ]*) ([^ ]*):([0-9]*) ([^ ]*)[:-](https://github.com/socisio/socis-agent/blob/main/optional-skills/security/performing-cloud-log-forensics-with-athena/[0-9]*) ([-.0-9]*) ([-.0-9]*) ([-.0-9]*) (|[0-9]*) (-|[0-9]*) ([-0-9]*) ([-0-9]*) \"([^ ]*) (.*) (- |[^ ]*)\" \"([^\"]*)\" ([A-Z0-9-_]+) ([A-Za-z0-9.-]*) ([^ ]*) \"([^\"]*)\" \"([^\"]*)\" \"([^\"]*)\" ([-.0-9]*) ([^ ]*) \"([^\"]*)\" \"([^\"]*)\" \"([^ ]*)\" \"([^\"]*)\" \"([^ ]*)\" \"([^ ]*)\" \"([^ ]*)\"'
)
STORED AS INPUTFORMAT 'org.apache.hadoop.mapred.TextInputFormat'
OUTPUTFORMAT 'org.apache.hadoop.hive.ql.io.HiveIgnoreKeyTextOutputFormat'
