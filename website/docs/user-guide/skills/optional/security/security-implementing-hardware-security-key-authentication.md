---
title: "Implementing Hardware Security Key Authentication — Builds a FIDO2/WebAuthn relying party server with the"
sidebar_label: "Implementing Hardware Security Key Authentication"
description: "Builds a FIDO2/WebAuthn relying party server with the"
---
...
Builds a FIDO2/WebAuthn relying party server with the

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/implementing-hardware-security-key-authentication` |
| Path | `optional-skills/security/implementing-hardware-security-key-authentication` |
| Version | `1.0.0` |
