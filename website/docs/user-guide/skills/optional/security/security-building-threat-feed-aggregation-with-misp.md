---
title: "Building Threat Feed Aggregation With Misp — Deploy MISP via Docker and configure feeds from sources"
sidebar_label: "Building Threat Feed Aggregation With Misp"
description: "Deploy MISP via Docker and configure feeds from sources"
---
...
Deploy MISP via Docker and configure feeds from sources

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/building-threat-feed-aggregation-with-misp` |
| Path | `optional-skills/security/building-threat-feed-aggregation-with-misp` |
| Version | `1.0` |
