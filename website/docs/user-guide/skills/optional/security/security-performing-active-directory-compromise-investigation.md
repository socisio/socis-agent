---
title: "Performing Active Directory Compromise Investigation — Investigate Active Directory compromise by analyzing"
sidebar_label: "Performing Active Directory Compromise Investigation"
description: "Investigate Active Directory compromise by analyzing"
---
...
Investigate Active Directory compromise by analyzing

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/performing-active-directory-compromise-investigation` |
| Path | `optional-skills/security/performing-active-directory-compromise-investigation` |
| Version | `1.0` |
