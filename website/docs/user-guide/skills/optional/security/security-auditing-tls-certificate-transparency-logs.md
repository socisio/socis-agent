---
title: "Auditing Tls Certificate Transparency Logs — Monitors Certificate Transparency (CT) logs to detect"
sidebar_label: "Auditing Tls Certificate Transparency Logs"
description: "Monitors Certificate Transparency (CT) logs to detect"
---
...
Monitors Certificate Transparency (CT) logs to detect

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/auditing-tls-certificate-transparency-logs` |
| Path | `optional-skills/security/auditing-tls-certificate-transparency-logs` |
| Version | `1.0.0` |
