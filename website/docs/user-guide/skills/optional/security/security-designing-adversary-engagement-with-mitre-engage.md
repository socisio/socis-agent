---
title: "Designing Adversary Engagement With Mitre Engage — Plan, run, and measure an adversary engagement operation"
sidebar_label: "Designing Adversary Engagement With Mitre Engage"
...
| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/designing-adversary-engagement-with-mitre-engage` |
| Path | `optional-skills/security/designing-adversary-engagement-with-mitre-engage` |
| Version | `1.0` |
| Author | andrewibrah (vendored by SOCIS) |
| License | Apache-2.0 |
| Platforms | linux, macos, windows |
| Tags | `mitre-engage`, `adversary-engagement`, `deception`, `denial-and-deception`, `engage-matrix`, `cyber-deception`, `threat-intelligence`, `detection-engineering` |
