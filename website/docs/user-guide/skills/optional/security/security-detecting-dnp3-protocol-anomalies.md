---
title: "Detecting Dnp3 Protocol Anomalies — Detect anomalies in DNP3 communications used in SCADA/ICS"
sidebar_label: "Detecting Dnp3 Protocol Anomalies"
description: "Detect anomalies in DNP3 communications used in SCADA/ICS"
---
...
Detect anomalies in DNP3 communications used in SCADA/ICS

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/detecting-dnp3-protocol-anomalies` |
| Path | `optional-skills/security/detecting-dnp3-protocol-anomalies` |
| Version | `1.0` |
