---
title: "Detecting Ransomware Precursors In Network — Detects early-stage ransomware indicators in network"
sidebar_label: "Detecting Ransomware Precursors In Network"
description: "Detects early-stage ransomware indicators in network"
---
...
Detects early-stage ransomware indicators in network

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/detecting-ransomware-precursors-in-network` |
| Path | `optional-skills/security/detecting-ransomware-precursors-in-network` |
| Version | `1.0.0` |
