---
title: "Performing Log Analysis For Forensic Investigation — Collect, parse, and correlate system, application, and"
sidebar_label: "Performing Log Analysis For Forensic Investigation"
description: "Collect, parse, and correlate system, application, and"
---
...
Collect, parse, and correlate system, application, and

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/performing-log-analysis-for-forensic-investigation` |
| Path | `optional-skills/security/performing-log-analysis-for-forensic-investigation` |
| Version | `1.0` |
