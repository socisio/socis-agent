---
title: "Implementing Aqua Security For Container Scanning — Deploy Aqua Security's Trivy scanner to detect"
sidebar_label: "Implementing Aqua Security For Container Scanning"
description: "Deploy Aqua Security's Trivy scanner to detect"
---
...
Deploy Aqua Security's Trivy scanner to detect

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/implementing-aqua-security-for-container-scanning` |
| Path | `optional-skills/security/implementing-aqua-security-for-container-scanning` |
| Version | `1.0` |
