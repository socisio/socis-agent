---
title: "Scanning Network With Nmap Advanced — Performs advanced network recon using Nmap's Scripting"
sidebar_label: "Scanning Network With Nmap Advanced"
description: "Performs advanced network recon using Nmap's Scripting"
---
...
Performs advanced network recon using Nmap's Scripting

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/scanning-network-with-nmap-advanced` |
| Path | `optional-skills/security/scanning-network-with-nmap-advanced` |
| Version | `1.0` |
