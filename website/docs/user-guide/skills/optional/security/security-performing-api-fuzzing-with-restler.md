---
title: "Performing Api Fuzzing With Restler — Uses Microsoft RESTler to perform stateful REST API"
...
| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/performing-api-fuzzing-with-restler` |
| Path | `optional-skills/security/performing-api-fuzzing-with-restler` |
| Version | `1.0.0` |
