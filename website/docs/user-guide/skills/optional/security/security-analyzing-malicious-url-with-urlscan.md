---
title: "Analyzing Malicious Url With Urlscan — URLScan.io is a free service for scanning and analyzing"
...
| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/analyzing-malicious-url-with-urlscan` |
| Path | `optional-skills/security/analyzing-malicious-url-with-urlscan` |
| Version | `1.0` |
