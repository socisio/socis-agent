---
title: "Collecting Open Source Intelligence — Collects and synthesizes open-source intelligence (OSINT)"
sidebar_label: "Collecting Open Source Intelligence"
description: "Collects and synthesizes open-source intelligence (OSINT)"
---
...
Collects and synthesizes open-source intelligence (OSINT)

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/collecting-open-source-intelligence` |
| Path | `optional-skills/security/collecting-open-source-intelligence` |
| Version | `1.0.0` |
