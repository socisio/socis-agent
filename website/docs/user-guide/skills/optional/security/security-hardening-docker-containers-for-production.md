---
title: "Hardening Docker Containers For Production — Hardens Dockerfiles, images, and per-container runtime"
sidebar_label: "Hardening Docker Containers For Production"
description: "Hardens Dockerfiles, images, and per-container runtime"
---
...
Hardens Dockerfiles, images, and per-container runtime

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/hardening-docker-containers-for-production` |
| Path | `optional-skills/security/hardening-docker-containers-for-production` |
| Version | `1.0` |
