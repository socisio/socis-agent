---
title: "Implementing Google Workspace Sso Configuration — Configures SAML 2.0 single sign-on for Google Workspace"
sidebar_label: "Implementing Google Workspace Sso Configuration"
description: "Configures SAML 2.0 single sign-on for Google Workspace"
---
...
Configures SAML 2.0 single sign-on for Google Workspace

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/implementing-google-workspace-sso-configuration` |
| Path | `optional-skills/security/implementing-google-workspace-sso-configuration` |
| Version | `1.0` |
