---
title: "Hunting For Persistence Via Wmi Subscriptions — Hunts for adversary persistence via WMI event subscriptions"
sidebar_label: "Hunting For Persistence Via Wmi Subscriptions"
description: "Hunts for adversary persistence via WMI event subscriptions"
---
...
Hunts for adversary persistence via WMI event subscriptions

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/hunting-for-persistence-via-wmi-subscriptions` |
| Path | `optional-skills/security/hunting-for-persistence-via-wmi-subscriptions` |
| Version | `1.0` |
