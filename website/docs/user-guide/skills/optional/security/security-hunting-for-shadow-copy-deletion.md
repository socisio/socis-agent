---
title: "Hunting For Shadow Copy Deletion — Runs a hypothesis-driven threat hunt for Volume Shadow Copy"
sidebar_label: "Hunting For Shadow Copy Deletion"
description: "Runs a hypothesis-driven threat hunt for Volume Shadow Copy"
---
...
Runs a hypothesis-driven threat hunt for Volume Shadow Copy

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `socis skills install official/security/hunting-for-shadow-copy-deletion` |
| Path | `optional-skills/security/hunting-for-shadow-copy-deletion` |
| Version | `1.0` |
