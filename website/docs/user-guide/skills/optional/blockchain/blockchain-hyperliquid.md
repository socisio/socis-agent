...
| | |
|---|---|
| Source | Optional — install with `socis skills install official/blockchain/hyperliquid` |
| Path | `optional-skills/blockchain\hyperliquid` |
| Version | `0.1.0` |
| Author | Hugo Sequier (Hugo-SEQUIER), SOCIS Agent |
| License | MIT |
...
The script reads `${SOCIS_AGENT_HOME:-~/.socis-agent}/.env` for two optional defaults:
...
Helper script: `~/.socis-agent/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py`
...
```bash
python ~/.socis-agent/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py <command> [args]
```
...
optional when `HYPERLIQUID_USER_ADDRESS` is set in `${SOCIS_AGENT_HOME:-~/.socis-agent}/.env`.
...
```bash
python ~/.socis-agent/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py dexs

python ~/.socis-agent/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py \
