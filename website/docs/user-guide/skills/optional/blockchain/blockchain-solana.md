...
| | |
|---|---|
| Source | Optional — install with `socis skills install official/blockchain/solana` |
| Path | `optional-skills/blockchain/solana` |
| Version | `0.2.0` |
| Author | Deniz Alagoz (gizdusum), enhanced by SOCIS Agent |
| License | MIT |
...
Helper script path: ~/.socis-agent/skills/blockchain/solana/scripts/solana_client.py
...
python ~/.socis-agent/skills/blockchain/solana/scripts/solana_client.py stats
```
...
```bash
python ~/.socis-agent/skills/blockchain/solana/scripts/solana_client.py \
...
```bash
python ~/.socis-agent/skills/blockchain/solana/scripts/solana_client.py price BONK
python ~/.socis-agent/skills/blockchain/solana/scripts/solana_client.py price JUP
python ~/.socis-agent/skills/blockchain/solana/scripts/solana_client.py price SOL
python ~/.socis-agent/skills/blockchain/solana/scripts/solana_client.py price DezXAZ8z7PnrnRJjz3wXBoRgixCa6xjnB7YaB1pPB263
```
