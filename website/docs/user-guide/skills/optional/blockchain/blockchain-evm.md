...
Helper script path: `~/.socis-agent/skills/blockchain/evm/scripts/evm_client.py`
...
python ~/.socis-agent/skills/blockchain/evm/scripts/evm_client.py stats
```
...
python ~/.socis-agent/skills/blockchain/evm/scripts/evm_client.py ens vitalik.eth
```
