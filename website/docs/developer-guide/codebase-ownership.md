...
| Model providers & transports | `agent/transports/`, `plugins/model-providers/`, `socis_cli/models.py` | [Adding Providers](adding-providers.md), [Model Provider Plugins](model-provider-plugin.md), [Provider Runtime](provider-runtime.md) |
...
| CLI | `socis_cli/` | [Extending the CLI](extending-the-cli.md) |
| Plugins system | `plugins/` | [Build a SOCIS Plugin](plugins/index.md) |
...
| Session storage | `socis_agent_state.py` | [Session Storage](session-storage.md) |
