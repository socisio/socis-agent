...
| [`socis-agent`](/docs/user-guide/skills/bundled/autonomous-ai-agents/autonomous-ai-agents-socis-agent) | Use, configure, theme, extend, and orchestrate SOCIS Agent. | `autonomous-ai-agents/socis-agent` |
...
| Skill | Description | Path |
|-------|-------------|------|
| [`alert-triage`](/docs/user-guide/skills/bundled/security-operations/security-operations-alert-triage) | Triage SOC alerts: enrich, scope, classify, verdict. | `security-operations/alert-triage` |
| [`attack-mapping`](/docs/user-guide/skills/bundled/security-operations/security-operations-attack-mapping) | Map observed activity to MITRE ATT&CK; assess real coverage. | `security-operations/attack-mapping` |
| [`detection-engineering`](/docs/user-guide/skills/bundled/security-operations/security-operations-detection-engineering) | Author, convert and tune Sigma rules for any SIEM. | `security-operations/detection-engineering` |
| [`evidence-handling`](/docs/user-guide/skills/bundled/security-operations/security-operations-evidence-handling) | Acquire and preserve digital evidence (ISO 27037). | `security-operations/evidence-handling` |
| [`incident-response`](/docs/user-guide/skills/bundled/security-operations/security-operations-incident-response) | Run an incident: contain, eradicate, recover, report. | `security-operations/incident-response` |
...
| [`inspecting-socis-desktop-dom`](/docs/user-guide/skills/bundled/software-development/software-development-inspecting-socis-desktop-dom) | Read the live SOCIS desktop DOM/CSS over CDP. | `software-development/inspecting-socis-desktop-dom` |
...
| [`socis-agent-skill-authoring`](/docs/user-guide/skills/bundled/software-development/software-development-socis-agent-skill-authoring) | Author in-repo SKILL.md files: frontmatter and structure. | `software-development/socis-agent-skill-authoring` |
