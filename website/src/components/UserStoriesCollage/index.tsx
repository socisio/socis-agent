  ...
  return (
    <div className={styles.wrap}>
      <div className={styles.hero}>
        ...
        <p>
          What the SOCIS Agent community is actually building. Every tile
          below links to a real post, issue, video, or gist where someone
          describes how they use SOCIS &mdash; scraped from X, GitHub, Reddit,
      ...
      <div className={styles.footer}>
        Built something with SOCIS?{' '}
        <a
          href="https://github.com/socisio/socis-agent/edit/main/website/src/data/userStories.json"
          target="_blank"
          rel="noopener noreferrer"
        >
        ...
        <a href="https://discord.gg/SOCIS" target="_blank" rel="noopener noreferrer">
          SOCIS Discord
        </a>{' '}
