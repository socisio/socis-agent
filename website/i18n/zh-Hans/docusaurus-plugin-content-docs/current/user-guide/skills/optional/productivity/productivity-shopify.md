...
| | |
|---|---|
| 来源 | 可选 — 通过 `socis skills install official/productivity/shopify` 安装 |
...
}' '{"input":{"title":"Test Hoodie","status":"DRAFT","vendor":"SOCIS","productType":"Apparel","tags":["test"]}}'
```
