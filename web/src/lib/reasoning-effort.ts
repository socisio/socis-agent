 ...
 *
 * Values mirror socis_agent_constants.VALID_REASONING_EFFORTS plus `none`
 * (thinking-off). An empty/unset config value means the SOCIS default,
 * which is `medium`.
 */
 ...
 *  option. Empty/unknown → `medium` (SOCIS' default when unset). */
