...
const SOURCE_CONFIG: Record<string, { icon: typeof Terminal; color: string }> =
  {
    ...
    socis_flow: { icon: Play, color: "text-warning" },
...
const NO_MATCHING_SESSION_SOURCE = "__socis_dashboard_no_matching_source__";
        ...
        const res = await fetch(api.exportSessionUrl(id, rowProfile(id)), {
          ...
          headers: {
            "X-SOCIS-Session-Token":
              (window as unknown as { __SOCIS_AGENT_SESSION_TOKEN__?: string })
                .__SOCIS_AGENT_SESSION_TOKEN__ ?? "",
          },
        });
