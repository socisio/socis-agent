/**
 * SOCIS Dashboard Plugin SDK — typed contract (SPIKE)
 * ====================================================
 *
 * This is the public type surface for ``window.__SOCIS_AGENT_PLUGIN_SDK__`` and
 * ``window.__SOCIS_AGENT_PLUGINS__``, the globals the dashboard host exposes to
 ...
 * window.__SOCIS_AGENT_PLUGIN_SDK__`` because:
 ...
 *
 * Versioning: bump ``SOCISPluginSDK["sdkVersion"]`` (and the
 ...
 *   - Ship as a published ``@socis/dashboard-plugin-sdk`` types package, or
 ...
 * of calling ``fetch`` with a hand-read ``window.__SOCIS_AGENT_SESSION_TOKEN__``.
 */
...
// ---------------------------------------------------------------------------
// Registry surface (window.__SOCIS_AGENT_PLUGINS__)
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// SDK surface (window.__SOCIS_AGENT_PLUGIN_SDK__)
// ---------------------------------------------------------------------------

export interface SOCISPluginSDK {
...
declare global {
  interface Window {
    __SOCIS_AGENT_PLUGIN_SDK__?: SOCISPluginSDK;
    __SOCIS_AGENT_PLUGINS__?: PluginRegistry;
  }
}
