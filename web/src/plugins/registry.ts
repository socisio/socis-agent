 ...
 *
 * Plugins call window.__SOCIS_AGENT_PLUGINS__.register(name, Component)
 ...
 * Exposed at runtime as ``window.__SOCIS_AGENT_PLUGIN_SDK__.sdkVersion`` so a
...
export function exposePluginSDK() {
  window.__SOCIS_AGENT_PLUGINS__ = {
    register: registerPlugin,
    registerSlot,
  };

  window.__SOCIS_AGENT_PLUGIN_SDK__ = {
    ...
    // window.__SOCIS_AGENT_SESSION_TOKEN__ directly.
    authedFetch,
