 ...
 * `window.__SOCIS_AGENT_PLUGINS__.registerSlot(pluginName, slotName, Component)`
 ...
 *  - `header-left`      — injected before the SOCIS brand in the top bar
 ...
 *  `window.__SOCIS_AGENT_PLUGINS__.registerSlot(...)`.
 *
