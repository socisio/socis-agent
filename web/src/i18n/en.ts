...
export const en: Translations = {
  ...
  status: {
    ...
    updateSOCISConfirmMessage:
      "This runs socis update and restarts the gateway when it finishes. Active sessions keep their prompt cache until then.",
    updateSOCISConfirmNow: "Update now",
    updateSOCISConfirmTitle: "Update SOCIS?",
    updatingSOCIS: "Updating SOCIS…",
  ...
  pluginsPage: {
    ...
    headline:
      "Discover, install, enable, and update SOCIS plugins (`socis plugins` parity).",
    ...
    removeConfirm: "Remove this plugin from ~/.socis-agent/plugins/?",
    removeHint: "Only user-installed plugins under ~/.socis-agent/plugins can be removed.",
  ...
  skills: {
    ...
    filters: "Filters",
    noSkills: "No skills found. Skills are loaded from ~/.socis-agent/skills/",
  ...
  config: {
    configPath: "~/.socis-agent/config.yaml",
    filters: "Filters",
    sections: "Sections",
  ...
  env: {
    ...
    customHint: "Arbitrary environment variables stored in your .env that SOCIS doesn't recognise. Use these to inject env vars for skills, MCP servers, or your own tooling.",
  ...
  achievements: {
    hero: {
      ...
      title: "SOCIS Achievements",
      subtitle:
        "Collectible SOCIS badges earned from real session history. Known unfinished achievements are shown as Discovered; Secret achievements stay hidden until the first matching behavior appears.",
      scan_subtitle:
        "Scanning SOCIS session history. First scan can take 5–10 seconds on large histories.",
    },
    actions: {
      rescan: "Rescan",
    },
    stats: {
      ...
      latest: "Latest",
      latest_hint_empty: "run SOCIS more",
      none_yet: "None yet",
    },
    state: {
      unlocked: "Unlocked",
    ...
    guide: {
      ...
      secret_body:
        "Secrets hide their exact trigger. Once SOCIS sees a related signal, the card becomes Discovered and shows its requirement.",
      scan_status_header: "Scan status",
      scan_status_body:
        "SOCIS is scanning local history once, then cards will appear automatically. Nothing is stuck if this takes a few seconds.",
    ...
    share: {
      ...
      tweet_text: "Just unlocked {tier_part}\"{name}\" in SOCIS Agent",
    },
  },
