...
export interface Translations {
  ...
  status: {
    ...
    stopped: string;
    updateSOCIS: string;
    updateSOCISConfirmMessage?: string;
    updateSOCISConfirmNow?: string;
    updateSOCISConfirmTitle?: string;
    updatingSOCIS: string;
  ...
  // ── Achievements plugin (plugins/socis-achievements) ──
  achievements: {
    hero: {
      kicker: string;
      title: string;
