...
the get_anchored_view / get_messages_around primitives in socis_agent_state.
...
from socis_agent_state_common import _RESET_END_REASONS

# Sources that are excluded from session browsing/searching by default.
# Third-party integrations tag their sessions with SOCIS_AGENT_SESSION_SOURCE=tool;
...
SESSION_SEARCH_SCHEMA = {
    "name": "session_search",
    "description": (
        "Recall past conversations: search or read old SOCIS sessions (FTS5), or "
    ...
    "parameters": {
        ...
        "properties": {
            ...
            "profile": {
                "type": "string",
                "description": (
                    "Optional. Read sessions from another SOCIS profile's database "
