...
def live_transcript_root() -> Path:
    """Root directory for live transcripts (profile-safe, never ~/.socis-agent)."""
    from socis_agent_constants import get_socis_dir

    return get_socis_dir("cache/delegation", "delegation_cache") / "live"
...
class LiveTranscriptWriter:
    ...
    def __init__(self, delegation_id: str, task_index: int, goal: str,
        ...
        try:
            ...
            header = [
                "=== SOCIS subagent live transcript ===",
