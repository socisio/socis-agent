...
class UIElement:
    ...
    # (trycua/cua#1961 — Surface 6 of socisio/socis-agent#47072).
...
class CaptureResult:
    ...
    # trycua/cua#1961 — Surface 7 of socisio/socis-agent#47072).
...
class ActionResult:
    ...
    verify → escalate ladder (socisio/socis-agent#67052). ``ok`` stays
