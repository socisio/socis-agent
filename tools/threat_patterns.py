...
_PATTERNS: List[Tuple[str, str, str]] = [
    ...
    (r'unset\s+\w*(?:CLAUDE|CODEX|SOCIS|AGENT|OPENAI|ANTHROPIC)\w*', "env_var_unset_agent", "context"),
    ...
    (r'\$HOME/\.socis-agent/\.env|\~/\.socis-agent/\.env', "socis_env", "strict"),
    ...
    (r'(update|modify|edit|write|change|append|add\s+to)\s+[^\n]{0,2048}\.socis-agent/(config\.yaml|SOUL\.md)', "socis_config_mod", "strict"),
...
def scan_for_threats(content: str, scope: str = "context") -> List[str]:
    ...
    # bypassing keyword checks (e.g. ``ｃａｔ ~/.socis-agent/.env``).  NOTE: this
