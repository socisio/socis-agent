#!/usr/bin/env python3
"""Apply a layout preset in the SOCIS desktop GUI.
...
_TIMEOUT_NOTE = "Layout apply is only available in the SOCIS desktop app."
...
APPLY_LAYOUT_SCHEMA = {
    "name": "apply_layout",
    "description": (
        "Apply a saved layout preset to the SOCIS desktop app when the user "
