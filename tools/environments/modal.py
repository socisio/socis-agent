...
wrapper, while preserving SOCIS' persistent snapshot behavior across sessions.
"""
...
_SNAPSHOT_STORE = get_socis_agent_home() / "modal_snapshots.json"
...
class ModalEnvironment(BaseEnvironment):
    ...
    def __init__(
        ...
        async def _create_sandbox(image_spec: Any):
            app = await _modal.App.lookup.aio("socis-agent", create_if_missing=True)
