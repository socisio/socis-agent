...
Only included in the socis-discord toolset, so it has zero cost
...
def _discord_request(
    ...
    req = urllib.request.Request(
        ...
        headers={
            ...
            "User-Agent": "SOCIS-Agent (https://github.com/socisio/socis-agent)",
        },
    )
...
def _capability_disk_cache_path() -> "Path":
    ...
    return get_socis_agent_home() / "cache" / "discord_capabilities.json"
