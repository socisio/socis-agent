 ...
 *
 * Each entry is a key/value pair that lands in the packaged SOCIS.app's
 ...
 * "SOCIS wants to access Music" prompt unless the Info.plist disclaims it
 ...
 * user ("SOCIS wants to access Music" when SOCIS never touches the Music
