...
def test_import_loads_env_from_socis_agent_home(tmp_path, monkeypatch):
    home = tmp_path / ".socis-agent"
    home.mkdir()
    (home / ".env").write_text("OPENROUTER_API_KEY=from-socis-home\n", encoding="utf-8")
    ...
    assert os.getenv("OPENROUTER_API_KEY") == "from-socis-home"
