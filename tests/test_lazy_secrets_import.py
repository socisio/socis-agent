"""Regression test: socis update must not load cryptography eagerly."""
...
assert 'socis_cli.secrets_cli' not in sys.modules, \\
...
"""
    ...
    def test_update_check_no_cryptography(self) -> None:
        """Running socis update --check should NOT load cryptography._rust."""
        # Write a small script in the repo root so socis_cli is importable,
...
import socis_cli.main
from socis_cli.update_cmd import _cmd_update_check
