...
* ``socis_agent_constants.get_socis_dir`` (cache path)
...
def tmp_cache_dir(tmp_path):
    """Override get_socis_dir so cache writes land under tmp_path."""
    ...
    with patch("socis_agent_constants.get_socis_dir", _fake_get):
        yield cache_dir
