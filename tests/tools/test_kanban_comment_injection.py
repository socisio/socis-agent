...
def worker_home(tmp_path, monkeypatch):
    ...
    for var in ("SOCIS_AGENT_KANBAN_DB", "SOCIS_AGENT_KANBAN_WORKSPACES_ROOT", "SOCIS_AGENT_KANBAN_HOME", "SOCIS_AGENT_KANBAN_BOARD"):
...
def test_seed_then_inject_new_comment(worker_home, monkeypatch):
    ...
    monkeypatch.setenv("SOCIS_AGENT_PROFILE", "worker-bot")
    agent = FakeAgent()
