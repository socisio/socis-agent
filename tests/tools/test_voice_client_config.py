...
Real config files in a temp SOCIS_AGENT_HOME, real resolution chains (no mocked
...
def voice_home(tmp_path, monkeypatch):
    """Isolated SOCIS_AGENT_HOME + reloaded config modules; yields a config writer."""
    ...
    for var in (
        ...
        "DEEPINFRA_API_KEY", "SOCIS_AGENT_LOCAL_STT_LANGUAGE",
    ):
