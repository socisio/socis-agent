...
def ledger_env(tmp_path, monkeypatch):
    """Isolated SOCIS_AGENT_HOME + skills dir for skill_manage and the ledger."""
    ...
    monkeypatch.setattr(skill_ledger, "get_socis_agent_home", lambda: home)
    monkeypatch.setattr(skill_usage, "get_socis_agent_home", lambda: home)
...
def test_rollback_refuses_paths_outside_socis_agent_home(ledger_env):
    """A hand-edited ledger entry pointing outside SOCIS_AGENT_HOME must not
