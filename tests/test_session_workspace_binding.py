"""Session <-> workspace grouping key (socis_agent_state.workspace_key).

The key is what `socis sessions list --workspace` groups/filters on. It is a
...
from socis_agent_state import workspace_key
