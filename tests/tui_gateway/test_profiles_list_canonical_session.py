...
def home(tmp_path, monkeypatch):
    """Temp SOCIS_AGENT_HOME with the default profile plus one named profile."""
...
def test_profiles_list_opens_session_db_read_only(home, monkeypatch):
    ...
    seen = []
    Real = socis_agent_state.SessionDB
    ...
    monkeypatch.setattr(socis_agent_state, "SessionDB", Spy)
