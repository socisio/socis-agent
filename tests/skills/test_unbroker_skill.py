...
# Resolve the skill's scripts dir across layouts: standalone dev repo (tests/) and socis-agent
...
_CANDIDATES = [
    ...
    _HERE.parent.parent.parent.joinpath(*_REL),          # socis-agent (tests/skills/)
]
