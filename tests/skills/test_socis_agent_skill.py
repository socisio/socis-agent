"""The `socis-agent` skill is what a running SOCIS knows about itself.

`website/` is never packaged, so an installed SOCIS has no local copy of the
user guide; skills ARE synced into `$SOCIS_AGENT_HOME/skills/`. The skill therefore
...
shipped feature is invisible and the agent answers "SOCIS can't do that."
"""
...
SKILL_DIR = REPO / "skills" / "autonomous-ai-agents" / "socis-agent"
