...
def test_rotation_is_atomic_under_sigkill(tmp_path, requested_mode):
    ...
    if requested_mode is not None:
        # Steer the CHILD's own resolver via an isolated SOCIS_AGENT_HOME config:
        ...
        child_env["SOCIS_AGENT_HOME"] = str(
            make_socis_agent_home(tmp_path, requested_mode.lower())
        )
