...
def make_socis_agent_home(base: Path, journal_mode: str) -> Path:
    """Create an isolated SOCIS_AGENT_HOME whose config pins ``database.journal_mode``.
    ...
    """
    home = base / f"socis-home-{journal_mode}"
