...
Damien's incident (Discord, 2026-05-28): a long SOCIS session in a Discord
...
def _make_legacy_session_db_class() -> type:
    ...
    imports the same still-loaded ``socis_agent_state`` module, whose ``SessionDB``
    ...
    namespace = {"__name__": "socis_agent_state"}
    source = '''
class SessionDB:
...
_NominalSessionDBImpostor.__module__ = "socis_agent_state"
