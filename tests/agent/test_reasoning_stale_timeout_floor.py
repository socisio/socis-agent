...
thinking phase.  SOCIS's default cloud-stream stale detector
(``SOCIS_AGENT_STREAM_STALE_TIMEOUT`` = 180s) and non-stream detector
(``SOCIS_AGENT_API_CALL_STALE_TIMEOUT`` = 90s) both fire before the
