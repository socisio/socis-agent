...
manipulation. SOCIS keeps canonical conversation history in state.db and may
...
def fake_homes(tmp_path, monkeypatch):
    """Point SOCIS_AGENT_HOME at a temp profile dir.

    Uses the real env-var resolution chain (get_socis_agent_home /
    get_default_socis_root) instead of monkeypatching private helpers —
    ...
    SOCIS_AGENT_HOME=<root>/profiles/<name> makes get_default_socis_root()
