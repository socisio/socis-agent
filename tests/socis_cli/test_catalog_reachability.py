...
Run before any catalog commit:
    ...
    SOCIS_AGENT_TEST_NETWORK=1 scripts/run_tests.sh tests/socis_cli/test_catalog_reachability.py
"""
...
pytestmark = pytest.mark.skipif(
    not os.environ.get("SOCIS_AGENT_TEST_NETWORK"),
    reason="network test; set SOCIS_AGENT_TEST_NETWORK=1 to run",
)
