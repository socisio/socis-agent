...
class TestGetCopilotModelContext:
    ...
    @patch("socis_cli.models.fetch_github_model_catalog", return_value=_SAMPLE_CATALOG)
    ...
    @patch("socis_cli.models._urlopen_model_catalog_request")
    ...
    @patch("socis_cli.models.fetch_github_model_catalog", return_value=[])
