...
class TestStatusEndpointTopology:
    ...
    def _setup_client(self, monkeypatch, _isolate_socis_agent_home):
        try:
    ...
    def test_profile_names_and_mode_public_when_auth_gated(self, monkeypatch):
        ...
        # SOCIS Cloud Portal reads /api/status over the network (a gated bind)
        ...
        try:
            ...
            # alongside socis_agent_home / gateway_pid.
            assert "gateways" not in data
            assert "socis_agent_home" not in data
