"""Regression: ``socis update`` should take a managed checkout off autocrlf=true.
...
``socis update`` has to repair them.
...
from socis_cli.update_cmd import _normalize_managed_eol
