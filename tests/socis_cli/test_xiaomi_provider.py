...
class TestXiaomiCredentials:
    ...
    def test_resolve_credentials_reads_home_external_secret_scope(
        ...
        from socis_cli import env_loader
...
class TestXiaomiProvidersModule:
    ...
    def test_overlay_exists(self):
        ...
        assert "xiaomi" in SOCIS_AGENT_OVERLAYS
        overlay = SOCIS_AGENT_OVERLAYS["xiaomi"]
...
class TestXiaomiDoctor:
    """Verify socis doctor recognizes Xiaomi env vars."""
