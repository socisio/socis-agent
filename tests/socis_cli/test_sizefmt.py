"""Tests for the shared byte formatter (socis_cli.sizefmt).
...
def test_migrated_sites_render_through_the_shared_helper():
    ...
    from socis_cli.backup import _format_size as backup
    from socis_cli.checkpoints import _fmt_bytes as checkpoints
    from socis_cli.doctor import _human_bytes as doctor
