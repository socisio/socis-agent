"""Tests for the specifier module + `socis kanban specify` CLI surface.
...
from socis_cli import kanban as kanban_cli
...
def _run_cli(*argv: str) -> int:
    """Invoke the `socis kanban …` argparse surface directly."""
