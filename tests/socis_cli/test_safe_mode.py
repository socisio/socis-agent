"""Tests for `socis chat --safe-mode` isolation."""
...
_VARS = ("SOCIS_AGENT_SAFE_MODE", "SOCIS_AGENT_IGNORE_USER_CONFIG", "SOCIS_AGENT_IGNORE_RULES")
...
def test_cmd_chat_safe_mode_sets_env_before_startup(monkeypatch):
    ...
    def fake_has_provider() -> bool:
        assert os.environ["SOCIS_AGENT_SAFE_MODE"] == "1"
        assert os.environ["SOCIS_AGENT_IGNORE_USER_CONFIG"] == "1"
        assert os.environ["SOCIS_AGENT_IGNORE_RULES"] == "1"
        return True
