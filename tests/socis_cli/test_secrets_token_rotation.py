"""Tests for `socis secrets bitwarden token` / `socis secrets onepassword token`.
...
from socis_cli import onepassword_secrets_cli as op_cli
from socis_cli import secrets_cli as bw_cli
