"""Tests for the ``socis prompt-size`` diagnostic (issue #34667)."""
...
from socis_cli.prompt_size import (
    _SKILLS_BLOCK_RE,
...
def _seed_memory(socis_agent_home, memory_text="", user_text=""):
    mem_dir = socis_agent_home / "memories"
...
def _seed_skill(socis_agent_home, name, description):
    skill_dir = socis_agent_home / "skills" / "demo" / name
