...
Covers the three paths changed by fix/bedrock-provider-model-ids-live-discovery:
  ...
  2. list_authenticated_providers() Section 2 (SOCIS_AGENT_OVERLAYS) — bedrock
...
# ---------------------------------------------------------------------------
# 2. list_authenticated_providers() — bedrock via SOCIS_AGENT_OVERLAYS (Section 2)
# ---------------------------------------------------------------------------
...
class TestBedrockOverlayRegistration:
    """bedrock entry in SOCIS_AGENT_OVERLAYS is correctly configured."""

    def test_bedrock_overlay_exists(self):
        from socis_cli.providers import SOCIS_AGENT_OVERLAYS
        assert "bedrock" in SOCIS_AGENT_OVERLAYS
