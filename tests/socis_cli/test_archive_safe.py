"""Tests for the shared tar.gz writer (``socis_cli.archive_safe.make_targz``).

``make_targz`` backs both ``socis profile export`` and ``socis kanban
...
from socis_cli.archive_safe import make_targz
