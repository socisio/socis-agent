"""Tests for the interactive session browser (`socis sessions browse`).
...
from socis_cli.main import _session_browse_picker
...
class TestSessionBrowseArgparse:
    ...
    def test_browse_subcommand_exists(self):
        """socis sessions browse should be parseable."""
