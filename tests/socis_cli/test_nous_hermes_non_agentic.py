...
``is_nous_hermes_non_agentic`` should only match the actual Nous
...
def test_matches_real_nous_hermes_chat_models(model_name: str) -> None:
    ...
    assert _check_socis_model_warning(model_name) == _NOUS_HERMES_MODEL_WARNING
