...
def test_vertex_registered_in_provider_registry():
    """PROVIDER_REGISTRY (socis_cli.auth) is what agent/auxiliary_client.py's
...
def test_vertex_registered_in_socis_overlays():
    """socis_cli.providers.get_provider("vertex") backs
