"""Tests for `_can_open_graphical_browser()` in socis_cli.auth.

Guards the fix for the May 2026 report where `socis auth add xai-oauth`
...
from socis_cli.auth import _can_open_graphical_browser
