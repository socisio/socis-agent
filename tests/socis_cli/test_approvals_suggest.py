"""Tests for ``socis approvals suggest`` (socis_cli/approvals_suggest.py).

Approval history in SOCIS is implied, not ledgered: the session DB
...
from socis_cli.approvals_suggest import (
    Proposal,
    apply_proposals,
    build_proposals,
    derive_glob,
