...
The main() function in socis_cli/main.py sets subparsers.required=True
...
If the subcommand token is consumed as a flag value (e.g. `socis -c model`
...
def _build_parser():
    """Build a minimal replica of the socis top-level parser."""
