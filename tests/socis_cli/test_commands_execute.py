...
Every ``CommandDef`` with ``execute`` set must:
  * name a key that exists in :data:`socis_cli.slash_exec.EXECUTORS`, and
...
from socis_cli.commands import COMMAND_REGISTRY, resolve_command
from socis_cli.slash_exec import (
    EXECUTORS,
    CommandContext,
    CommandReply,
    execute_command,
