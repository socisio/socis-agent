...
window keeps moving through the long silent stretches (`socis update`, pip,
...
def test_progress_advances_while_the_orchestrator_blocks(tmp_path: Path) -> None:
    ...
    env["SOCIS_AGENT_SELFTEST_HOLD_SECONDS"] = "30"
    ...
    try:
        ...
        # boot default instead ('SOCIS will open once done.' ==
