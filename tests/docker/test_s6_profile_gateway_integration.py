...
The unit tests in tests/socis_cli/test_service_manager.py exercise the
...
docstring. ``/run/service`` is chowned socis-writable by the
...
_REGISTER_SCRIPT = """
import sys
sys.path.insert(0, "/opt/socis")
from socis_cli.service_manager import S6ServiceManager
