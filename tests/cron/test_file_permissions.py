...
class TestConfigFilePermissions(unittest.TestCase):
    ...
    def test_save_config_sets_0600(self):
        ...
        with patch("socis_cli.config.get_config_path", return_value=config_path), \
             patch("socis_cli.config.ensure_socis_agent_home"):
    ...
    def test_ensure_socis_agent_home_sets_0700(self):
        home = Path(self.tmpdir) / ".socis-agent"
