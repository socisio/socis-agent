...
These exercise the real store against a temp SOCIS_AGENT_HOME (no mocks) per the
...
def temp_home(tmp_path, monkeypatch):
    ...
    # cron.jobs caches no home at import; get_socis_agent_home() reads the env live.
    yield tmp_path
