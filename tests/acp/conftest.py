...
Keeps the ACP server tests offline: ``SOCISACPAgent._build_model_state``
calls ``socis_cli.inventory.build_models_payload``, which (without this
...
def _offline_model_inventory(monkeypatch):
    ...
    import socis_cli.inventory as inventory
