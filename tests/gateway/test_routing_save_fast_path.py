...
def _make_store(tmp_path, monkeypatch, **config_kwargs) -> SessionStore:
    ...
    # The routing index is pinned to SOCIS_AGENT_HOME's store (#66887 recovery
    ...
    monkeypatch.setattr(socis_agent_constants, "get_socis_agent_home", lambda: str(tmp_path))
    return SessionStore(
