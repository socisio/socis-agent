"""Tests for _setup_feishu() in socis_cli/gateway.py.
...
def _run_setup_feishu(
    *,
    ...
    with patch("socis_cli.config.save_env_value", side_effect=mock_save), \
         patch("socis_cli.config.get_env_value", side_effect=mock_get), \
         patch("socis_cli.config.remove_env_value", side_effect=mock_remove), \
         patch("socis_cli.cli_output.prompt_yes_no", side_effect=prompt_yes_no_responses), \
         patch("socis_cli.setup.prompt_choice", side_effect=prompt_choice_responses), \
         patch("socis_cli.cli_output.prompt", side_effect=prompt_responses), \
         patch("socis_cli.cli_output.print_header"), \
         patch("socis_cli.cli_output.print_info"), \
         patch("socis_cli.cli_output.print_success"), \
         patch("socis_cli.cli_output.print_warning"), \
         patch("socis_cli.cli_output.print_error"), \
