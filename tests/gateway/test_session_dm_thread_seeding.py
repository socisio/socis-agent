...
def store(tmp_path, monkeypatch):
    ...
    ~/.socis-agent/state.db. (DEFAULT_DB_PATH is a module-level constant computed
    at socis_agent_state import time, before pytest's SOCIS_AGENT_HOME monkeypatch
    fires — the autouse fixture's SOCIS_AGENT_HOME override doesn't help here.)
    """
