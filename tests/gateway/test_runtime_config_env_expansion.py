...
def gateway_home(monkeypatch, tmp_path):
    ...
    monkeypatch.delenv("SOCIS_AGENT_PREFILL_MESSAGES_FILE", raising=False)
    monkeypatch.delenv("SOCIS_AGENT_EPHEMERAL_SYSTEM_PROMPT", raising=False)
    ...
    monkeypatch.delenv("SOCIS_AGENT_BACKGROUND_NOTIFICATIONS", raising=False)
    return tmp_path
