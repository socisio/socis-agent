...
def _reset_fuzzy_cache(monkeypatch):
    ...
    # via _load_cfg(), which resolves through _socis_agent_home captured at module
    # import time — before the per-test SOCIS_AGENT_HOME redirect applies. When the
