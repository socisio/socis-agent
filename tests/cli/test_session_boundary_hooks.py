...
from socis_cli.plugins import VALID_HOOKS, PluginManager
...
# tests/socis_cli/test_lifecycle.py::test_finalize_session_closes_core_before_plugin_export.
@patch("socis_cli.lifecycle.invoke_hook")
@patch("socis_cli.lifecycle.finalize_session")
